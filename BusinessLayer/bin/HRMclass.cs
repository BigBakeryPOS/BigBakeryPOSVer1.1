...
namespace BusinessLayer
{
    public class BSClass
    {
        ...
        {
            DataSet ds = new DataSet();
            string hrmview = "select e.*,j.Jobtype,b.Branch from tblEmployeeDetails as e inner join tbl_jobtype as j on e.JobType=j.jobtypeID inner join tbl_branch as b on b.BranchID=e.Branch";
            ds = dbObj.InlineExecuteDataSet(hrmview);
            return ds;
        }
        #endregion
        #region empdetailsall
        public DataSet emp_details()
        {
            DataSet ds = new DataSet();
            string empdetails = "select * from tblEmployeeDetails";
        ...
        public DataSet getdurationbydate(string fromDate, string Todate, int Employee_Id)
        {
            DataSet ds = new DataSet();
            string getbrld = " select * from Attendance_tbl where cast(LogIn_DateTime as DATE) between '" + fromDate + "' and '" + Todate + "' and Employee_Id=" + Employee_Id + " and Time_Duration<'08:00:00'";
        ...
        #endregion
        #region totalleave
        public DataSet totalleavedays(string fromDate, string Todate, int Employeeid)
        {
            DataSet ds = new DataSet();
            string getbrld = " select * from Attendance_tbl where cast(LogIn_DateTime as DATE) between '" + fromDate + "' and '" + Todate + "'   and Employee_Id='" + Employeeid + "'";
            ds = dbObj.InlineExecuteDataSet(getbrld);
            return ds;
        }
        ...
        public int getsearchcount(string fromDate, string Todate, int Employeeid)
        {
            DataSet ds = new DataSet();
