            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="grdViewOrders" CssClass="serh-grid" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="ProductName" HeaderText="Category" SortExpression="OrderID">
                            </asp:BoundField>
                            <asp:BoundField DataField="Item" HeaderText="Definition" SortExpression="ProductName" />
                            
                            <asp:BoundField DataField="Quantity" HeaderText="Available_Qty" SortExpression="Quantity" />
