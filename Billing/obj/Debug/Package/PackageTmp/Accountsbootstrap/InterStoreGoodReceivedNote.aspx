<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterStoreGoodReceivedNote.aspx.cs" Inherits="Billing.Accountsbootstrap.InterStoreGoodReceivedNote" %>
...
<body style="">
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Production Goods Received Entry</h1>
	    </div>
                        ...
                        <asp:Button ID="btncheck" runat="server" OnClick="check_Qty" Text="Check Qty" CssClass="btn btn-primary pos-btn1"  />
                                               ...
                                               <div class="table-responsive panel-grid-left">
                                                    <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="false" Width="100%" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0">
                                                   <%-- <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> --%>
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Received Qty">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtWeight"  runat="server" Text='<%#Eval("SentQty") %>' Enabled="true" class="form-control"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Damage Qty">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtdmgqty"  runat="server"  Enabled="true" class="form-control"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Missing Qty">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtmissqty"  runat="server"  Enabled="true" class="form-control"></asp:TextBox>
                                                                          <asp:TextBox ID="txtfinalqty" runat="server" Visible="false"  Enabled="false" class="form-control"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                  ...
                                                  <div class="col-lg-3"> 
                                                    ...
                                                    <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Width="300px" Height="75px"
                                                        CssClass="form-control"></asp:TextBox> 
                                                         ...
                                                         <div class="col-lg-3"> 
                                                         <br />
                                                    <label id="lblrem" runat="server" style="color: Red"><asp:Button ID="btnvalue" runat="server" CssClass="btn btn-primary pos-btn1" Text="Receive"
