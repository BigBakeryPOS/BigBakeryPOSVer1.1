<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerHistory.aspx.cs" Inherits="Billing.Accountsbootstrap.DealerHistory" %>
...
<form runat="server" id="form1" method="post" style="margin-top:100px">
   ...
   <usc:Header ID="Header" runat="server" />
    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dealer History</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                               ...
                               <div class="table-responsive">
                                ...
                                <tr>
                                <td>
                                <label>Dealer Sales History</label>
                                </td>
                                </tr>
                                <tr>
                                <td>
