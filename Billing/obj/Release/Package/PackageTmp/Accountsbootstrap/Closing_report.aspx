...
<body>
    ...
    <asp:TextBox ID="txtemail" Visible="false" runat="server" Text="nknavaneethan4U@gmail.com"></asp:TextBox>
    <asp:TextBox ID="txtdelorderemail" runat="server" Text="blaackforestonline@gmail.com"></asp:TextBox>
    ...
    <asp:UpdatePanel ID="Updatepnel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="A4" runat="server" title="">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                ...
                                <asp:CheckBox ID="chkdatetime" runat="server" />
                            </div>
                            <div class="col-lg-2">
                                Select Store:
                            ...
                            <div class="col-lg-4">
                                Select Date:<asp:TextBox ID="date" runat="server" CssClass="cal_Theme1"></asp:TextBox>
                                ...
                                <asp:Button ID="Button1" runat="server" Visible="false" Text="Send Mail" CssClass="btn btn-info"
                            ...
                            <div class="col-lg-4">
                                ...
                                <asp:Button ID="btnSendMail" runat="server" Text="Send As Mail" OnClick="btnSendMailReport_Click"
                                    Visible="false" />
                ...
                <div class="col-lg-12">
                    <table id="Table1" border="1" width="100%" align="center" runat="server" visible="true">
                        <tr>
                            <td valign="top" width="30%">
                                <table id="Table2" width="100%" border="1" runat="server" visible="true">
                                    <thead>
                                        <tr>
                            ...
                            <td valign="top" rowspan="2" width="100%">
                                <table border="1" width="100%" style="border-color: Maroon;" id="deno" runat="server">
                                    <thead>
                                        <tr>
                                            <th colspan="2" style="background-color: #5bc0de; color: white">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvdenominationoffice" Width="50%" runat="server" AutoGenerateColumns="false">
                                                    <Columns>
                                                        <asp:BoundField DataField="Name" HeaderText="" />
                                                        <asp:TemplateField HeaderText="No's">
                                                            <ItemTemplate>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvdenominationcloseing" Width="50%" runat="server" AutoGenerateColumns="false">
                                                    <Columns>
                                                        <asp:BoundField DataField="Name" HeaderText="" />
                                                        <asp:TemplateField HeaderText="No's">
                                                            <ItemTemplate>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvorder_rpt" runat="server" AutoGenerateColumns="false" CssClass="myGridStyle"
                ...
                <tr runat="server" visible="false">
                    <td>
                        <asp:GridView ID="gvorder1" runat="server" AutoGenerateColumns="false" CssClass="myGridStyle"
