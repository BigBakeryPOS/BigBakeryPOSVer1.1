<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterProdGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.InterProdGrid" %>
...
<head>
    ...
    <title>Inter Prod Stock Request Entry Grid </title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Production Stock Request Details
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive panel-grid-left">
                                <asp:GridView ID="gvPurchaseEntry" runat="server" AllowPaging="true" PageSize="10" padding="0" spacing="0" border="0" cssClass="table table-striped pos-table"
