<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreRawItemRequestGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.StoreRawItemRequestGrid" %>
                                            ...
                                            <div class="col-lg-5">
                                                <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server"  Caption="Accept Details"
                                                    ...
                                                    <asp:BoundField HeaderText="Accept Type" DataField="reqtype" />
                                                        <asp:BoundField HeaderText="AcceptNo" DataField="RequestNo" />
                                                        <asp:BoundField HeaderText="AcceptDate" DataField="RequestDate" DataFormatString='{0:d}' />
                                                        <asp:BoundField HeaderText="Prepared" DataField="Prepared" />
                                                        <asp:BoundField HeaderText="Qty" DataField="Qty" DataFormatString="{0:f}" />
                                                        <asp:BoundField HeaderText="Request No" DataField="Requestid" />
                                            ...
                                            <label>Sent By</label><asp:Label ID="lblPrepared" runat="server" ></asp:Label>
                                                ...
                                                <asp:GridView ID="gvCustsales" runat="server" ShowFooter="true"   Caption="Accept Items Details"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="AcceptDate" DataField="RequestDate" Visible="false" DataFormatString='{0:dd/MM/yyyy}' />
                                                        ...
                                                        <asp:BoundField HeaderText="Qty" DataField="Qty" DataFormatString='{0:N3}' />
