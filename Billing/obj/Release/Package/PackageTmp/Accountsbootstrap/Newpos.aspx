...
<body class="myfont" style="background-color: #fffff">
    ...
    <div class="col-lg-12" style="padding-top: 3px;">
        ...
        <div class="col-lg-12">
                ...
                <ContentTemplate>
                    <div class="col-lg-2">
                        <div id="categoryname" runat="server" visible="true">
                                    ...
                                    <tr>
                                        <td style="width: 237px;">
                                            <table class="table" border="0">
                                                <tr>
                                                    <td style="width: 78px;">
                                                        <font size="2px"><b>T.NO.:</b></font> <font size="2px"><b>
                            ...
                            <ContentTemplate>--%>
                                ...
                                <div style="width: 100%; height: 540px; overflow: auto;margin-top: -20px;">
                                    <%--<asp:UpdatePanel ID="upan" runat="server" UpdateMode="Always">
                    <ContentTemplate>--%>
                                    <asp:DataList ID="datcat" runat="server" RepeatColumns="1" RepeatDirection="Vertical">
                                        <ItemTemplate>
                                            <asp:Button ID="btncat" runat="server" Font-Bold="true" Height="30px" Width="200px"
                                                Text='<%#Eval("Category")%>' CommandArgument='<%#Eval("CategoryID") %>' OnClick="Button1_Click"
                                                BackColor="#428bca" ForeColor="White" />
                                        </ItemTemplate>
                                    </asp:DataList>
                                    <%-- </ContentTemplate>
                </asp:UpdatePanel>--%>
                    ...
                    <div class="col-lg-5">
                        <div id="itemname1" runat="server" visible="true">
                            <div>
                                <asp:UpdatePanel ID="UpdatePanell1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table border="1">
                                            <tr style="width: 100%">
                                            ...
                                            <tr id="item" runat="server" style="width: 100%; height: 500px; overflow: auto;">
                                            ...
                                            CommandArgument='<%#Eval("CategoryUserID") %>' OnClick="Button2_Click" />--%>
                                                            ...
                                                            <asp:Button ID="Button2" CssClass="styled-button-101" Font-Bold="true" runat="server"
                                                                ...
                                                                Font-Size="14px" Width="13pc" BackColor="steelblue" ForeColor="white" Height="4pc"
            ...
            <div class="col-lg-5">
                <div id="horizontalTab" style="background-color: white;">
                    <ul>
                        <li><a href="#tab-2">Order Summary
                            <%=iCntt %><asp:Label ID="count" runat="server" Style="color: Yellow"></asp:Label></a></li>
                        ...
                        <div style="text-align: right">
                            <div style="overflow: auto; padding-left: 20px">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                                    <ContentTemplate>
                                        <table border="2" width="500px" style="border-color: darkblue;">
                                            <tr>
                                                <td align="left">
                                                    <asp:Button ID="Button2" runat="server" Text="Print KOT" CssClass="btn-danger" BackColor="steelblue"
                                                        BorderColor="steelblue" Width="100px" Height="30px" OnClick="Button2_Click1" />
                                                </td>
                                                <td align="left">
                                                    <label>
                                            ...
                                            <tr style="height: 30px; vertical-align: middle; width: 100%">
                                                <td colspan="2" style="background-color: #428BCA; color: White; text-align: center;
                                                    font-weight: bold; height: 30px; font-size: 14px">
                                                    Order Summary
                                                </td>
                                            ...
                                            <tr style="height: 350px; overflow: scroll; vertical-align: top">
                                                <td colspan="2">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <table id="Table2" width="100%" align="left" runat="server" class="table-bordered"
                                                        ...
                                                        <tr id="tr17" runat="server">
                                                            ...
                                                            <td width="30px">
                                                                <asp:Label ID="txtTax" runat="server" Width="50px" style="text-align: right">0</asp:Label>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="trTot" runat="server">
                                                            ...
                                                            <td width="30px">
                                                                <asp:Label ID="lblGrandTotal1" runat="server" Width="50px"></asp:Label>
                                                            </td>
                                                        </tr>
                ...
                <h2>
                    Total :<label id="lblTotal" runat="server"></label></h2>
            </div>--%>
                        </div>
                        <div>
                        </div>
                    </div>
                    <div class="row" id="tab-3" style="background-color: white; padding-top: 30px">
