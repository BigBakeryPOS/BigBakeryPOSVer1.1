<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingStockGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.PackingStockGrid" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                          <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-2">
                                                <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Add New Pack"
                                                    PostBackUrl="~/Accountsbootstrap/PackingStock.aspx" />
                                            </div>
                                            <div class="col-lg-6">
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-5">
                                                <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server"  Caption="Pack Details"
                                                    ...
                                                    <Columns>
                                                      <asp:BoundField HeaderText="Id" DataField="Id"  Visible="false"/>
                                                        <asp:BoundField HeaderText="PackNo" DataField="PackNo" />
                                                        <asp:BoundField HeaderText="PackDate" DataField="PackDate" DataFormatString="{0:d}" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Cancel Sales" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("PackNo") %>'
                                                                    CommandName="cancel">
                                                        ...
                                                        <asp:TemplateField HeaderText="View Details" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnview" runat="server" CommandArgument='<%#Eval("id") %>'
                                                                    CommandName="view">
                                                        ...
                                                        <asp:TemplateField HeaderText="Print" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("PackNo") %>'
                                                                    CommandName="print">
                                        ...
                                        <div class="col-lg-7">
                                            <asp:GridView ID="gvCustsales" runat="server" ShowFooter="true"  Caption="Packing Items Details"
                                                EmptyDataText="No Records Found" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True">
                                                <Columns>
                                                    <asp:BoundField HeaderText="PackNo" DataField="PackNo" Visible="true" />
                                                    <asp:BoundField HeaderText="PackDate" DataField="PackDate" DataFormatString='{0:dd/MM/yyyy}' />
                                                    ...
                                                    <asp:BoundField HeaderText="PackingQty" DataField="PackingQty" DataFormatString='{0:f}' />
                                                      <asp:BoundField HeaderText="ReceiveQty" DataField="ReceiveQty" DataFormatString='{0:f}' />
                                                        <asp:BoundField HeaderText="CurrentQty" DataField="CurrentQty" DataFormatString='{0:f}' />
                                                          <asp:BoundField HeaderText="FInalQty" DataField="FInalQty" DataFormatString='{0:f}' />
