    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Demand Stock Request</h1>
	    </div>
                                    ...
                                    <br />
                                     <asp:Button ID="btnaddqueue" runat="server" Text="Add to Queue" OnClick="btnaddqueue_OnClick"
                                        ...
                                        &nbsp;&nbsp;<asp:Button ID="btnsave" runat="server" Text="Send Request" OnClientClick="ClientSideClick(this)"
                                         ...
                                         &nbsp;&nbsp;<asp:Button ID="btnexit" runat="server" Text="Exit" CssClass="btn btn-link"
                                      ...
                                      <label id="Label1" runat="server">
                                        ...
                                        <div id="div1" runat="server" class="table-responsive panel-grid-left">
                                            <asp:GridView ID="gvqueueitems" runat="server" AutoGenerateColumns="false" Width="100%"
                                                cssClass="table table-striped pos-table" OnRowCommand="gvqueueitems_RowCommand" OnRowDeleting="gvqueueitems_RowDeleting" padding="0" spacing="0" border="0">
                                               <%-- <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"
                                                    HorizontalAlign="Center" ForeColor="White" />--%>
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Category">
