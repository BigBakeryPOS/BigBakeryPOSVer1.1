<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemandRequestStore.aspx.cs"
    Inherits="Billing.Accountsbootstrap.DemandRequestStore" %>
...
<head>
    ...
    <title>Demand Stock Request </title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading " style="background-color: #428bca; color: White">
                            <b>Demand Stock Request</b> : Entry Date:<asp:Label ID="lblentrydatetime" runat="server"></asp:Label></div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-1">
                                        <asp:Button ID="btnsave" runat="server" Text="Send Request" OnClientClick="ClientSideClick(this)"
                                            UseSubmitBehavior="false" CssClass="btn btn-success" Style="margin-top: 2pc"
                                            OnClick="btnsave_Click" />
                                    </div>
                                    <div class="col-lg-1">
                                        <asp:Button ID="btnexit" Style="margin-top: 2pc" runat="server" Text="Exit" CssClass="btn btn-warning"
