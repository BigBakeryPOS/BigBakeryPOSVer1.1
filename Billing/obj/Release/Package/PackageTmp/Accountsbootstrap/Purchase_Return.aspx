                            ...
                            <asp:GridView ID="gvcustomerorder" runat="server" AutoGenerateColumns="False" OnRowDeleting="grvStudentDetails_RowDeleting" Font-Names="Calibri"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ingredients" HeaderStyle-Width="450px" HeaderStyle-ForeColor="white"
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlDef" CssClass="chzn-select" runat="server" TabIndex="5" Enabled="false"
                                                Height="50px" Width="450px" AutoPostBack="true" OnSelectedIndexChanged="ddlDef_OnSelectedIndexChanged">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="SubCatID" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide"
                                      ...
                                      <asp:TemplateField HeaderText="PO.Qty" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px"
                                        HeaderStyle-ForeColor="white">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Return Quantity" HeaderStyle-Width="50px" HeaderStyle-ForeColor="white">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="GST%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50px"
                                        HeaderStyle-ForeColor="white">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBillNo" runat="server" Enabled="false" CssClass="form-control" Width="81px" AutoPostBack="true"
                                    ...
                                    <asp:TemplateField ControlStyle-Width="100%" HeaderStyle-ForeColor="white" HeaderText="Exp.Date"
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexpireddate" Enabled="false" runat="server"  Height="30px" Width="250px">0</asp:TextBox>
                                     ...
                                     <asp:TemplateField HeaderText="Narrations" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="150px"
                                        HeaderStyle-ForeColor="white">
                                        <ItemTemplate>
                                            <asp:TextBox Width="150px" Style="text-align: right"  class="form-control" TextMode="MultiLine"
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="add" runat="server" OnClick="btnnew_Click">
                                                <asp:Image ID="img" Width="20px" runat="server" ImageUrl="~/images/edit_add.png" Visible="false" /></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                                ...
                                <asp:Button ID="Button2" runat="server" CssClass=" btn btn btn-danger" Text="Exit"
                                    PostBackUrl="~/Accountsbootstrap/Purchase_invGrid.aspx" /></div>
                        </div>
                        <table width="45%">
