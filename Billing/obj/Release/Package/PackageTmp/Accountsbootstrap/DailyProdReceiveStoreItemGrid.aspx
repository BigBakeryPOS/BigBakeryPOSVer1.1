<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyProdReceiveStoreItemGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.DailyProdReceiveStoreItemGrid" %>
...
<head>
    ...
    <title>Receive Item Details </title>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                          <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-2">
                                                <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Add New Receive"
                                                    PostBackUrl="~/Accountsbootstrap/DailyProductionReceiveStoreItem.aspx" />
                                            </div>
                                            <div class="col-lg-6">
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-5">
                                                <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server"  Caption="Receive Details"
                                                    AllowPaging="true" PageSize="50" AutoGenerateColumns="false"
                                                    OnRowCommand="gvsales_RowCommand">
                                                    <%--<HeaderStyle BackColor="#990000" />--%>
                                                    <PagerSettings FirstPageText="1" Mode="Numeric" />
                                                    <Columns>
                                                        <asp:BoundField HeaderText="ReceiveNo" DataField="ReceiveNo" />
                                                        <asp:BoundField HeaderText="ReceiveDate" DataField="ReceiveDate" DataFormatString="{0:d}" />
                                                        <asp:BoundField HeaderText="Prepared" DataField="Prepared" />
                                                        <asp:BoundField HeaderText="Prod.Qty" DataField="Qty" DataFormatString="{0:f}" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Cancel Sales" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("ReceiveNo") %>'
                                                                    CommandName="cancel">
                                                        ...
                                                        <asp:TemplateField HeaderText="View Details" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnview" runat="server" CommandArgument='<%#Eval("ReceiveNo") %>'
                                                                    CommandName="view">
                                                        ...
                                                        <asp:TemplateField HeaderText="Print" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("ReceiveNo") %>'
                                                                    CommandName="print">
                                        ...
                                        <div class="col-lg-7">
                                            <asp:GridView ID="gvCustsales" runat="server" ShowFooter="true"  Caption="Receive Items Details"
                                                EmptyDataText="No Records Found" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True">
                                                <Columns>
                                                    <asp:BoundField HeaderText="ReceiveNo" DataField="ReceiveNo" Visible="true" />
                                                    <asp:BoundField HeaderText="ReceiveDate" DataField="ReceiveDate" DataFormatString='{0:dd/MM/yyyy}' />
