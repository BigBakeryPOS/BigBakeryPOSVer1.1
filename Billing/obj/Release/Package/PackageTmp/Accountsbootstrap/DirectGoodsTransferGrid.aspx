<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirectGoodsTransferGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.DirectGoodsTransferGrid" %>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-2">
                                                <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Add New Request"
                                                    PostBackUrl="~/Accountsbootstrap/DirectGoodsTransfer.aspx" />
                                            </div>
                                            <div class="col-lg-6">
                                            </div>
                                            <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-6">
                                                <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server"
                                                    ...
                                                    Width="80%" Font-Names="Calibri" OnRowCommand="gvsales_RowCommand">
