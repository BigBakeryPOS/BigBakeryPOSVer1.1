                        ...
                        <div>
                            <div>
                                <div align="center">
                                    ...
                                    <div align="center">
                                        <blink><label style="color:Red" >Every 5 min Screen Will Refresh. Thank YOU!!!</label></blink>
                                    </div>
                                    <hr />
                                    <blink><label style="color:Red" >Billing Level</label></blink>
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnDelete" runat="server" CommandArgument='<%#Eval("Id") %>'
                                                                    CommandName="delete">
                                                                    <asp:Image ID="img" runat="server" ImageUrl="~/images/delete.png" /></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                    ...
                                    <br />
                                    <hr />
                                    <blink><label style="color:Red" >Store Level</label></blink>
                                    <br />
                                    <hr />
                                    <blink><label style="color:Red" >Production Level</label></blink>
                                </div>
                            </div>
                        </div>
                    </div>
