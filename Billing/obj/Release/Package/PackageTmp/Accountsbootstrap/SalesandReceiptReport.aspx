...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Sales and Receipt Report</h1>
	    </div>
        ...
        <div class="panel-body">
            ...
            <div id="IDValues" runat="server" class="table-responsive panel-grid-left">
                        ...
                        <asp:GridView ID="gvreceiptamt" EmptyDataText="Oops! No Activity Performed." cssClass="table table-striped pos-table" OnRowDataBound="gvreceiptamt_OnRowDataBound"
                            OnRowCommand="gvsales_RowCommand" Caption="Customer Payment Details" runat="server" padding="0" spacing="0" border="0"
