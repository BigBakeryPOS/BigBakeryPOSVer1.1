<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterBranchReceivedReport.aspx.cs" Inherits="Billing.Accountsbootstrap.InterBranchReceivedReport" %>
...
<head>
    ...
    <title>Inter Branch Goods Received </title>
    <!-- Bootstrap Core CSS -->
...
<body style="">
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Branch Goods Transfer Details</h1>
	    </div>
                ...
                <div class="panel-body">
                            ...
                            <div class="col-lg-3">
                                ...
                                <asp:RangeValidator ID="RangeValidator1" runat="server"
                                          ControlToValidate="txtDate" ErrorMessage="Please Select valid Date Thank You!!!"
                                          Type="Date">
                                </asp:RangeValidator>
                            ...
                            <div class="table-responsive panel-grid-left">
                                            <asp:GridView ID="gvreceived" runat="server" AutoGenerateColumns="false" padding="0" spacing="0" border="0" cssClass="table table-striped pos-table"
