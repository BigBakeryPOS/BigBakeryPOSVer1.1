<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillInvoiceDeptGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.BillInvoiceDeptGrid" %>
...
<head>
    ...
    <title>Store Invoice Grid </title>
...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Store Invoice Details
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                                ...
                                                <asp:DropDownList ID="ddlbillno" CssClass="form-control" runat="server">
                                                    ...
                                                    <asp:ListItem Text="Department Name" Value="b.deptname"></asp:ListItem>
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="table-responsive panel-grid-left">
                                        <asp:GridView ID="gvsales" align="center" runat="server" AllowPaging="true" PageSize="50" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0"
                                           ...
                                           <%-- <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Branch Name" DataField="deptname" />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="25%" HeaderText="System No."
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <div id="dv<%# Eval("invoiceno") %>" style="display: none; position: relative;">
                                                            <asp:GridView runat="server" ID="gvLiaLedger" GridLines="Both" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0" AutoGenerateColumns="false"
                                                                 ShowFooter="true">
                                                                <Columns>
