<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterStoreGoodsTransferReport.aspx.cs" Inherits="Billing.Accountsbootstrap.InterStoreGoodsTransferReport" %>
...
<head>
    ...
    <title>Store Goods Transfer Grid </title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="col-lg-12">
      <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Store Goods Transfer Details</h1>
	    </div>
