...
<body>
    <body>
        ...
        <div class="login-box">
         <asp:Image ID="log" src='<%#Eval("Image")%>' class="avatar"  
                                runat="server" />
            <%--<img src="../css/avatar.png" class="avatar">  --%>
            <form id="Form1" runat="server">
            
             <h1><asp:LinkButton Text="Login Here" ID="btnSetting" OnClick="btnSeeting_OnClick" runat="server"></asp:LinkButton> </h1>  
            ...
            <asp:TextBox ID="txtEmail" runat="server"  AutoComplete="Off"  Visible="false" Placeholder="Enter Email ID"
                        AutoPostBack="true" OnTextChanged="UserName_OnTextChanged"></asp:TextBox>
