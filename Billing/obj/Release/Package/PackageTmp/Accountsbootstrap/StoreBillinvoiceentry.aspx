<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreBillinvoiceentry.aspx.cs" Inherits="Billing.Accountsbootstrap.StoreBillinvoiceentry" %>
    ...
    <div class="col-lg-12" style="">
        <div class="panel panel-default" style="">
            <div class="panel-heading " style="background-color: #428bca; color: White">
                <b>Store Bill Invoice Entry</b></div>
            <div class="panel-body" style="">
                            ...
                            <div style="">
                                ...
                                <div class="row" style="">
                                    ...
                                    <div class="col-lg-2" style="">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtgrndate" runat="server" CssClass="form-control" Width="150px"
                                                OnTextChanged="grn_date"  Enabled="true" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <asp:Button ID="btnRate" runat="server" Text="Rate Check" OnClick="Rate_Click"  />
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-1">
                            <br />
                            <asp:Button ID="btnexit" runat="server" class="btn btn-danger" Text="Exit" Width="100px" PostBackUrl="~/Accountsbootstrap/StoreBillInvoiceGrid.aspx"
                                 />
                        </div>
                        <div class="col-lg-1">
                        </div>
