    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Daily Semi Stock Request Details 
                ...
                <div class="panel-body">
                         ...
                         <div class="row">
                            ...
                            <div class="table-responsive panel-grid-left">
                                ...
                                <div class="col-lg-6">
                                <div class="table-responsive panel-grid-left">
                                <asp:GridView ID="gvPurchaseReqDetails"  padding="0" spacing="0" border="0" cssClass="table table-striped pos-table"
