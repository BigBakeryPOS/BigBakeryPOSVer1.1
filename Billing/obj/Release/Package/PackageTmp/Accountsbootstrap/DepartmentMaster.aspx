<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.DepartmentMaster" %>
            ...
            <div class="col-lg-12" >
              <div class="col-lg-8" >
                ...
                <div class="panel-header">
                  <h1 class="page-header">Department Master</h1>
	            </div>
                    <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                 <div class="form-group has-feedback">
                                    <asp:TextBox CssClass="form-control" ID="txtsearch" placeholder="Search Department.." onkeyup="Search_Gridview(this, 'gridview')"
                                                ...
                                                <asp:GridView ID="gridview" runat="server" AllowPaging="false" AutoGenerateColumns="false" Width="100%" cssClass="table table-striped pos-table"
                                                   ...
                                                   <%--  <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Branch Code" DataField="Pbranch" />
                                                        <asp:BoundField HeaderText="Is Active" DataField="IsActive" />
                                                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnedit" ForeColor="White" CommandArgument='<%#Eval("DeptID") %>' cssclass="btn btn-warning btn-md"
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-custom1">
                               ...
                               <div class="panel-header">
				                        <h1 class="page-header">Add Department Master</h1>
		                        </div>
                                 <div class="panel-body panel-form-right">
                                <center><blink> <label  style="color:#007aff">Need To Add Department Master</label></blink></center>
                               
                                   
                                        <div class="list-group">
                                           
                                                <asp:TextBox CssClass="form-control" ID="txtdepartid" runat="server" Visible="false"></asp:TextBox>
                                            
                                                <label>
                                                   Department Name</label>
                                                <asp:TextBox CssClass="form-control" ID="txtdepartname" runat="server" placeholder="To Add New Department Name"
                                                    Style="text-transform: capitalize" ></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="txtcat" ControlToValidate="txtdepartname"
                                                    ValidationGroup="val1" ErrorMessage="Please enter your Department Name!" Style="color: Red" />
                                            <br />
                                            ...
                                            <div class="col-lg-6">
                                               ...
                                               <div class="col-lg-6">
                                                 ...
                                                 <label>
                                                    Is Allowed</label>
                                                   <asp:DropDownList ID="ddlisrequest" runat="server" CssClass="form-control" >
        ...
        <div class="popup_Container">
            ...
            <div class="popup_Body">
                <p>
                    ...
                    <blink> <label  style="color:Red; font-size:12px">If you Delete This Department Rate Name It Will Affect Your Branchs!!!</label> </blink>
                </p>
            </div>
