<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MinimumQtyAlertReport.aspx.cs" Inherits="Billing.Accountsbootstrap.MinimumQtyAlertReport" %>
...
<head id="Head1">
    ...
    <title>Minimum Quantity Alert Report </title>
...
<body>
    ...
    <div class="col-lg-12">
        <div class="row panel-custom1">
          ...
          <h1 class="page-header">Minimum Quantity Alert Report</h1>
	    </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                                  ...
                                  <%--  <div id="div1" runat="server">
                                    ...
                                    <asp:GridView Visible="true" ID="gvlowstock" runat="server" AutoGenerateColumns="false" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0"
