    ...
    <div class="col-lg-12">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading " style="background-color: #428bca; color: White">
                    <b>Attender Master Details</b></div>
                            ...
                            <asp:GridView ID="gridview" runat="server" AllowPaging="false" AutoGenerateColumns="false" Width="100%" Font-Names="Calibri"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Edit">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnedit" ForeColor="White" CommandArgument='<%#Eval("AttenderId") %>'
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-heading " style="background-color: #428bca; color: White">
                    <b>Attender Master Create</b></div>
                <div class="panel-body">
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                Attender Type</label>
                                <asp:DropDownList ID="drpattendertype" runat="server" Width="200px" CssClass="form-control" >
                                </asp:DropDownList>
                                </div>

                                <div class="form-group">
                            <label>
                                Attender PassWord</label>
                                <asp:TextBox ID="txtpwd" runat="server" CssClass="form-control" Width="200px" >0</asp:TextBox>
                                </div>
                                <div runat="server" visible="false" class="form-group">
                            <label>
                                Disc %</label>
                                <asp:TextBox ID="txtdisc" runat="server" CssClass="form-control" Width="200px" >0</asp:TextBox>
                                </div>
                             ...
                             <label>
                                Select Branch</label>
                           <asp:DropDownList ID="drpbranch" runat="server" Width="200px" CssClass="form-control" ></asp:DropDownList>
                        </div>
                     ...
                     <div class="col-lg-4">
                 Discount Selection
                 <asp:CheckBoxList ID="chkdisc" runat="server" ></asp:CheckBoxList>
                 </div>
                </div>
            </div>
        </div>
