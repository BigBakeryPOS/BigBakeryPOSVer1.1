<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportRawMaterialDecAlert.aspx.cs" Inherits="Billing.Accountsbootstrap.ReportRawMaterialDecAlert" %>
...
<head>
    ...
    <title>Store Raw Materials Alert</title>
    <!-- Bootstrap Core CSS -->
...
<body>
   ...
   <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Store Raw Materials Alert</h1>
	    </div>
                        ...
                        <asp:GridView ID="BankGrid" runat="server" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0" Width="100%" AllowSorting="true"
                           ...
                           <%-- <HeaderStyle BackColor="#3366FF" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Min.Qty" DataField="minqty" DataFormatString='{0:f3}' ItemStyle-Font-Size="X-Large"  ItemStyle-Font-Bold="true" />
                                <asp:BoundField HeaderText="Avl.Qty" DataField="curqty" DataFormatString='{0:f3}' ItemStyle-Font-Size="X-Large"  ItemStyle-Font-Bold="true" />
                                <asp:BoundField HeaderText="Need to Purchase" DataField="Purqty" DataFormatString='{0:f3}' ItemStyle-Font-Size="X-Large" ItemStyle-ForeColor="Red" ItemStyle-Font-Bold="true" />
