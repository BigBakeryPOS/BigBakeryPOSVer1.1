<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemStockRequestStore.aspx.cs" Inherits="Billing.Accountsbootstrap.ItemStockRequestStore" %>
...
<head>
    ...
    <title>Store Stock Request </title>
    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Store Stock Request</h1>
	    </div>
                    ...
                    Entry Date:<asp:Label ID="lblentrydatetime" runat="server" ></asp:Label>
                        ...
                        <div class="col-lg-12">
                            ...
                            <label id="Label1" runat="server" >Selected Requested Item List</label>
                                <div class="table-responsive panel-grid-left">
                                    <asp:GridView ID="gvqueueitems" runat="server" AutoGenerateColumns="false" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0" OnRowCommand="gvqueueitems_RowCommand"
