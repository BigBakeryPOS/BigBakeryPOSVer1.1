<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrencyMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.CurrencyMaster" %>
...
<body>
    ...
    <form id="Form1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-2">
                    <h2 class="page-header" style="text-align: left; color: #fe0002; font-size: 20px">Currency Master</h2>
                </div>
            </div>
            <div class="col-lg-2">
                ...
                <asp:DropDownList CssClass="form-control" ID="ddlfilter" Visible="false" Style="width: 150px; margin-left: 1px;"
                    runat="server">
            ...
            <div class="col-lg-2">
                <asp:Button ID="btnresret" runat="server" class="btn btn-primary" Text="Reset" Style="width: 120px; margin-top: -34px; margin-left: 90px;"
                    OnClick="btnresret_OnClick" />
            </div>
            ...
            <div class="col-lg-2">
                <asp:Button ID="btnsearch" runat="server" class="btn btn-success" Visible="false"
                    ValidationGroup="val1" Text="Search" Style="width: 120px; margin-top: -59px; margin-left: 10px;" />
            </div>
            <div class="col-lg-2">
                                            ...
                                            <asp:GridView ID="gridview" runat="server" Width="100%" EmptyDataText="No Records Found"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="CurrencyName" SortExpression="CurrencyName" HeaderText="CurrencyName"
                                                        ItemStyle-Width="20%" />
                                                    <asp:BoundField DataField="Value" SortExpression="Value" HeaderText="Value" ItemStyle-Width="10%" />


                                                    <asp:BoundField DataField="defname" HeaderText="Default currency" ItemStyle-Width="20%" />
                                                    <asp:BoundField DataField="defvalue" HeaderText="Default Value" ItemStyle-Width="10%" />
