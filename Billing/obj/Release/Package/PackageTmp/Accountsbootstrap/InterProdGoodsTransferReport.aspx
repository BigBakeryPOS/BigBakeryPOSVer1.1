<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterProdGoodsTransferReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.InterProdGoodsTransferReport" %>
...
<head>
    ...
    <title>Production Goods Transfer Grid </title>
    <!-- Bootstrap Core CSS -->
...
<body style="">
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Production Goods Transfer Details</h1>
	    </div>
                ...
                <div class="panel-body">
                                            ...
                                            <asp:GridView ID="gvGoodTransFer" runat="server" AllowPaging="true" PageSize="5" cssClass="table table-striped pos-table"
                                               ...
                                               <%-- <PagerSettings Mode="Numeric" />--%>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="DC Date" DataField="Dc_Date"  DataFormatString='{0:dd/MMM/yyyy}' />
                                                    ...
                                                    <asp:TemplateField HeaderText="Transfer">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("Dc_No") %>'
                                                                ...
                                                                <asp:Image ID="dlt" runat="server" ImageAlign="Middle" ImageUrl="~/images/transfer.jpg" visible="false"
                        ...
                        <div class="table-responsive panel-grid-left">
                                            ...
                                            <asp:GridView ID="gvTransfer" runat="server" EmptyDataText="No Record Found" AutoGenerateColumns="false" cssClass="table table-striped pos-table"
                                                OnRowCommand="gvTransfer_RowCommand" padding="0" spacing="0" border="0">
                                                <Columns>
                                                    <asp:BoundField HeaderText="DC No" DataField="DC_NO" />
