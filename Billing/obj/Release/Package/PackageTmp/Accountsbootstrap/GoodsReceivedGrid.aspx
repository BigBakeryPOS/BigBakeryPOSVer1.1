                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="col-lg-3" style="">
                                        <div class="form-group" style="">
                                            <label>
                                                Select DC NO</label>
                                            <asp:DropDownList ID="ddlDC" Width="200px" runat="server" CssClass="form-control"
                                    ...
                                    <div class="col-lg-1" style="">
                                        <div>
                                            <asp:Button ID="btnsearchqty" runat="server" class="btn btn-success" Text="Get Details"
                                    ...
                                    <div class="col-lg-12" style="">
                                        <div class="col-lg-6" style="">
                                            ...
                                            <asp:GridView ID="gvGoodsReceived" Width="100%" runat="server" AllowPaging="true"
                                                PageSize="10" Font-Names="Calibri" AutoGenerateColumns="false" OnRowCommand="gvGoodTransFer_RowCommand">
                                        ...
                                        <div class="col-lg-6" style="">
                                            ...
                                            <div id="PRINTID" runat="server">
                                                ...
                                                <asp:GridView ID="gvsummary" OnRowDataBound="gvsummary_rowdatabound" ShowFooter="true"
                                                ...
                                                <asp:GridView ID="gvdetailsall" OnRowDataBound="gvdetailsall_rowdatabound" ShowFooter="true"
                                                    Visible="false" runat="server" Width="100%" AutoGenerateColumns="false" Font-Names="Calibri">
                                                    <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"
                                                        HorizontalAlign="Center" ForeColor="White" />
                                                    <Columns>
