<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReqDeptGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.PurchaseReqDeptGrid" %>
...
<head>
    ...
    <title>Department Request Entry Grid </title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Department Request Details
                                ...
                                <asp:GridView ID="gvPurchaseEntry" runat="server" AllowPaging="true" PageSize="10" cssClass="table table-striped pos-table"
                                   ...
                                   <%-- <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Entry Date/Time" DataField="entrytime"  DataFormatString='{0:dd/MMM/yyyy}'/>
