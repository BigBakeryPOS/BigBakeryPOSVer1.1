<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyProductionStockGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.DailyProductionStockGrid" %>
...
<head>
    ...
    <title>Daily Production Stock Grid </title>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                         <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-2">
                                                <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Add New Production Goods"
                                                    PostBackUrl="~/Accountsbootstrap/DailyProductionStock.aspx" />
                                            </div>
                                            <div class="col-lg-6">
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-5">
                                                <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server" Caption="Daily Production Stock"
                                            ...
                                            <div class="col-lg-7">
                                                <asp:GridView ID="gvCustsales" runat="server" ShowFooter="true"  Caption="Daily Production Stock Details"
