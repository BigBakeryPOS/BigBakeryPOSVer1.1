<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemStockRequest.aspx.cs"
    EnableEventValidation="false" Inherits="Billing.Accountsbootstrap.ItemStockRequest" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-6">
                                <div class="panel-heading " style="background-color: #428bca; color: White">
                                    <b>Daily Stock Request</b> : Entry Date:<asp:Label ID="lblentrydatetime" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="panel-heading " style="background-color: #428bca; color: White">
                                    ...
                                    <asp:DropDownList ID="drpproductiontype" runat="server" Width="50%" CssClass="form-control"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <asp:Button ID="btnsave" runat="server" Text="Send Request" OnClientClick="ClientSideClick(this)"
                                            UseSubmitBehavior="false" CssClass="btn btn-success" OnClick="btnsave_Click" />
            ...
            <asp:Label ID="lblmainrequestid" runat="server" Visible="false" ></asp:Label>
                <asp:GridView ID="gvUserInfo" runat="server" AutoGenerateColumns="false">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Available_Qty" HeaderText="Avl.Qty" HtmlEncode="False" DataFormatString="{0:F2}"  />
                        <asp:BoundField DataField="Qty" HeaderText="Request Qty" />
