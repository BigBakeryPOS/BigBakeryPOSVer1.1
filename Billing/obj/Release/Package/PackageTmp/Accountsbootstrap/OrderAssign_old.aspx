<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderAssign_old.aspx.cs"
    Inherits="Billing.Accountsbootstrap.OrderAssign_old" %>
                                    ...
                                    <asp:GridView ID="BankGrid" runat="server" DataKeyNames="BillNo,Branchcode,BookNo" Width="100%"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Select">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkitem" runat="server" OnCheckedChanged="chkitem_oncheckedchanged"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Kot Print">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" CommandArgument='<%#Eval("orderno") + ";" +Eval("Branchcode")%>'
