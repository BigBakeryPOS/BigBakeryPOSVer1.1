<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterBranchStockRequestReport.aspx.cs" Inherits="Billing.Accountsbootstrap.InterBranchStockRequestReport" %>
...
<head>
    ...
    <title>Inter Branch Stock Request Report</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="row" style="">
        <div class="col-lg-12" style="">
            <h1 class="page-header">
                Inter Branch Stock Request Report Details</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row" style="">
        <div class="col-lg-12" style="">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-2">
                                            <label>
                                                From Date</label>
                                            <asp:TextBox runat="server" ID="txtfromdate" Enabled="true" CssClass="form-control" Width="150px"
                                                AutoPostBack="true"  ontextchanged="txttodate_TextChanged">
                                            </asp:TextBox>
                                            <asp:RangeValidator ID="RangeValidator1" runat="server"
          ControlToValidate="txtfromdate" ErrorMessage="Please Select valid Date Thank You!!!"
          Type="Date">
</asp:RangeValidator>
                                        ...
                                        <div class="col-lg-2">
                                            <label>
                                                To Date</label>
                                            <asp:TextBox runat="server" ID="txttodate" Enabled="true" CssClass="form-control" Width="150px">
                                            </asp:TextBox>
          ...
          Type="Date">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <asp:Button ID="btnrefresh" runat="server" class="btn btn-warning" Text="Reset" Style="margin-top: 25px;" OnClick="btnrefresh_Click" />
                                            <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Add" Style="margin-top: 10px;" Visible="false"/>
                                        </div>
                                        <div class="col-lg-2">
                                        </div>
                                         <div class="col-lg-2">
                                    ...
                                    <div>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvPurchaseEntry" runat="server"  EmptyDataText="No Record Found" PageSize="10" 
                                                        Width="100%" AutoGenerateColumns="false" CssClass="myGridStyle" DataKeyNames="RequestNO" 
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div id="dv<%# Eval("RequestNO") %>" style="display: none; position: relative;">
                                                                        <asp:GridView runat="server" ID="gvdetails" CssClass="mGrid" GridLines="Both"
                                                                            AutoGenerateColumns="false" DataKeyNames="TransP_Id" >
                                                                              <HeaderStyle BackColor="#990000" />
                                                                            <Columns>
