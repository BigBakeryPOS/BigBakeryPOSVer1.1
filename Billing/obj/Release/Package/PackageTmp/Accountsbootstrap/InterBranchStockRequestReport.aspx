...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Branch Stock Request Report Details</h1>
	    </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        ...
                                        <br />
                                           ...
                                           &nbsp;&nbsp;&nbsp; <asp:Button ID="btnrefresh" runat="server" class="btn btn-secondary" Text="Reset"  OnClick="btnrefresh_Click" />
                                            <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Add"  Visible="false"/>
                                        </div>
                                   ...
                                   <div class="table-responsive panel-grid-left">
                                                    ...
                                                    <asp:GridView ID="gvPurchaseEntry" runat="server"  EmptyDataText="No Record Found" PageSize="10" 
                                                        Width="100%" AutoGenerateColumns="false" cssClass="table table-striped pos-table" DataKeyNames="RequestNO"  padding="0" spacing="0" border="0"
                                                         ...
                                                         <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30%" HeaderText="Req. No."
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div id="dv<%# Eval("RequestNO") %>" style="display: none; position: relative;">
                                                                        <asp:GridView runat="server" ID="gvdetails" cssClass="table table-striped pos-table" GridLines="Both"
                                                                            AutoGenerateColumns="false" DataKeyNames="TransP_Id" padding="0" spacing="0" border="0" >
                                                                              <%--<HeaderStyle BackColor="#990000" />--%>
                                                                            <Columns>
