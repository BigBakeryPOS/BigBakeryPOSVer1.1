<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CakeOrderForm.aspx.cs" Inherits="Billing.Accountsbootstrap.CakeOrderForm" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div runat="server" id="editbill" visible="false">
                                <blink>
                                    <label id="lbleditbill" runat="server" style="color: Green; font-size: 12px"></label>
                                </blink>
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <asp:CheckBox ID="chkchecklist" Checked="false" runat="server" />
                                            </div>
                                            <div class="col-lg-2">
                                                <b>Book No:</b>
                                                <asp:Label ID="lblbookcode" Font-Bold="true" Font-Size="13px" runat="server"></asp:Label>
                                                ...
                                                <br />
                                                <b>Date</b>
                                                <asp:TextBox ID="txtOrderDate" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <br />
                                                <b>Alternative No</b>
                                                <asp:TextBox ID="txtalternativenumber" MaxLength="10"
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <br />
                                                <b>GST No (if applicable)</b>
                                                <asp:TextBox ID="txtgstno" Font-Bold="true" CssClass="form-control" Enabled="true" Font-Size="20px" runat="server"></asp:TextBox>
                                            </div>
                                            ...
                                            <div style="width: 100%;">
                                                ...
                                                <asp:GridView ID="gridorder" runat="server" AutoGenerateColumns="false" Width="100%"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Category" Visible="false" HeaderStyle-Width="15%">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Food Type" HeaderStyle-Width="9%">
                                                            <ItemTemplate>
                                                                <asp:DropDownList ID="drpfoodtype" runat="server" CssClass="form-control" OnSelectedIndexChanged="Foodtype_SelectedIndexChanged"
                                                                    AutoPostBack="true">
                                                                    <asp:ListItem Text="Food Item" Value="F"></asp:ListItem>
                                                                    <asp:ListItem Text="Order Item" Value="O" Selected="True"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Flavour/Food Item" HeaderStyle-Width="18%">
                                                            <ItemTemplate>
                                                         ...
                                                         <asp:TemplateField HeaderText="Shape" Visible="true" HeaderStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <asp:DropDownList ID="drpshape" Font-Bold="true" Font-Size="Larger" ForeColor="Black" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-Width="8%" HeaderText="Shape.Rate" ItemStyle-Font-Size="Smaller">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtshaperate" OnTextChanged="Shaperate_chnaged" AutoPostBack="true" Font-Bold="true" Font-Size="Larger" ForeColor="Black" runat="server" CssClass="form-control"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="8%" HeaderText="Rate" ItemStyle-Font-Size="Smaller">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtsubrate" Width="100%" Enabled="false" CssClass="form-control" runat="server"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="10%" HeaderText="Amount" ItemStyle-Font-Size="Smaller">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtsubamount" Width="100%" CssClass="form-control" Style="text-align: right"
                                                                    runat="server" Enabled="false"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-Width="5%" Visible="false" HeaderText="Units" ItemStyle-Font-Size="Smaller">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="SET WISE" Visible="true" HeaderStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <asp:DropDownList ID="drpset" Font-Bold="true" Font-Size="Larger" ForeColor="Black" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="add" runat="server" OnClick="btnnew_Click">
                                                                    <asp:Image ID="img" Width="20px" runat="server" ImageUrl="~/images/edit_add.png" />
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
