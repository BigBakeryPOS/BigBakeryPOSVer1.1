<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Purchase_ReturnGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.Purchase_ReturnGrid" %>
...
<head>
    ...
    <title>Purchase Return - bootsrap</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <asp:GridView ID="BankGrid" runat="server"  Width="100%" AllowSorting="true" cssClass="table table-striped pos-table"
                                   ...
                                   <%--<HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Purchase Return Date" DataField="PurchaseRtnDate" DataFormatString="{0:dd/MM/yyyy}" />
