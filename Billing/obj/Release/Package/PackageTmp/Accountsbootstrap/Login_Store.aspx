<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login_Store.aspx.cs" Inherits="Billing.Accountsbootstrap.Login_Store" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="text-center">
                                <asp:LinkButton Text="LOGIN" ID="LinkButton1" OnClick="btnSeeting_OnClick" runat="server"></asp:LinkButton>
                            </h3>
                            ...
                            <label for="inputEmail">SELECT BRANCH</label>
                            <asp:DropDownList ID="drpbranchlist" runat="server" CssClass="form-control">
                            </asp:DropDownList>
                            <label for="inputEmail">EMP User name</label>
                            <asp:TextBox ID="txtempusername" runat="server" AutoComplete="Off" class="form-control input-md"></asp:TextBox>
                            <label for="inputEmpcode">EMP Password</label>
                            ...
                            <div class="user-bottom fix">
                                ...
                                <asp:Button ID="btnOTP" Visible="false" runat="server" Text="Send OTP" CssClass="common-btn rjc"
                                    Style="background: #90133b none repeat scroll 0 0; border: 1px solid transparent; border-radius: 4px; color: #fff; display: inline-block; font-size: 14px; font-weight: 700; line-height: 35px; padding: 0 20px; text-transform: uppercase; white-space: nowrap; transition: .3s;"
                                    OnClick="btnOTPClick" />
