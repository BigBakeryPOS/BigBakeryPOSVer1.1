<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreItemSetting.aspx.cs" Inherits="Billing.Accountsbootstrap.StoreItemSetting" %>
...
<head>
    ...
    <title>Store Item Setting Details  </title>
    ...
    <form id="Form1" runat="server">
                            ...
                            <div class="panel-body panel-form-right">
                                <div class="list-group">
                                    <div id="UPD" runat="server" visible="false">
                                        <blink>
                                            <label>
                                                If you Edit This Store Ing. Setting It Will Affect Your Branch's Stock So Be CareFull,Now this Screen on TRACKING!!! 
        ...
        <asp:Panel class="popupConfirmation" ID="DivDeleteConfirmation"
            ...
            <div class="popup_Container">
                ...
                <blink>
                    <label style="color: Red; font-size: 12px">If you Delete This Store Ing. Setting It Will Affect Your Branchs or Your Production!!!</label>
                </blink>
                    </p>
                </div>
