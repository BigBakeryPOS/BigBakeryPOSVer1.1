...
<body style="font-family: Calibri; font-size: medium;">
    ...
    <div class="col-lg-12">
        ...
        <div class="panel-header">
          <h1 class="page-header">Inter Prod/Store Setting Details</h1>
	    </div>
                           ...
                           <%-- <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Edit" ItemStyle-Width="60px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnedit" ForeColor="White" CommandArgument='<%#Eval("InterProdid") %>' cssclass="btn btn-warning btn-md"
        ...
        <div class="col-lg-4">
            ...
            <div class="panel-header">
				<h1 class="page-header">Add Inter Prod/Store Setting</h1>
		</div>
