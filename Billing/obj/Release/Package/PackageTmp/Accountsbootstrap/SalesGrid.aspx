                            ...
                            <asp:UpdatePanel ID="updatepanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:Button ID="btnsearch" runat="server" class="btn btn-danger" Text="Search" Width="150px" OnClick="Search_Click"
                                            onkeyup="Search_Gridview(this, 'gvCustsales')" /></div>
                                              <div class="col-lg-2"><br />
                                        <asp:Button ID="btnrefresh" runat="server" class="btn btn-warning" Width="150px" Text="Reset" OnClick="refresh_Click" />
                                        </div>

  <div class="col-lg-2"><br />                                        <asp:Button ID="btnadd" runat="server" Width="150px" class="btn btn-success" Text="Add New Bill" OnClick="Add_Click" />
                                      ...
                                      <div class="col-lg-6">
                                                    ...
                                                    <asp:GridView ID="gvsales" align="center" runat="server" AllowPaging="true" PageSize="50" Width="100%"
                                                        OnRowCancelingEdit="GridView1_RowCancelingEdit" OnPageIndexChanging="Page_Change" Font-Names="Calibri"
                                                 ...
                                                 <div class="col-lg-6">
                                                    <asp:GridView ID="gvCustsales" runat="server" AllowPaging="true" PageSize="10"
                                                        DataKeyNames="BillNo,salestype" ShowFooter="true" OnPageIndexChanging="Page_Change" OnRowDataBound="gvCustsales_RowDataBound"
