<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillInvoiceDeptEntry.aspx.cs"
    Inherits="Billing.Accountsbootstrap.BillInvoiceDeptEntry" %>
...
<html lang="en">
<head id="Head1">
    <title>Department Bill Invoice Entry</title>
                                ...
                                <div class="row" style="">
                                    <div class="col-lg-2" style="">
                                        <div class="form-group" style="">
                                            ...
                                            <asp:DropDownList ID="drpdepartment" runat="server" CssClass="form-control" OnSelectedIndexChanged="dept_chnaged"
                                                AutoPostBack="true">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group" style="">
                                    ...
                                    <%--   <div class="col-lg-1">
                                        <div class="form-group">
                                            <label>
                                                Vehicle No</label>
                                            <asp:TextBox ID="txtvehicleno" runat="server" CssClass="form-control" Width="150px"></asp:TextBox>
                                        </div>
                                    </div>--%>
                                    <div class="col-lg-3">
                                        <label>
                                    ...
                                    <asp:GridView ID="gridsummary" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Request NO">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldcno" runat="server" Text='<%#Eval("requestno") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Request Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldcdate" runat="server" Text='<%#Eval("requestdate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Avaliable Qty">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Order Qty">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblqty" runat="server" Text='<%#Eval("order_qty") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Send Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtsendqty" runat="server" CssClass="form-control"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField Visible="false" HeaderText="Tax">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtTaxVal" Enabled="false" runat="server" Visible="false" Text='<%#Eval("TaxValue") %>'></asp:TextBox>
