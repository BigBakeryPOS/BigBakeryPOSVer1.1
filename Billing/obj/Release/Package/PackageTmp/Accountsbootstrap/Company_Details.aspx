<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_Details.aspx.cs"
    Inherits="Billing.Accountsbootstrap.Company_Details" %>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:FileUpload ID="FileUpload2" runat="server" style="    margin-top: 7px;" />  <asp:Image ID="img_Photo2" runat="server" class="img-fluid" Height="50px" Width="50px" style="    margin-left: 230px;margin-top: -40px;" />
                                         ...
                                         <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:FileUpload ID="FileUpload4" runat="server" style="    margin-top: 7px;" /> <asp:Image ID="img_Photo4" runat="server" class="img-fluid" Height="50px" Width="50px" style="    margin-left: 230px;margin-top: -40px;" />
