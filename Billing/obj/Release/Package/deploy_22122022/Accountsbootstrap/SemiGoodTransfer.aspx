<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SemiGoodTransfer.aspx.cs" Inherits="Billing.Accountsbootstrap.SemiGoodTransfer" %>
...
color:White;
    ...
    <title>Semi Goods Transfer</title>
...
<body>
    ...
    <ContentTemplate>   --%>  
            <div class="panel panel-primary" style="">
                            <div class="panel-heading">Semi Goods Requested</div>
                <div class="panel-body" style="">
                    ...
                    <div class="col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="false" Width="100%"
                                                        Font-Size="Medium">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="categoryID" DataField="SemiCatID" Visible="false" />
                                                            <asp:BoundField HeaderText="DespID" DataField="SemiIngridID" Visible="false" />
                                                            <asp:TemplateField HeaderText="Category" HeaderStyle-Width="175px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCategory" runat="server" Text='<%#Eval("SemiCategory")%>'></asp:Label>
                                                                    <asp:HiddenField ID="HDCategoryid" runat="server" Value='<%#Eval("SemiCatID") %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Item Name" HeaderStyle-Width="450px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProduct" runat="server" Text='<%#Eval("SemiIngredientName")%>'></asp:Label>
                                                                    <asp:HiddenField ID="HDProductid" runat="server" Value='<%#Eval("SemiIngridID") %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
