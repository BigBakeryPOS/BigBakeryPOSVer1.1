...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Daily Stock Request</h1>
	    </div>
                    ...
                    <div class="col-lg-3">
                          ...
                          <asp:DropDownList ID="drpproductiontype" runat="server" CssClass="form-control" OnSelectedIndexChanged="Producttype_chnaged" AutoPostBack="true">
                            </asp:DropDownList>
                    </div>
                                               ...
                                               <%-- <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                     ...
                                                     <asp:TemplateField HeaderText="delaydays">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldelaydays" runat="server" Text='<%#Eval("delaydays") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
