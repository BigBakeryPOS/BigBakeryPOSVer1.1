...
<body style="">
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Stock Request From Production Details</h1>
	    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <asp:ScriptManager ID="scriptmanager" runat="server">
                            ...
                            <div class="col-lg-3">
                             <%--  <label>Select Date:</label> --%><asp:TextBox ID="txtDate"  runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive panel-grid-left">
                                <asp:GridView ID="gvPurchaseEntry" runat="server" AllowPaging="true" PageSize="20" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0"
