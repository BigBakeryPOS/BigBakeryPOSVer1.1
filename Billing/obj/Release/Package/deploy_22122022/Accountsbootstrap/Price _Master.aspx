<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Price _Master.aspx.cs" Inherits="Billing.Accountsbootstrap.Price__Master" %>
...
<body>
   ...
   <form runat="server" id="form1">
    ...
    <div style="margin-top:100px" class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Price Master</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
          ...
          <div class="row">
            ...
            <asp:TextBox ID="txtser" Visible="true" placeholder="Search Item" runat="server" Width="200px"  CssClass="form-control"  ></asp:TextBox>
             </div>
            <div class="form-group">
            ...
            <br />
                               ...
                               <div class="table-responsive">
                                ...
                                <asp:GridView ID="gvcust"  ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found"  runat="server" AllowPaging="true" PageSize="10" 
                                      CssClass="myGridStyle" OnPageIndexChanging="Page_Change" 
    ...
    <asp:BoundField HeaderText="Category" DataField="Category" />
     <asp:BoundField HeaderText="Item" DataField="Definition" />
      <asp:BoundField HeaderText="Tax" DataField="Tax" />
       ...
       <asp:BoundField HeaderText="Serial_No" DataField="Serial_No" />
       <asp:BoundField HeaderText="Quantity" DataField="Quantity" />
       <asp:BoundField HeaderText="Available_QTY" DataField="Available_QTY" />
         <asp:BoundField HeaderText="PurchaseRate" DataField="PurchaseRate" DataFormatString="{0:f}"/>
           <asp:BoundField HeaderText="DealerUnitPrice" DataField="DealerUnitPrice" DataFormatString="{0:f}"/>
             <asp:BoundField HeaderText="PressUnitPrice" DataField="PressUnitPrice" DataFormatString="{0:f}"/>
               <asp:BoundField HeaderText="Customer Price" DataField="Customer Price" DataFormatString="{0:f}"/>
