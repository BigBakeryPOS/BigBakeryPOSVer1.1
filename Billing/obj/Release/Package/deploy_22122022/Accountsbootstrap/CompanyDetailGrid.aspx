<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDetailGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.CompanyDetailGrid" %>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tr id="Tr1" runat="server">
                                        <td>
                                            <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New" PostBackUrl="~/Accountsbootstrap/Company_Details.aspx" />
                                        </td>
                                    </tr>
                                            ...
                                            <asp:GridView ID="gvcust" EmptyDataText="No records Found" runat="server" CssClass="mGrid"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="login_id" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbllogin_id" runat="server" CommandArgument='<%#Eval("ComapanyID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
