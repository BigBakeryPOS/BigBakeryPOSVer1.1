            ...
            <div class="col-lg-12" >
              <div class="col-lg-8" >
                ...
                <div class="panel-header">
                  <h1 class="page-header">Ingredient Category Master</h1>
	            </div>
                                                   ...
                                                   <%--  <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnedit" ForeColor="White" CommandArgument='<%#Eval("IngCatID") %>' cssclass="btn btn-warning btn-md"
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-custom1">
                               ...
                               <div class="panel-header">
                                ...
                                <center><blink> <label  style="color:#007aff">Need To Add Ingredient Category Name and Code</label></blink></center>
