<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionStock.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ProductionStock" %>
                    ...
                    <table border="0">
                        <tr>
                            ...
                            <td style="height: 20px; width: 300px">
                                ...
                                <asp:TextBox ID="txtpono" Width="100px" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td align="center" style="height: 20px; width: 300px">
                                <asp:Label runat="server" ID="Label2">Updated By </asp:Label><asp:TextBox ID="txtOrderBy"
                            ...
                            <td style="height: 20px; width: 300px; padding-left: 50px; padding-top: 15px">
                                ...
                                <asp:TextBox ID="txtpodate" Width="200px" runat="server" Text="--Select Date--" Enabled="false"></asp:TextBox>
    ...
    <asp:UpdatePanel ID="update" runat="server" ChildrenAsTriggers="true" EnableViewState="true"
        ...
        <ContentTemplate>
                                                                                    ...
                                                                                    id="tab13" runat="server"><span style="width: 65px">
                                                                                        ...
                                                                                        id="tab14" runat="server"><span style="width: 65px">
                                                                                            ...
                                                                                            id="tab15" runat="server"><span style="width: 65px; height: 25px">
                                                                                                ...
                                                                                                id="tab16" runat="server"><span style="width: 65px; height: 25px">
                                                                                                    <label id="lblitem16" runat="server">
                                                                                                    </label>
                                                                                                </span></a><a href="#" style="visibility: hidden; background-color: #428bca" class="c-tabs-nav__link"
                                                                                                    id="tab17" runat="server"><span style="width: 65px; height: 25px">
                                                                                                        <label id="lblitem17" runat="server">
                                                                                                        </label>
                                                                                                    </span></a>
                            <a href="#" style="visibility: hidden; background-color: #428bca" class="c-tabs-nav__link"
                                id="tab18" runat="server"><span style="width: 65px; height: 25px">
                                    <label id="lblitem18" runat="server">
                                    </label>
                                </span></a><a href="#" style="visibility: hidden; background-color: #428bca" class="c-tabs-nav__link"
                                    id="tab19" runat="server"><span style="width: 65px; height: 25px">
                                        <label id="lblitem19" runat="server">
                                        </label>
                                    </span></a><a href="#" style="visibility: hidden; background-color: #428bca" class="c-tabs-nav__link"
                                        id="tab20" runat="server"><span style="width: 65px; height: 25px">
                                            <label id="lblitem20" runat="server">
                                            </label>
                                        </span></a>
                        </div>
                                    ...
                                    <div>
                                        <table class="table table-bordered table-striped">
                                            <tr align="center">
                                                <td>
                                                    Search :
                                                    <asp:TextBox ID="txtSearch" runat="server" onkeyup="Search_Gridview(this, 'gvGateaux')"
                                                        ...
                                                        <asp:GridView ID="gvGateaux" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Units">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="ddUnits" Enabled="false " runat="server" Width="50px">
                                                                        </asp:DropDownList>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                ...
                                                <div id="div2" runat="server" style="height: 370px; overflow-x: auto;">
                                                    <asp:GridView ID="gvSnacks" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Units">
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="ddUnits" Enabled="false " Width="50px" runat="server">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                ...
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <td>
                                                Search :
                                                <asp:TextBox ID="TextBox10" runat="server" onkeyup="Search_Gridview(this, 'gvBday')"
                                                    CssClass="form-control" Width="200px"></asp:TextBox><br />
                                ...
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <td>
                                                Search :
                                                <asp:TextBox ID="TextBox11" runat="server" onkeyup="Search_Gridview(this, 'gvbread')"
                                                    CssClass="form-control" Width="200px"></asp:TextBox><br />
                                ...
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <td>
                                                Search :
                                                <asp:TextBox ID="TextBox12" runat="server" onkeyup="Search_Gridview(this, 'gvSponges')"
                                                    CssClass="form-control" Width="200px"></asp:TextBox><br />
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox13" runat="server" onkeyup="Search_Gridview(this, 'gvReadySp')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox14" runat="server" onkeyup="Search_Gridview(this, 'gvRmCake')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox15" runat="server" onkeyup="Search_Gridview(this, 'gvIce')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox16" runat="server" onkeyup="Search_Gridview(this, 'gv16')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                                                <div id="div1" runat="server" style="height: 370px; overflow-x: auto;">
                                                    <asp:GridView ID="gv16" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Group" DataField="Category" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="Item Name" DataField="Definition" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="categoryID" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide"
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox17" runat="server" onkeyup="Search_Gridview(this, 'gv17')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                                                <div id="div17" runat="server" style="height: 370px; overflow-x: auto;">
                                                    <asp:GridView ID="gv17" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Group" DataField="Category" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="Item Name" DataField="Definition" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="categoryID" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide"
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox18" runat="server" onkeyup="Search_Gridview(this, 'gv18')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                                                <div id="div18" runat="server" style="height: 370px; overflow-x: auto;">
                                                    <asp:GridView ID="gv18" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Group" DataField="Category" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="Item Name" DataField="Definition" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="categoryID" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide"
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox19" runat="server" onkeyup="Search_Gridview(this, 'gv19')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                                                <div id="div19" runat="server" style="height: 370px; overflow-x: auto;">
                                                    <asp:GridView ID="gv19" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Group" DataField="Category" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="Item Name" DataField="Definition" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="categoryID" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide"
                        ...
                        <div class="c-tab">
                            <div class="c-tab__content">
                                <div class="row" style="background-color: #D0D3D6; padding-left: 30px">
                                    <table class="table table-bordered table-striped">
                                        <tr align="center">
                                            <asp:TextBox ID="TextBox20" runat="server" onkeyup="Search_Gridview(this, 'gv20')"
                                                CssClass="form-control" Width="200px"></asp:TextBox><br />
                                            <td>
                                                <div id="div20" runat="server" style="height: 370px; overflow-x: auto;">
                                                    <asp:GridView ID="gv20" runat="server" AutoGenerateColumns="false" CssClass="mGrid">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Group" DataField="Category" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="Item Name" DataField="Definition" HeaderStyle-Font-Size="Smaller" />
                                                            <asp:BoundField HeaderText="categoryID" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide"
            ...
            <div class="form-group" align="center">
                ...
                <asp:Button ID="Button1" runat="server" Text="Exit" PostBackUrl="~/Accountsbootstrap/ProductionStockGrid.aspx" />
            </div>
        </ContentTemplate>
        <Triggers>
