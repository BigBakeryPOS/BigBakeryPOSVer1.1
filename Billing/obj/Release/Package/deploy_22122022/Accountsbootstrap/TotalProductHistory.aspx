<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalProductHistory.aspx.cs" Inherits="Billing.Accountsbootstrap.TotalProductHistory" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                               ...
                               <asp:TextBox ID="txtProduct" runat="server" CssClass="form-control" ></asp:TextBox>
                                ...
                                <asp:Button id="btnreset" runat="server" Text="Reset" CssClass="btn btn-danger" onclick="btnreset_Click" 
										...
										<div class="table-responsive" id="Report" runat="server">
                                ...
                                <label> By Sales</label>
                                <asp:GridView ID="gvSales" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records Found" 
                         ...
                         <asp:BoundField HeaderText="Amount" DataFormatString="{0:f}" DataField="Amount" />
                                </Columns>
                                </asp:GridView>
                               Total <label id="lblSales" runat="server" style="margin-left:570px">Sales</label>
                                </td>
                                </tr>
                                                               
                                   <tr>
                                <td colspan="4" align="left">
                                <label> By Purchase</label>
                                <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records Found"  
                                        AllowPaging="true" CssClass="myGridStyle" PageSize="10" 
                                        >
                                  <HeaderStyle BackColor="#336699" /><PagerSettings FirstPageText="1" Mode="Numeric" />
                                <Columns>
                                ...
                                <asp:BoundField HeaderText="Product Name " DataField="Definition" />
                                    ...
                                    <asp:BoundField HeaderText="Tax %" DataField="Tax" />
                                    <asp:BoundField HeaderText="Purchase Quantity" DataField="Qty" />
                                    <asp:BoundField HeaderText="Purchase Price" DataFormatString="{0:f}" DataField="Amount" />
                         
                                </Columns>
                                </asp:GridView>
                               Total <label id="lblPurchase" style="margin-left:450px" runat="server"></label>
                                </td>
                                </tr>
                                <tr>
                                <td colspan="4" align="left">
                               Total <label> By Stock</label>
                                <asp:GridView ID="gvstock" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records Found"  
                                        AllowPaging="true" CssClass="myGridStyle" PageSize="10" 
                                        >
                                  <HeaderStyle BackColor="#336699" /><PagerSettings FirstPageText="1" Mode="Numeric" />
                                <Columns>
                              ...
                              Total Qty Available <label id="lblStock" runat="server"></label>
                                </td>
                                </tr>
                                </table>
