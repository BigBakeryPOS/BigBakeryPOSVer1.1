<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodTransferStore.aspx.cs" Inherits="Billing.Accountsbootstrap.GoodTransferStore" %>
...
<head id="Head1">
    ...
    <title>Store Goods Transfer</title>
...
<body>
    ...
    <ContentTemplate>    
            <div class="panel panel-primary" style="">
                            <div class="panel-heading">Store Goods Requested</div>
                                                    ...
                                                    <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="false" Width="100%"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Category" HeaderStyle-Width="175px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCategory" runat="server" Text='<%#Eval("IngreCategory")%>'></asp:Label>
                                                                    <asp:HiddenField ID="HDCategoryid" runat="server" Value='<%#Eval("IngCatID") %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Item Name" HeaderStyle-Width="450px">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProduct" runat="server" Text='<%#Eval("IngredientName")%>'></asp:Label>
                                                                    <asp:HiddenField ID="HDProductid" runat="server" Value='<%#Eval("IngridID") %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Store Qty" HeaderStyle-Width="110px">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Store to Branch" HeaderStyle-Width="110px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txttransferQty" runat="server" Width="110px"></asp:TextBox>
                                                            ...
                                                            <asp:BoundField HeaderText="Rate" DataField="Rate" Visible="false" DataFormatString="{0:n}" />
    ...
    <div>
        ...
        <asp:Panel ScrollBars="Auto" Height="600px" Width="900px" ID="DivDeleteConfirmation"
            ...
            <div>
                ...
                <div align="center">
                    <asp:Button ID="btnPreview1" runat="server" CssClass="btn btn-danger" OnClientClick="ClientSideClick(this)" UseSubmitBehavior="false" Text="Ok" OnClick="btnPrev_Click" />
