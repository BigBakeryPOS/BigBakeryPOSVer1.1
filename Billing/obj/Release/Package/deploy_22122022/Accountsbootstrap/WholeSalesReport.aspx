<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WholeSalesReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.WholeSalesReport" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server" OnRowDataBound="gvsales_OnRowDataBound"
                                        Caption="Whole Sales Details" ShowFooter="true" AutoGenerateColumns="false"
                                        CssClass="mGrid">
