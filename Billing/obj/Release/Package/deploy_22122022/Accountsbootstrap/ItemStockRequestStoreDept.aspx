<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemStockRequestStoreDept.aspx.cs" Inherits="Billing.Accountsbootstrap.ItemStockRequestStoreDept" %>
...
<head>
    ...
    <title>Department Stock Request </title>
    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Department Stock Request</h1>
	    </div>
                ...
                Entry Date:<asp:Label ID="lblentrydatetime" runat="server" ></asp:Label>
                            ...
                            <div class="col-lg-3">
                                ...
                                <asp:TextBox ID="txtpodate" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                            ...
                            <div class="col-lg-3">
                               ...
                               <asp:DropDownList ID="drpdepartment" runat="server" CssClass="form-control" OnSelectedIndexChanged="dept_chnaged" AutoPostBack="true" >
                            </asp:DropDownList>
                                </div>
                            <div class="col-lg-3">
                                <label>
                        ...
                        <div class="row">
                            ...
                            <label id="lblcap" runat="server" >Selected Category Items</label>
                                <div id="divid" runat="server" class="table-responsive panel-grid-left">
                                    <asp:GridView ID="gvitems" runat="server" AutoGenerateColumns="false" cssClass="table table-striped pos-table"  Width="100%" padding="0" spacing="0" border="0">
