<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterProdRequest.aspx.cs" Inherits="Billing.Accountsbootstrap.InterProdRequest" %>
...
<head>
    ...
    <title>Inter Prod Stock Request </title>
    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Prod Stock Request</h1>
	    </div>
                    ...
                    <div class="row">
                        ...
                        Entry Date:<asp:Label ID="lblentrydatetime" runat="server" ></asp:Label>
                            ...
                            <div class="col-lg-3">
                                ...
                                &nbsp;<asp:Button ID="btnexit" runat="server" Text="Exit" CssClass="btn btn-link" OnClick="btnexit_Click" />
                            </div>
                        </div>
                        <div class="row">
