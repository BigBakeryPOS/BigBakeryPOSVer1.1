<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SemiCategoryGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.SemiCategoryGrid" %>
...
<head>
    ...
    <title>Semi Category Details </title>
        ...
        <div class="popup_Container">
            ...
            <div class="popup_Body">
                <p>
                    ...
                    <blink> <label  style="color:Red; font-size:12px">If you Delete This Semi Category It Will Affect Your Branchs!!!</label> </blink>
                </p>
            </div>
