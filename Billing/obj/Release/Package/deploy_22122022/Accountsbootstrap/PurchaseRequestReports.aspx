                                ...
                                <ContentTemplate>
                                   ...
                                   <div class="table-responsive panel-grid-left">
                                                    ...
                                                    <asp:GridView ID="gvPurchaseEntry" runat="server" EmptyDataText="No Record Found"
                                                        ...
                                                        DataKeyNames="RequestNO" OnRowDataBound="gvPurchaseEntry_RowDataBound" padding="0" spacing="0" border="0">
                                                            ...
                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30%" HeaderText="Req. No."
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div id="dv<%# Eval("RequestNO") %>" style="display: none; position: relative;">
                                                                        <asp:GridView runat="server" ID="gvdetails" GridLines="Both" AutoGenerateColumns="false" cssClass="table table-striped pos-table"
