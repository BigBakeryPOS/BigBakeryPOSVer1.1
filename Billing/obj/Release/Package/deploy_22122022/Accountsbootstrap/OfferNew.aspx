<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfferNew.aspx.cs" Inherits="Billing.Accountsbootstrap.OfferNew" %>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <asp:ValidationSummary runat="server" HeaderText="Validation Messages" ValidationGroup="val1"
                                    ...
                                    <label>
                                        Category</label>
                                    <asp:DropDownList runat="server" ID="drpCategory"   class="form-control">
                                    </asp:DropDownList>
                                </div>
                                    ...
                                    <asp:TextBox CssClass="form-control" ID="txtcomboname" runat="server" MaxLength="150"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox CssClass="form-control" ID="txtfromdate" runat="server" MaxLength="150" ></asp:TextBox>
                                              ...
                                              PopupButtonID="txtfromdate" EnabledOnClient="true" runat="server" Format="dd/MM/yyyy" CssClass="cal_Theme1"></ajaxToolkit:CalendarExtender>
                                         <asp:Label ID="Label1" runat="server" style="color:Red"></asp:Label> 
                                            ...
                                            <asp:TextBox CssClass="form-control" ID="txttodate" runat="server"  MaxLength="150" ></asp:TextBox>
                                              <ajaxToolkit:CalendarExtender ID="CalendarExtender2" TargetControlID="txttodate" Format="dd/MM/yyyy" PopupButtonID="txttodate"
                                               EnabledOnClient="true" runat="server" CssClass="cal_Theme1"></ajaxToolkit:CalendarExtender>
                                       
                                                                                 </div>
                                                                                  <div class="form-group">
                                            <label>From Time </label>
                                          <asp:DropDownList ID="ddlTimeFrom" CssClass="form-control" runat="server"></asp:DropDownList>
                                          <asp:Label ID="fromtime" runat="server" BackColor="Red" Font-Bold="true" ForeColor="White" Visible="false"></asp:Label>
                                           ...
                                           <asp:Label ID="totime" runat="server" BackColor="Red" Font-Bold="true" ForeColor="White" Visible="false"></asp:Label>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="Table1" width="100%">
                                                <tr>
                                                   ...
                                                   <asp:Panel  ID="Panel1" runat="server" Width="100%">
                                                        <asp:GridView ID="gvcombo" AutoGenerateColumns="False" ShowFooter="false"
                                                            ...
                                                            <Columns>
                                                              <asp:TemplateField HeaderText="S.No" ItemStyle-Width="3%">
                                                                ...
                                                                <asp:TemplateField HeaderText="Item Name" ItemStyle-Width="30%">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList CssClass="form-control" ID="drpitem" OnSelectedIndexChanged="drpitem_changed" AutoPostBack="true" runat="server">
                                                                        </asp:DropDownList>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Qty" ItemStyle-Width="20%">
                                                                    ...
                                                                    <asp:TextBox ID="txtqty" OnTextChanged="txtQty_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Rate" ItemStyle-Width="20%">
                                                                    <ItemTemplate>
                                                                  
                                                                    <asp:TextBox ID="txtrate" runat="server" OnTextChanged="txtRate_TextChanged" AutoPostBack="true" CssClass="form-control"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Button ID="ButtonAdd1" runat="server" AutoPostback="false" 
                                                                        EnableTheming="false" Height="30px" Text="Add New"  OnClick="ButtonAdd1_Click"
                                                                         />
                                                                </ItemTemplate>
                                                        ...
                                                        <div align="right" >
                                                        <asp:TextBox ID="getttal"  runat="server" Text="0.00" style="padding-left: -26px;  margin-right: 165px;  width: 100px;"></asp:TextBox>
                                                        </div>
                                                        </asp:Panel>
                                                        </ContentTemplate>
                                                        </asp:UpdatePanel>
