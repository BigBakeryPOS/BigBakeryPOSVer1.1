<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WholeSalesReturnPrint.aspx.cs" Inherits="Billing.Accountsbootstrap.WholeSalesReturnPrint" %>
                    ...
                    <table border="1" width="100%">
                        <tr>
                            ...
                            <td width="54%" valign="top" style="border-right: solid 1px">
                                ...
                                Narrations :
                                <asp:Label ID="lblNarrations" runat="server"></asp:Label><br />
                            </td>
                            <td width="2%">
                            </td>
                    ...
                    <table width="595px" class="style1">
                        <tr>
                            <td align="center">
                                ...
                                <asp:Button ID="btnexit" runat="server" Text="Exit" PostBackUrl="~/Accountsbootstrap/WholeSalesReturnGrid.aspx"/>
                            </td>
                        </tr>
                    </table>
                </td>
