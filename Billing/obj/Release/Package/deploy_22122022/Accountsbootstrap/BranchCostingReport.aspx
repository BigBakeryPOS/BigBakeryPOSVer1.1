<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchCostingReport.aspx.cs" Inherits="Billing.Accountsbootstrap.BranchCostingReport" %>
...
<head id="Head1">
    ...
    <title>Branch Costing Report</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <asp:UpdatePanel ID="Updatepnel" runat="server" UpdateMode="Conditional">
        ...
        <div class="panel-header">
          <h1 class="page-header">Branch costing Report</h1>
	    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <asp:RadioButtonList ID="radbtnlist" runat="server" RepeatColumns="3">
                                        <asp:ListItem Text="Costing Report" Value="1" ></asp:ListItem>
                                    ...
                                    <div class="col-lg-12">
                                                    ...
                                                    <div id="divdetails">
                                                        <asp:GridView ID="gvdetailed" runat="server" AllowPaging="false"  cssClass="table table-striped pos-table" padding="0" spacing="0" border="0"
                                                             ShowFooter="true" OnRowDataBound="gvdetailed_rowdatabound"
                                                            ...
                                                            <asp:TemplateField HeaderText="S.No">
                                                                ...
                                                                <asp:BoundField HeaderText="OP Value" DataField="OpStockValue"  />
                                                                
                                                                <asp:BoundField HeaderText="Stock In Value" DataField="StockInValue"  />
                                                                <asp:BoundField HeaderText="Sales Value " DataField="SalesValue"  />
                                                                <asp:BoundField HeaderText="Return Value" DataField="SalesReturnValue"  />
                                                                <asp:BoundField HeaderText="Stock Value" DataField="StockValue"  />
                                                                <asp:BoundField HeaderText="Margin Value" DataField="MarginValue"  />
                                                                <asp:BoundField HeaderText="Expense Value" DataField="Expense"  />
                                                                <asp:BoundField HeaderText="Variable Value" DataField="VariableExp"  />
                                                                <asp:BoundField HeaderText="Profit in Value" DataField="Total"  />
                                                                <asp:BoundField HeaderText="Profit in (%)" DataField="percentage"  />
                                                            </Columns>
