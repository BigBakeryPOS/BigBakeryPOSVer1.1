<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashReceiptsGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.CashReceiptsGrid" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <asp:GridView ID="gvsales" align="center" EmptyDataText="No Records Found" runat="server"
                                            ...
                                            <Columns>
                                                <asp:BoundField HeaderText="ReceiptNo No" DataField="ReceiptNo" />
                                                ...
                                                <asp:TemplateField HeaderText="Print">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("ReceiptID") %>'
                                                            CommandName="print">
                                                            <asp:Image ID="print" Width="5%" runat="server" ImageAlign="Middle" ImageUrl="~/images/print (1).png" /></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
