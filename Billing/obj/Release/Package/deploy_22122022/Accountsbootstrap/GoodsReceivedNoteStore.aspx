<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsReceivedNoteStore.aspx.cs" Inherits="Billing.Accountsbootstrap.GoodsReceivedNoteStore" %>
...
<head id="Head1">
    ...
    <title>Store Goods Received</title>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-CssClass="Hide" HeaderStyle-CssClass="Hide">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="Hiddenfield2" runat="server" Value='<%#Eval("Finitemid") %>' />
                                                                    <asp:HiddenField ID="Hiddenfield3" runat="server" Value='<%#Eval("Fincatid") %>' />
                                                            ...
                                                            <asp:BoundField HeaderText="Item Conversion" DataField="FINitem" />  
