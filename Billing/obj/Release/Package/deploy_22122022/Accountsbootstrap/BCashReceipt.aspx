<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCashReceipt.aspx.cs" Inherits="Billing.Accountsbootstrap.BCashReceipt" %>
                    ...
                    <table width="595px" class="style1">
                        <tr>
                            <td align="center">
                                ...
                                <asp:Button ID="btnexit" runat="server" Text="Exit" PostBackUrl="~/Accountsbootstrap/CashReceiptsGrid.aspx" />
                            </td>
                        </tr>
                    </table>
                </td>
