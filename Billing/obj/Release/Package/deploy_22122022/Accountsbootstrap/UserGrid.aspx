<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.UserGrid" %>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField  HeaderText="Delete" Visible="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("EmpID") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
