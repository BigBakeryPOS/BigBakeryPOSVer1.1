<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WholeSalesPrintnew.aspx.cs"
    Inherits="Billing.Accountsbootstrap.WholeSalesPrintnew" %>
...
<body>
    ...
    <center>
        <table border="1" width="100%" height="10px">
                ...
                <tr style="font-family: Courier New; font-weight: bold;" align="center">
                    <td colspan="2" align="center">
                        <asp:Label ID="l2" runat="server" Style="font-weight: bolder; font-size: x-large"
                            Visible="true">TAX INVOICE</asp:Label>
                        <br />
                    </td>
                </tr>
            ...
            <tr style="width: 100%; height: 35px" runat="server" visible="false">
                <td align="left" width="30%">
                    GST:
                    <asp:Label ID="Label2" runat="server" Text="33AAMCM1387P1ZU"></asp:Label>
                </td>
                <td align="center" width="40%">
                    <asp:Label ID="lblname" runat="server" Text="SRI BALAJI SWEETS AND BAKERY" Font-Bold="true">
                    </asp:Label>
            ...
            <asp:GridView runat="server" ID="gridprint" GridLines="Vertical" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Qty" DataField="Qty" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="UM" DataField="UOM" HeaderStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="Unit Price" DataField="Rate" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField HeaderText="Disc" DataField="Disc" HeaderStyle-HorizontalAlign="Center"
                        Visible="false" />
                    <asp:BoundField HeaderText="DiscAmt" DataField="DiscAmount1" HeaderStyle-HorizontalAlign="Center"
                        Visible="false" />
                    <asp:BoundField HeaderText="GST%" DataField="Tax1" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField HeaderText="GST Amt" DataField="TaxAmount" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField HeaderText="Amount" DataField="Amount1" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                    <%-- <asp:BoundField HeaderText="" DataField="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" />--%>
                </Columns>
            </asp:GridView>
        </div>
        <table style="width: 100%; border: solid 1px">
            ...
            <tr style="border: solid 1px" runat="server" id="Disc" visible="false">
                <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: right">
                    <b>Discount(%):</b>
                    <asp:Label Font-Size="16px" Style="text-align: right" ID="lbldiscper" runat="server">
                    </asp:Label>
                </td>
                <td style="border-bottom: solid 1px; text-align: right; width: 15%">
                    <b>Discount(Rs.):</b>
                    <asp:Label Font-Size="16px" Style="text-align: right" ID="lbldiscamt" runat="server">
                    </asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr style="border: solid 1px" runat="server" id="Tax" visible="false">
                <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: right">
                </td>
                <td style="border-bottom: solid 1px; text-align: right; width: 15%">
                    <b>Tax Amount:</b>
                    <asp:Label Font-Size="16px" Style="text-align: right" ID="lblTaxamount" runat="server">
                    </asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr style="border: solid 1px" runat="server" id="DeliveryCharge" visible="false">
                <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: right">
                </td>
                <td style="border-bottom: solid 1px; text-align: right; width: 15%">
                    <b>Delivery Charge:</b><asp:Label Font-Size="16px" Style="text-align: right" ID="lblDeliveryCharge"
                        runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr style="border: solid 1px" runat="server">
                <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: left">
                    <b>Narration:
                        <asp:Label Font-Size="16px" Style="text-align: right" ID="lblNarration" runat="server">
                        </asp:Label></b>
                </td>
                <td style="border-bottom: solid 1px; text-align: right; width: 15%">
                    <b>GrandTotal:
        ...
        <div runat="server" id="div1">
            <asp:GridView runat="server" ID="gvGST" GridLines="Vertical" AutoGenerateColumns="false"
                ShowHeader="true" Width="100%" Style="font-family: 'Trebuchet MS'; font-size: 13px;">
                <HeaderStyle BorderStyle="Solid" BorderWidth="1px" CssClass="centerHeaderText" />
                <Columns>
                    <asp:TemplateField HeaderText="S.No" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <asp:BoundField HeaderText="GST%" DataField="Tax" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField HeaderText="CGST" DataField="CGST" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="SGST" DataField="SGST" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="IGST" DataField="IGST" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="Total GST" DataField="TaxAmount" HeaderStyle-HorizontalAlign="Center"
                        DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                </Columns>
            </asp:GridView>
        </div>
