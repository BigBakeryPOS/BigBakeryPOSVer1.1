<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentEntryPrint.aspx.cs" Inherits="Billing.Accountsbootstrap.PaymentEntryPrint" %>
            ...
            <tr>
                <td colspan="3">
                    <table width="100%" style="border: solid 1px">
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Label ID="lblname" runat="server" Text="Payment Print" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table border="1" width="100%">
                        <tr>
                            ...
                            <td width="38%" valign="top">
                                ...
                                Cheque/UTR
                                <asp:Label ID="lblchequeno" runat="server" Style="text-align: center" ></asp:Label><br />
                    ...
                    <div runat="server" id="divgv">
                        <asp:GridView runat="server" ID="gridprint" AutoGenerateColumns="false" ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Paid Amount" DataField="Amount" DataFormatString="{0:f2}"
                    ...
                    <table style="width: 100%; border: solid 1px">
                        <tr id="Tr1" style="border: solid 1px" runat="server" visible="false">
                        ...
                        <tr id="Tr2" style="border: solid 1px" runat="server" visible="false">
                            <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: right">
                                Sub.Total:
                            </td>
                            <td style="border-bottom: solid 1px; text-align: right; width: 15%">
