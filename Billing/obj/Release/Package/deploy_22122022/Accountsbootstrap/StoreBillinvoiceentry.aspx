...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Store Bill Invoice Entry</h1>
	    </div>
            ...
            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <br />
                                       ...
                                       &nbsp;&nbsp;&nbsp; <asp:Button ID="btnRate" runat="server" Text="Rate Check" OnClick="Rate_Click" cssClass="btn btn-primary pos-btn1" />
                                    </div>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-3">
                         ...
                         <div class="col-lg-3">
                            ...
                            <asp:Button ID="btnexit" runat="server" class="btn btn-lg btn-link" Text="Exit" Width="100px" PostBackUrl="~/Accountsbootstrap/StoreBillInvoiceGrid.aspx" />
                        </div>
