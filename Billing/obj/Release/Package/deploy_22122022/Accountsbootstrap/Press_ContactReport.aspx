<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Press_ContactReport.aspx.cs" Inherits="Billing.Accountsbootstrap.Press_ContactReport" %>
...
<body>
   ...
   <form runat="server" id="form1">
    ...
    <div style="margin-top:100px" class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Press Contact Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
          ...
          <div class="row">
            ...
            <asp:TextBox ID="txtser" Visible="true" runat="server" Width="200px" placeholder="Search Name /
            
            
             Mobile No." CssClass="form-control"  ></asp:TextBox>
             </div>
            <div  class="form-group">
