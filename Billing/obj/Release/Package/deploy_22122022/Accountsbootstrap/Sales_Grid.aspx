<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales_Grid.aspx.cs" Inherits="Billing.Accountsbootstrap.Sales_Grid" %>
    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header"> Raw Sales Entry
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
                ...
                <div class="row">
                    ...
                    <div runat="server" visible="false" class="col-lg-3">
                            ...
                            <asp:DropDownList CssClass=" form-control chzn-select" ID="ddlsuplier" AutoPostBack="true"
                ...
                <div class="col-lg-12">
                            ...
                            <div id="Div1" runat="server" class="table-responsive panel-grid-left">
                                <asp:GridView ID="BankGrid" runat="server" Width="100%" AllowSorting="true" cssClass="table table-striped pos-table" padding="0" spacing="0" border="0"
                                  ...
                                  <%-- <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="LedgerID" DataField="Salesid" Visible="false" />
                                        ...
                                        <asp:BoundField HeaderText="Payment" Visible="false" DataField="Paymentmode" />
                                         ...
                                         <asp:TemplateField HeaderText="Print"  ItemStyle-HorizontalAlign="center" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnPrint" runat="server" CommandArgument='<%#Eval("Salesid") %>'
                                                    CommandName="Print">
                                                      <asp:Image ID="img1" runat="server" ImageUrl="~/images/print%20(1).png" /></asp:LinkButton>
