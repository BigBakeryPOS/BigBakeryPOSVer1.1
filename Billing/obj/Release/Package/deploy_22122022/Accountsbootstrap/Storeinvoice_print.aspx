<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Storeinvoice_print.aspx.cs" Inherits="Billing.Accountsbootstrap.Storeinvoice_print" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Store Invoice Print</title>
                    ...
                    <table width="100%" border="1" style="border: none; height: 10px">
                        ...
                        <tr style="height: 10px">
                            <td align="left" valign="top" class="style2" style="width: 40%; height: 10px" rowspan="4"
                                ...
                                State Name:<asp:Label ID="lblstate" runat="server" ></asp:Label>,Code:<asp:Label ID="lblcode" runat="server" Text="33" ></asp:Label><br />
