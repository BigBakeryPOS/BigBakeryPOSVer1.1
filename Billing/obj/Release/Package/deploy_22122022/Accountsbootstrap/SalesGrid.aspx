                            ...
                            <div class="row">
                                ...
                                <asp:UpdatePanel ID="updatepanel" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                                ...
                                                HorizontalAlign="Center" ForeColor="White" />--%>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Kot Print">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnkotprint" runat="server" CommandArgument='<%#Eval("BillNo") +", "+ Eval("salestype").ToString() %>'
                                                                    CommandName="kotprint">
                                                                    <asp:Image ID="kotprint" runat="server" ImageAlign="Middle" ImageUrl="~/images/print (1).png" Width="55px" />
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                        ...
                                        <td id="refre" runat="server" visible="false"></td>
