<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemandRequestSemiStore.aspx.cs" Inherits="Billing.Accountsbootstrap.DemandRequestSemiStore" %>
...
<head>
    ...
    <title>Demand Semi Stock Request </title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading " style="background-color: #428bca; color: White">
                            <b>Demand Semi Stock Request</b> : Entry Date:<asp:Label ID="lblentrydatetime" runat="server"></asp:Label></div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-2" style="">
                                        <div class="form-group" style="">
                                            ...
                                            <asp:DropDownList ID="drpentrytype" runat="server" Enabled="false" CssClass="form-control">
                                                <asp:ListItem Text="Manual Production" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="From Branch Wise/GRN" Value="2"></asp:ListItem>
                                                <asp:ListItem Text="Demand Request" Value="3" Selected="True"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-lg-1">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-2">
                                        <asp:Button ID="btnaddqueue" runat="server" Text="Add to Queue" OnClick="btnaddqueue_OnClick"
                                            CssClass="btn btn-danger" style="margin-top:2pc" />
                                    </div>
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-1">
                                        <asp:Button ID="btnsave" runat="server" Text="Send Request" OnClientClick="ClientSideClick(this)"
                                            UseSubmitBehavior="false" CssClass="btn btn-success" style="margin-top:2pc" OnClick="btnsave_Click" />
                                    </div>
                                    <div class="col-lg-1">
                                        <asp:Button ID="btnexit" style="margin-top:2pc" runat="server" Text="Exit" CssClass="btn btn-warning" OnClick="btnexit_Click" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div id="divid" runat="server" style="height: 370px; overflow-x: auto;">
                                            <asp:GridView ID="gvitems" runat="server" AutoGenerateColumns="false" Font-Names="Calibri"
                                                Width="100%">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField Visible="false" HeaderText="Available Qty">
                                                        <ItemTemplate>
