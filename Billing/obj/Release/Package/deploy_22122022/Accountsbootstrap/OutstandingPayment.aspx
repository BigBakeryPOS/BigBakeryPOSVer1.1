<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutstandingPayment.aspx.cs" Inherits="Billing.Accountsbootstrap.OutstandingPayment" %>
...
<body>
   ...
   <form runat="server" id="form1" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                            <label style="padding-top:20px">Select Customer</label>
    ...
    <asp:BoundField HeaderText="Pending Amount" DataField="Balance" DataFormatString="{0:N}" />
     <asp:BoundField HeaderText="Branch" DataField="Branch" DataFormatString="{0:N}" />
   ...
   <HeaderStyle BackColor="#336699" Font-Bold="True" ForeColor="White" HorizontalAlign="Left" />
                                ...
                                <td>
                                <label id="lbldays" runat="server"></label>
                                </td>
                                </td>
                                </tr>
                                </table>
