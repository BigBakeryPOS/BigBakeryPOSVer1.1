<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseRequestGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.PurchaseRequestGrid" %>
...
<head>
    ...
    <title>Daily Stock Entry Grid </title>
    <!-- Bootstrap Core CSS -->
...
<body>
   ...
   <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Daily Stock Request Details
                ...
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="table-responsive panel-grid-left">
                                <asp:GridView ID="gvPurchaseEntry" runat="server" AllowPaging="true" PageSize="10" cssClass="table table-striped pos-table"  padding="0" spacing="0" border="0"
     ...
     <ItemTemplate>
           <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("SalesID") %>' CommandName="delete" OnClientClick="alertMessage()"><asp:Image ID="dlt" runat="server" ImageAlign="Middle" ImageUrl="~/images/delete.png" /></asp:LinkButton>
                                ...
                                <div class="col-lg-6">
                                <div class="table-responsive panel-grid-left">
                                <asp:GridView ID="gvPurchaseReqDetails"  cssClass="table table-striped pos-table"
                                    runat="server" AutoGenerateColumns="false" Width="100%"  padding="0" spacing="0" border="0">
                                  <%--  <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> --%>
                                    <Columns>
