<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewHeader.ascx.cs" Inherits="Billing.HeaderMaster.NewHeader" %>
  ...
  <option value="30">30</option>
                ...
                <td style="width: 30%; background-color: #6c7079;">
                    <div id="Div1" runat="server" class="container-fluid">
                        ...
                        <a href="../Accountsbootstrap/Home_Page.aspx">
                            <img src="../images/BlackForrestRe.png" backcolor="White" alt="logo" style="width: 70px;
                                background: white;" /></a><br />
    ...
    <div id='cssmenu' style="background-color: darkblue; height: 47px">
        <ul>
            ...
            <li><a href="../Accountsbootstrap/HomePage.aspx">
                <img src="../images/logo11.png" backcolor="White" alt="logo" style="width: 40px;
                    margin-top: -10px; background: white;" /></a> </li>
            ...
            <li id="MasterMenu" visible="false" class='has-sub' runat="server" style="color: White">
                ...
                <ul>
                    ...
                    <li id="IBSM" runat="server" visible="false"><a href="../Accountsbootstrap/InterBranchSetting.aspx">
                        Intet Branch Setting Master</a></li>
                    <li id="IPS" runat="server" visible="false"><a href="../Accountsbootstrap/InterProdSetting.aspx">
                        Intet Prod/Store Setting Master</a></li>
                    <li id="STSIS" runat="server" visible="false"><a href="../Accountsbootstrap/StoreItemSetting.aspx">
                        Store To Shop Item Setting Master</a></li>
                    <li id="UOM" runat="server" visible="false"><a href="../Accountsbootstrap/Uom.aspx">
                        Uom Master</a></li>
                    <li id="vehiclemaster" runat="server" visible="false"><a href="../Accountsbootstrap/VehicleMaster.aspx">
                        Vehicle Master</a></li>
                    <li id="TAX" runat="server" visible="false"><a href="../Accountsbootstrap/Tax.aspx">
                        Tax Master</a></li>
                    <li id="Category" runat="server" visible="false"><a href="../Accountsbootstrap/categorygrid.aspx">
                        Group Master</a></li>
                    <li id="Msetting" runat="server" visible="false"><a href="../Accountsbootstrap/MarginSetting.aspx">
                        Margin Setting</a></li>
                    <li id="subcategory" runat="server" visible="false"><a href="../Accountsbootstrap/SubCategory.aspx">
                        Sub Category Master</a></li>
                    <li id="Item" runat="server" visible="false"><a href="../Accountsbootstrap/Descriptiongrid.aspx">
                        Item Master</a></li>
                    <li id="combo" runat="server" visible="false"><a href="../Accountsbootstrap/ComboGrid.aspx">
                        Combo Master</a></li>
                    <li id="itemupdate" runat="server" visible="false"><a href="../Accountsbootstrap/itemupdatescreen.aspx">
                    ...
                    <li id="Online" runat="server" visible="false"><a href="../Accountsbootstrap/OnlineMaster.aspx">
                        Online Master</a></li>
                    <li id="BranchSetting" runat="server" visible="false"><a href="../Accountsbootstrap/BranchSetting.aspx">
                    ...
                    <li id="SemiRaw" runat="server" visible="false"><a href="../Accountsbootstrap/SemiRawSetting.aspx">
                        Recepie Settings</a></li>
                    <li id="Ledger" runat="server" visible="false"><a href="../Accountsbootstrap/LedgerMasterGrid.aspx">
                        Ledger Master</a></li>
                    <li id="Dealer" visible="false" runat="server"><a href="../Accountsbootstrap/ReceiptReport.aspx">
                        Dealer Creation</a></li>
                    <li id="MinimumQty" runat="server" visible="false"><a href="../Accountsbootstrap/MinQty.aspx">
                        Minimum Qty Set </a></li>
                    <li id="ChangeRate" visible="false" runat="server"><a href="../Accountsbootstrap/ChangeRate.aspx">
                        Change Rate</a></li>
                    <li id="Waiter" runat="server" visible="false"><a href="../Accountsbootstrap/Waiter.aspx">
                        Waiter</a></li>
                    <li id="RequestStockSettings" runat="server" visible="false"><a href="../Accountsbootstrap/RequestStockSettings.aspx">
                        Request Stock Settings</a></li>
                    <li id="CategorySettingsMaster" runat="server" visible="false"><a href="../Accountsbootstrap/CategorySettingsMaster.aspx">
                        Category Settings Master</a></li>
                    <li id="DepartmentSetting" runat="server" visible="false"><a href="../Accountsbootstrap/DepartmentSetting.aspx">
                        Department Setting</a></li>
                    <li id="Mbranch" runat="server" visible="false"><a href="../Accountsbootstrap/BranchGrid.aspx">
                        Branch Master</a></li>
                    <li id="ModelMaster" runat="server" visible="false"><a href="../Accountsbootstrap/ModelScreen.aspx">
                        Model Master</a></li>
            ...
            <li id="OrderFormMenu" runat="server" visible="false" class='has-sub'><a id="A10"
                ...
                <ul>
                    <li id="OrderForm" runat="server" visible="false"><a href="../Accountsbootstrap/OrderGrid.aspx">
                        Order Form</a></li>
                    <li id="TodaysDelivery" runat="server" visible="false"><a href="../Accountsbootstrap/TodaysDeliveryOrder.aspx">
            ...
            <li id="InventoryMenu" visible="false" runat="server" class='has-sub'><a href="javascript:;"
                ...
                <ul>
                    <li id="rawsales" runat="server" visible="false"><a href="../Accountsbootstrap/sales_grid.aspx">
                        Raw Sales</a></li>
                    <li id="PO" runat="server" visible="false"><a href="../Accountsbootstrap/Purchase_OrderGrid.aspx">
                        Purchase Order</a></li>
                    <li id="RawPurchase" runat="server" visible="false"><a href="../Accountsbootstrap/Purchase_invGrid.aspx">
                        Raw Purchase</a></li>
                    <li id="PurRtn" runat="server" visible="false"><a href="../Accountsbootstrap/Purchase_ReturnGrid.aspx">
                        Purchase Return</a></li>
                    <li id="restkotsales" runat="server" visible="false"><a href="../Accountsbootstrap/RestaurantSalesKot.aspx">
                        Kot Sales</a></li>
                    <li id="KitchenOrders" runat="server" visible="false"><a href="../Accountsbootstrap/KitchenOrders.aspx">
                        Kitchen Orders</a></li>
                    <li id="oprawentry" runat="server" visible="false"><a href="../Accountsbootstrap/PhysicalStockEntry.aspx">
                        Store Opening Stock Entry</a></li>
                    <li id="Sales" runat="server" visible="false"><a href="../Accountsbootstrap/SalesGrid.aspx">
                        Sales</a></li>
                    <li id="wholesale" runat="server" visible="false"><a href="../Accountsbootstrap/WholeSalesGrid.aspx">
                        Whole Sales Entry</a></li>
                    <li id="wholesaleReturn" runat="server" visible="false"><a href="../Accountsbootstrap/WholeSalesReturnGrid.aspx">
                        Whole Sales Return Entry</a></li>
                    <li id="StockReturn" runat="server" visible="false"><a href="../Accountsbootstrap/ItemReturngrid.aspx">
                        Stock Return</a></li>
            ...
            <li id="OrderRights" runat="server" visible="false"><a href="../Accountsbootstrap/OrderRightsGrid.aspx">
                Order Rights</a></li>
            <li id="Cakeordersummary" runat="server" visible="false"><a href="../Accountsbootstrap/orderassign.aspx">
            ...
            <li id="RequestAccept" visible="false" runat="server" class='has-sub'><a href="javascript:;"
                ...
                <ul>
                    <li id="StockMaster" runat="server" visible="false"><a href="../Accountsbootstrap/stockgrid.aspx">
                        GRN Master</a></li>
                    <li id="StockRequest" runat="server" visible="false"><a href="../Accountsbootstrap/PurchaseRequestGrid.aspx">
                        Daily Stock Request</a> </li>
                    <li id="GoodsReceived" runat="server" visible="false"><a href="../Accountsbootstrap/GoodsReceivedGrid.aspx">
                        Goods Received</a> </li>
                    <li id="storerequest" runat="server" visible="false"><a href="../Accountsbootstrap/PurchaseReqStoreGrid.aspx">
                        Store Stock Request</a> </li>
                    <li id="storegoodsreceived" runat="server" visible="false"><a href="../Accountsbootstrap/GoodsReceivedStoreGrid.aspx">
                        Store Goods Received</a> </li>
                    <li id="IBSR" runat="server" visible="false"><a href="../Accountsbootstrap/InterBranchStockRequestGrid.aspx">
                        Inter Branch Stock Request</a> </li>
                    <li id="IBSRFB" runat="server" visible="false"><a href="../Accountsbootstrap/RequestFromBranchGrid.aspx">
                        Inter Branch Stock Request From Branch</a> </li>
                    <li id="IGRG" runat="server" visible="false"><a href="../Accountsbootstrap/InterGoodsReceivedGrid.aspx">
                        Inter Branch Stock Received</a> </li>
                    ...
                    <li id="RequestRawItem" runat="server" visible="false"><a href="../Accountsbootstrap/GoodsTransferNewGrid.aspx">
                        Request Raw Item to Store</a></li>
                    ...
                    <li id="ReceiveProductionStock" runat="server" visible="false"><a href="../Accountsbootstrap/ReceiveProductionStockGrid.aspx">
                        Add Production Stock </a></li>
                    <li id="ReturnReceiving" runat="server" visible="false"><a href="../Accountsbootstrap/ReturnReceiving.aspx">
                        Return Receiving From Branch </a></li>
                    <li id="IcingRequest" runat="server" visible="false"><a href="../Accountsbootstrap/home_page.aspx">
                        Icing Request </a></li>
                    <li id="IcingReceive" runat="server" visible="false"><a href="../Accountsbootstrap/home_page.aspx">
                        Icing Received </a></li>
                    <li id="IPSR" runat="server" visible="false"><a href="../Accountsbootstrap/InterProdGrid.aspx">
                        Inter Production Stock Request</a> </li>
                    <li id="IPSRFP" runat="server" visible="false"><a href="../Accountsbootstrap/RequestFromProdGrid.aspx">
                        Inter Production Stock Request From Production</a> </li>
                    <li id="IPGRG" runat="server" visible="false"><a href="../Accountsbootstrap/InterProdGoodsReceivedGrid.aspx">
                        Inter Production Stock Received</a> </li>
                    <li id="DISENT" runat="server" visible="false"><a href="../Accountsbootstrap/dispatchentry.aspx">
                        Dispatch Entry</a></li>
                    <li id="ISSR" runat="server" visible="false"><a href="../Accountsbootstrap/InterStoreGrid.aspx">
                        Inter Store Stock Request</a> </li>
                    <li id="ISSRFS" runat="server" visible="false"><a href="../Accountsbootstrap/RequestFromStoreGrid.aspx">
                        Inter Store Stock Request From Store</a> </li>
                    <li id="ISGRG" runat="server" visible="false"><a href="../Accountsbootstrap/InterstoreGoodsReceivedGrid.aspx">
                        Inter Production Stock Received</a> </li>
                </ul>
            </li>
                ...
                New Dashboard Template</a></li>
                    ...
                    <li id="OrderFormReport" class='has-sub' runat="server" visible="false"><a id="A24" href="javascript:;"
                        ...
                        <ul>
                            ...
                            <li id="OrderFormRep" runat="server" visible="false"><a href="../Accountsbootstrap/customerorderformreport.aspx">
                                Order Form Report</a></li>
                            <li id="OrderFormCancel" runat="server" visible="false"><a href="../Accountsbootstrap/OrderFormCancelledReport.aspx">
                                OrderForm Cancel Report</a></li>
                            ...
                            <li id="TodaysAdvance" runat="server" visible="false"><a href="../Accountsbootstrap/SplitUp.aspx">
                                Today's Advance and Balance</a></li>
                    ...
                    <li id="RawPurchaseReport" class='has-sub' runat="server" visible="false"><a id="A29" href="javascript:;"
                        ...
                        <ul>
                            <li id="StoreStockDetails" runat="server" visible="false"><a href="../Accountsbootstrap/StoreStockDetails.aspx">
                                StoreStockDetails </a></li>
                            <li id="storestockdetailedreport" runat="server" visible="false"><a href="../Accountsbootstrap/storeStockDeatailedReport.aspx">
                                Store Stock Detailed Report </a></li>
                            <li id="KitchenUsageReport" runat="server" visible="false"><a href="../Accountsbootstrap/KitchenUsageReport.aspx">
                                KitchenUsageReport </a></li>
                            <li id="KitchenrawreceivedReport" runat="server" visible="false"><a href="../Accountsbootstrap/RawReceivedReport.aspx">
                    ...
                    <li id="SalesReport" class='has-sub' runat="server" visible="false"><a id="ASalesReport" href="javascript:;"
                        ...
                        <ul>
                            <li id="CustomerSalesRep" runat="server" visible="false"><a href="../Accountsbootstrap/CustomerSalesReport.aspx">
                                Customer Sales Report</a></li>
                            <li id="CustomerSalesKotRep" runat="server" visible="false"><a href="../Accountsbootstrap/customerKotReport.aspx">
                                Customer Sales Kot Report</a></li>
                            <li id="Scredit" runat="server" visible="false"><a href="../Accountsbootstrap/SalesTypeCreditreport.aspx">
                                Sales employee Wise Report</a></li>
                            <li id="SType" runat="server" visible="false"><a href="../Accountsbootstrap/SalesTypeReport.aspx">
                                Sales Type Report</a></li>
                            <li id="SalesSummary" runat="server" visible="false"><a href="../Accountsbootstrap/salessummary.aspx">
                                Sales Summary Report</a></li>
                            <li id="NormalSalesCancelRep" runat="server" visible="false"><a href="../Accountsbootstrap/customercancelreport.aspx">
                                Normal Sales Cancel Report</a></li>
                            <li id="SalesHoursReport" runat="server" visible="false"><a href="../Accountsbootstrap/saleshourreport.aspx">
                                Sales Hour's Report</a></li>
                            <li id="HourlysalesReport" runat="server" visible="false"><a href="../Accountsbootstrap/DetailedHourlyReport.aspx">
                                Hourly sales Report- Detailed </a></li>
                    ...
                    <li id="StockReport" class='has-sub' runat="server" visible="false"><a runat="server" href="javascript:;">
                        ...
                        <ul>
                            <li id="Productionrep" runat="server" visible="false"><a href="../Accountsbootstrap/Production_Report.aspx">
                                Production GRN Report</a></li>
                            <li id="Stockrep" runat="server" visible="false"><a href="../Accountsbootstrap/StockReport.aspx">
                                Avaliable Stock Report</a></li>
                            ...
                            <li id="GRNReport" runat="server" visible="false"><a href="../Accountsbootstrap/GRNReport.aspx">
                                GRN Report</a></li>
                            <li id="GRNPMRPT" runat="server" visible="false"><a href="../Accountsbootstrap/GRNPMREPORT.aspx">
                                GRN-P/M Report</a></li>
                            <li id="FULLGRNReport" runat="server" visible="false"><a href="../Accountsbootstrap/StockFlowReport.aspx">
                                FULL GRN Report </a></li>
                            <li id="SlotGRNReport" runat="server" visible="false"><a href="../Accountsbootstrap/VendorHistory.aspx">
                                Slot GRN Report </a></li>
                            <li id="StockDeatailedReport" runat="server" visible="false"><a href="../Accountsbootstrap/StockDeatailedReport.aspx">
                            ...
                            <li id="StockReturned" runat="server" visible="false"><a href="javascript:;">Stock Returned </a>
                                <ul>
                                    ...
                                    <li id="StockReturnChart" runat="server" visible="false"><a href="../Accountsbootstrap/CRMReturns.aspx">
                                        Stock Return Chart </a></li>
                            ...
                            <li id="Li1" runat="server" visible="false"><a href="../Accountsbootstrap/DatabaseBackUp.aspx">
                                DB Backup </a></li>
                            <li id="DailyStockRequestRep" runat="server" visible="false"><a href="../Accountsbootstrap/PurchaseRequestReports.aspx">
                                Daily Stock Request Report</a></li>
                            <li id="DailyStockReceivedRep" runat="server" visible="false"><a href="../Accountsbootstrap/StockREceivedFromBranch.aspx">
                                Daily Stock Received Report</a></li>
                            <li id="StockReturnandGRN" runat="server" visible="false"><a href="../Accountsbootstrap/StockReportsforBoth.aspx">
                                Stock Return and GRN</a></li>
                            <li id="IBSRR" runat="server" visible="false"><a href="../Accountsbootstrap/InterBranchStockRequestReport.aspx">
                                Inter-Branch Stock Request Report</a></li>
                            <li id="IBSRECR" runat="server" visible="false"><a href="../Accountsbootstrap/InterBranchReceivedReport.aspx">
                                Inter-Branch Stock Received Report</a></li>
                            <li id="IBSTR" runat="server" visible="false"><a href="../Accountsbootstrap/InterGoodsTransferReport.aspx">
                                Inter-Branch Stock Transfer Report</a></li>
                            <li id="IPSRR" runat="server" visible="false"><a href="../Accountsbootstrap/InterProdStockRequestReport.aspx">
                                Inter-Production Stock Request Report</a></li>
                            <li id="IPRECR" runat="server" visible="false"><a href="../Accountsbootstrap/InterProdReceivedReport.aspx">
                                Inter-Production Stock Received Report</a></li>
                            <li id="IPSTR" runat="server" visible="false"><a href="../Accountsbootstrap/InterProdGoodsTransferReport.aspx">
                                Inter-Production Stock Transfer Report</a></li>
                            <li id="ISSRR" runat="server" visible="false"><a href="../Accountsbootstrap/InterstoreStockRequestReport.aspx">
                                Inter-Store Stock Request Report</a></li>
                            <li id="ISRECR" runat="server" visible="false"><a href="../Accountsbootstrap/InterStoreReceivedReport.aspx">
                                Inter-Store Stock Received Report</a></li>
                            <li id="ISSTR" runat="server" visible="false"><a href="../Accountsbootstrap/InterStoreGoodsTransferReport.aspx">
                                Inter-Store Stock Transfer Report</a></li>
                        </ul>
                    </li>
                    ...
                    <li id="supplierhead" class='has-sub' runat="server" visible="false"><a id="supplierreport"
                        ...
                        <ul>
                            ...
                            <li id="SupplierPaymentReport" runat="server" visible="false"><a href="../Accountsbootstrap/PaymentEntryReport.aspx">
                                Supplier Payment Report </a></li>
                            <li id="SupplierOutStanding" runat="server" visible="false"><a href="../Accountsbootstrap/SupplierOutStanding.aspx">
                    ...
                    <li id="PaymentReport" class='has-sub' runat="server" visible="false"><a id="A31" href="javascript:;"
                        ...
                        <ul>
                            <li id="CustomerReceiptReport" runat="server" visible="true"><a href="../Accountsbootstrap/CashReceiptsReport.aspx">
                                Customer Receipt Report</a></li>
                            <li id="CustomerOutStandingReport" runat="server" visible="true"><a href="../Accountsbootstrap/CustomerOutStanding.aspx">
                                Customer OutStanding Report</a></li>
                            <li id="SalesandReceiptReport" runat="server" visible="true"><a href="../Accountsbootstrap/SalesandReceiptReport.aspx">
    ...
    <div class="footer" visible="false">
        ...
        <div id="hide" style="display: none; background-color: Black; font-size: large; color: White">
            Messege</div>--%>
        <div id="divv1" style="width: auto; display: none; background-color: Green; color: Black;
            height: 100px">
            <div>
