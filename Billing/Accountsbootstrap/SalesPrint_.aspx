        ...
        <div align="center">
            <table width="500px" style="font-size: x-large; font-family: Calibri; font-weight: bold">
               ...
               <%-- <tr>
                ...
                <tr runat="server" id="staxdetails" visible="false" style="width: 100%" >
                    <td colspan="2" >
                    <label runat="server" style="font-size:16px" >Tax Split Up Details :</label>
                        <asp:GridView ID="GridTaxvalue" EmptyDataText="No Tax Split Up Details" runat="server"
                            Width="100%" AutoGenerateColumns="false" Font-Names="Calibri" Font-Size="16px">
                            <Columns>
                                <asp:BoundField HeaderText="Tax Value" DataField="taxvalue" />
                                <asp:BoundField HeaderText="HSN Code" Visible="false" DataField="hsncode" />
                                <asp:BoundField HeaderText="Item Value" DataField="value" />
                                <asp:BoundField HeaderText="CGST Value" DataField="CGST" />
                                <asp:BoundField HeaderText="SGST Value" DataField="SGST" />
                ...
                <tr>
                    <td colspan="2" style="font-size: large; text-decoration: none; border-bottom: 3px dotted black; padding-bottom:1pc">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <label style="font-size: x-large">
                            For FeedBack/Queries - 84899-55500</label>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <label style="font-size: x-large">
                            www.Facebook.com/blaackforestcakes</label>
                    </td>
                </tr>
                <%-- <tr>
                    <td colspan="2" align="center">
