...
{
    public partial class StoreBillInvoiceGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.GwtStoreinvoiceBillgrid(sTableName);
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("StoreBillinvoiceentry.aspx");
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = objBs.GwtSToreinvoiceBillgridsearch(sTableName, ddlbillno.SelectedValue, txtAutoName.Text);
        ...
        protected void gvsales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "view")
            {
                ...
                ds = objBs.GwtStoreinvoiceBillgridbyid(sTableName, (e.CommandArgument.ToString()));
            ...
            else if (e.CommandName == "print")
            {
                ...
                string yourUrl = "Storeinvoice_print.aspx?&iinvoiceID=" + billno;
        ...
        public void gvCustsales_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (gvGroup.DataKeys[e.Row.RowIndex].Value != "")
                {
                    ...
                    DataSet ds = objBs.gettransitemforid_Store(sTableName, groupID.ToString());
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    if (ds.Tables[0].Rows.Count > 0)
                    {
