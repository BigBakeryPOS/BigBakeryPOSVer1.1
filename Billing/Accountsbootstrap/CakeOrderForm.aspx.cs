...
{
    public partial class CakeOrderForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblmaxdiscount.Text = Convert.ToDouble(getmaxdiscamnt.Tables[0].Rows[0]["maxdisc"]).ToString("0.00");
                }
                ...
                if (OrderNo != null)
                {
                    ...
                    if (dBilling.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (getpaid.Tables[0].Rows.Count > 0)
                        {
                            ...
                            totpaid.Text = (Convert.ToDouble(getpaid.Tables[0].Rows[0]["Amt"]) - refund).ToString("0.00");
                        }
                        else
                        {
                            totpaid.Text = "0";
                        ...
                        drpproductiontype.SelectedValue = dBilling.Tables[0].Rows[0]["Protype"].ToString();
                        ...
                        if (status == "Y")
                        {
                            ...
                            lblbalpaid.Text = Convert.ToDouble(dBilling.Tables[0].Rows[0]["balance"]).ToString("0.00");
                            ...
                            txtAdvance.Text = Convert.ToDouble(totpaid.Text).ToString("0.00");
                        }
                        else
                        {
                        ...
                        //for (int i = 0; i < iCount; i++)
                        {
                            ...
                            for (int vLoop = 0; vLoop < gridorder.Rows.Count; vLoop++)
                            {
                                ...
                                DropDownList drpset = (DropDownList)gridorder.Rows[vLoop].FindControl("drpset");
                                ...
                                drpset.SelectedValue = Convert.ToInt32(dstd.Tables[0].Rows[vLoop]["set"]).ToString();
                ...
                //if (iOrderNo != null)
                {
                    ...
                    //    txtBalance.Text = (Convert.ToDouble(dsedit.Tables[0].Rows[0]["NetAmount"]) - Convert.ToDouble(dsedit.Tables[0].Rows[0]["Advance"])).ToString("f2");
        ...
        private void FirstGridViewRow()
        {
            ...
            dt.Columns.Add(new DataColumn("Shapeid", typeof(string)));
            dt.Columns.Add(new DataColumn("Shaperate", typeof(string)));
            //dt.Columns.Add(new DataColumn("Modelid", typeof(string)));

            dt.Columns.Add(new DataColumn("Foodtype", typeof(string)));
            dt.Columns.Add(new DataColumn("Subamount", typeof(string)));
            dt.Columns.Add(new DataColumn("Subrate", typeof(string)));
            ...
            dr["Shapeid"] = string.Empty;
            dr["Shaperate"] = string.Empty;

            dr["Foodtype"] = string.Empty;
            dr["Subrate"] = string.Empty;
            dr["SubAmount"] = string.Empty;
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        DropDownList drpset = (DropDownList)gridorder.Rows[rowIndex].Cells[1].FindControl("drpset");
                        ...
                        DropDownList drpshape = (DropDownList)gridorder.Rows[rowIndex].Cells[1].FindControl("drpshape");
                        TextBox txtshaperate = (TextBox)gridorder.Rows[rowIndex].Cells[5].FindControl("txtshaperate");

                        DropDownList drpfoodtype = (DropDownList)gridorder.Rows[rowIndex].Cells[1].FindControl("drpfoodtype");
                        TextBox txtsubrate = (TextBox)gridorder.Rows[rowIndex].Cells[5].FindControl("txtsubrate");
                        TextBox txtsubamount = (TextBox)gridorder.Rows[rowIndex].Cells[5].FindControl("txtsubamount");
                        ...
                        dtCurrentTable.Rows[i - 1]["set"] = drpset.SelectedValue;
                        ...
                        dtCurrentTable.Rows[i - 1]["Shapeid"] = drpshape.SelectedValue;
                        dtCurrentTable.Rows[i - 1]["Shaperate"] = txtshaperate.Text;

                        dtCurrentTable.Rows[i - 1]["Foodtype"] = drpfoodtype.SelectedValue;
                        dtCurrentTable.Rows[i - 1]["Subrate"] = txtsubrate.Text;
                        dtCurrentTable.Rows[i - 1]["Subamount"] = txtsubamount.Text;

                        if (drpset.SelectedValue == "1")
                        {
                            drpset.BackColor = System.Drawing.Color.Green;
                        }
                        else if (drpset.SelectedValue == "2")
                        {
                            drpset.BackColor = System.Drawing.Color.Yellow;
                        }
                        else if (drpset.SelectedValue == "3")
                        {
                            drpset.BackColor = System.Drawing.Color.Red;
                        }
                        else if (drpset.SelectedValue == "4")
                        {
                            drpset.BackColor = System.Drawing.Color.Gray;
                        }
                        else if (drpset.SelectedValue == "5")
                        {
                            drpset.BackColor = System.Drawing.Color.LightBlue;
                        }
                        else if (drpset.SelectedValue == "6")
                        {
                            drpset.BackColor = System.Drawing.Color.LightCoral;
                        }
                        else if (drpset.SelectedValue == "7")
                        {
                            drpset.BackColor = System.Drawing.Color.LightSkyBlue;
                        }
                        else if (drpset.SelectedValue == "8")
                        {
                            drpset.BackColor = System.Drawing.Color.Magenta;
                        }
                        else if (drpset.SelectedValue == "9")
                        {
                            drpset.BackColor = System.Drawing.Color.Navy;
                        }
                        else if (drpset.SelectedValue == "10")
                        {
                            drpset.BackColor = System.Drawing.Color.Violet;
                        }
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        if (dt.Rows[i]["Qty"].ToString() != "")
                        {
                            ...
                            drpset.SelectedValue = dt.Rows[i]["set"].ToString();
                            ...
                            drpshape.SelectedValue = dt.Rows[i]["shapeid"].ToString();
                            txtshaperate.Text = dt.Rows[i]["shaperate"].ToString();

                            drpfoodtype.SelectedValue = dt.Rows[i]["Foodtype"].ToString();
                            txtsubrate.Text = dt.Rows[i]["subrate"].ToString();
                            txtsubamount.Text = dt.Rows[i]["subamount"].ToString();
        ...
        protected void gridorder_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            DataSet dCategory = objbs.selectcategorymasterforitemrequest_Order("All");



            DataSet dsmadel = objbs.Get_model();

            DataSet dsset = objbs.Get_Set();

            DataSet dssharpe = objbs.Get_Sharpe();
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                DropDownList drpsetwise = (DropDownList)(e.Row.FindControl("drpset") as DropDownList);

                DropDownList drpfoodtype = (DropDownList)(e.Row.FindControl("drpfoodtype") as DropDownList);

                DropDownList drpshape = (DropDownList)(e.Row.FindControl("drpshape") as DropDownList);



                // DropDownList drpfoodtype = (DropDownList)row.FindControl("drpfoodtype");
                // Label lblunits = (Label)(e.Row.FindControl("lblunits") as Label);

                DataSet dst = objbs.selectallcategorydecription_new_Foodtype(sTableName, drpfoodtype.SelectedValue);
                ...
                {
                    drpsetwise.DataSource = dsset.Tables[0];
                    drpsetwise.DataTextField = "Setname";
                    drpsetwise.DataValueField = "Setid";
                    drpsetwise.DataBind();
                    drpsetwise.Items.Insert(0, "Select Set");
                }


                if (dssharpe.Tables[0].Rows.Count > 0)
                {
                    drpshape.DataSource = dssharpe.Tables[0];
                    drpshape.DataTextField = "ShapeName";
                    drpshape.DataValueField = "Shapeid";
                    drpshape.DataBind();
                    drpshape.Items.Insert(0, "Select Shape");
                }

                //if(drpsetwise.SelectedValue == "1")
        ...
        protected void Shaperate_chnaged(object sender, EventArgs e)
        {
            TextBox ddl = (TextBox)sender;
            GridViewRow row = (GridViewRow)ddl.NamingContainer;

            DropDownList drpshape = (DropDownList)row.FindControl("drpshape");

            TextBox txtshaperate = (TextBox)row.FindControl("txtshaperate");
            ...
            if (txtshaperate.Text == "")
                txtshaperate.Text = "0";

            double Rate = Convert.ToDouble(txtRate.Text);
            double sepRate = Convert.ToDouble(txtshaperate.Text);

            if (drpshape.SelectedValue !="Select Shape")
            {
                double Ratee = Rate + sepRate;
                txtRate.Text = Convert.ToDouble(Ratee).ToString(""+ ratesetting + "");
            }
            else
            {
        ...
        protected void Foodtype_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dst.Tables[0].Rows.Count > 0)
            {
                drpitemm.DataSource = dst.Tables[0];
                drpitemm.DataTextField = "definition";
                drpitemm.DataValueField = "CategoryuserID";
                drpitemm.DataBind();
                drpitemm.Items.Insert(0, "Select Product");
        ...
        protected void productCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                for (int vLoop = 0; vLoop < gridorder.Rows.Count; vLoop++)
                {
                    ...
                    DropDownList drpfoodtypee = (DropDownList)row.FindControl("drpfoodtype");



                    if (drpitem.SelectedItem.Text != "Select Product")
                    {
                        string[] user = drpitem.SelectedValue.Split('-');
                        string itemid = string.Empty;
                        string flavourid = string.Empty;
                        if (drpfoodtypee.SelectedValue == "F")
                        {
                            itemid = drpitem.SelectedValue;
                        }
                        else if (drpfoodtypee.SelectedValue == "O")
                        {
                            itemid = user[0];
                            flavourid = user[1];
                        }
                        ...
                        DataSet dsCategory1 = objbs.selectProduct(Convert.ToInt32(itemid), sTableName);
                        if (dsCategory1.Tables[0].Rows.Count > 0)
                        {
            ...
            TextBox txtsubRate = (TextBox)row.FindControl("txtsubRate");
            TextBox txtsubAmount = (TextBox)row.FindControl("txtsubAmount");
            ...
            DataSet DflavAmt = new DataSet();

            if (drpfoodtype.SelectedValue == "F")
            {

                DflavAmt = objbs.getCakeRate(Convert.ToInt32(drpitemm.SelectedValue));
            }
            else if (drpfoodtype.SelectedValue == "O")
            {
                //string itemid = ;

                string[] user = drpitemm.SelectedValue.Split('-');
                string itemid = user[0];
                string flavourid = user[1];


                DflavAmt = objbs.getCakeRate_itemtype(itemid, flavourid);
            }
            ...
            txtRate.Text = dAmt.ToString("f2");
            txtsubRate.Text = dAmt.ToString("f2");
            txtsubAmount.Text = DflavAmt.Tables[0].Rows[0]["Rate"].ToString();
            // = DflavAmt.Tables[0].Rows[0][Rate].ToString("f2");
        ...
        void GSTVAlNew()
        {
            ...
            for (int vLoop = 0; vLoop < gridorder.Rows.Count; vLoop++)
            {
                ...
                DropDownList drpshape = (DropDownList)gridorder.Rows[vLoop].FindControl("drpshape");
                TextBox txtshaperate = (TextBox)gridorder.Rows[vLoop].FindControl("txtshaperate");

                DropDownList drpfoodtype = (DropDownList)gridorder.Rows[vLoop].FindControl("drpfoodtype");
                TextBox txtsubrate = (TextBox)gridorder.Rows[vLoop].FindControl("txtsubrate");
                TextBox txtsubamount = (TextBox)gridorder.Rows[vLoop].FindControl("txtsubamount");
                ...
                txtsubrate.Text = (Convert.ToDouble(txtQty.Text) * Convert.ToDouble(txtsubrate.Text)).ToString("0.00");
                double ratee = Convert.ToDouble(txtsubrate.Text) + Convert.ToDouble(txtshaperate.Text);

                txtRate.Text = ratee.ToString();

                txtAmount.Text = (Convert.ToDouble(txtQty.Text) * Convert.ToDouble(txtRate.Text)).ToString("0.00");
                txtsubamount.Text = (Convert.ToDouble(txtQty.Text) * Convert.ToDouble(txtsubrate.Text)).ToString("0.00");

                {
                    ...
                    Discamt = Tot * dis;
                    lblitemdiscount.Text = Discamt.ToString("0.00");


                    txtdiscamount.Text = Convert.ToDecimal(Discamt).ToString("f2");
            ...
            txtdiscamount.Text = distot.ToString("0.00");



            txtcgst.Text = (cgstot).ToString("0.00");
            txtsgst.Text = (sgstot).ToString("0.00");
            ...
            txttotal.Text = (Grand1).ToString("0.00");
            ...
            //txtamount1.Text = dRate1.ToString("f2");
            ...
            //txtamount2.Text = dRate2.ToString("f2");
            ...
            //txtamount3.Text = dRate3.ToString("f2");
            ...
            //txtamount4.Text = dRate4.ToString("f2");
            ...
            //txtamount5.Text = dRate5.ToString("f2");
            ...
            //lbloritot.Text = oritot.ToString("f2");
            ...
            //txtdiscamount.Text = dDisc.ToString("f2");

            //txtsgst.Text = (taxamt1 + taxamt2 + taxamt3 + taxamt4 + taxamt5).ToString("f2");
            //txtcgst.Text = (taxamt1 + taxamt2 + taxamt3 + taxamt4 + taxamt5).ToString("f2");

            //txttotal.Text = (dTotal + (Convert.ToDecimal(txtsgst.Text)) + (Convert.ToDecimal(txtcgst.Text)) - dDisc).ToString("f2");
            ...
            if (btnSave.Text == "Save & Print")
            {
                ...
                if (txtAdvance.Text != "" && txtAdvance.Text != null)
                {
                    ...
                    txtBalance.Text = dBal.ToString("f2");
            ...
            if (btnSave.Text == "Save & Print" || btnSave.Text == "Update Bill")
            {
                ...
                if (chkdisc.Checked == true)
                {
                    ...
                    if (Convert.ToDouble(lbloritot.Text) < Convert.ToDouble(lblmaxdiscount.Text))
                    {
                        ...
                        txtdiscper.Text = "0";
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Discount Applicable Above " + Convert.ToDouble(lblmaxdiscount.Text).ToString("0.00") + ".Please Contact Administrator.Thank You!!!');", true);
                        return;
                    }
        ...
        protected void partial_amount(object sender, EventArgs e)
        {
            ...
            if (dBilling.Tables[0].Rows.Count > 0)
            {
                txtBalance.Text = Convert.ToDouble(dBilling.Tables[0].Rows[0]["balancepaid"]).ToString("0.00");
                ...
                else
                {
                    ...
                    txtBalance.Text = ball.ToString("0.00");
                }
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            #region SET WISE NARRATION
            string SET1 = string.Empty;
            string SET2 = string.Empty;
            string SET3 = string.Empty;
            string SET4 = string.Empty;
            string SET5 = string.Empty;
            string SET6 = string.Empty;
            string SET7 = string.Empty;
            string SET8 = string.Empty;
            string SET9 = string.Empty;
            string SET10 = string.Empty;
            ...
            for (int vLoop = 0; vLoop < gridorder.Rows.Count; vLoop++)
            {
                ...
                if (drpcategory.SelectedValue != "Select Category" && drpitem.SelectedValue != "Select Product" && (txtQty.Text != "" && txtQty.Text != "0"))
                {
                    ...
                    if (drpset.SelectedValue != "Select Set")
                    {

                        string fulldetails = drpitem.SelectedItem.Text + '-' + txtQty.Text;
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Select Set in Row Else Delete That " + vLoop + " Row.Thank You!!!.');", true);
                        return;
                    }
                }
                else
            ...
            {
                int iStatus = objbs.Insertcust(txtCustname.Text, txtPhineNo.Text, txtaddress.Text, "Yes", lblUserID.Text, txtgstno.Text);
                    ...
                    if (txtDeliveryDate.Text != "")
                    {
                        if (radiomode.Text != "")
                        {
                            if (txtPhineNo.Text.Length == 10)
                            {
                                ...
                                string onlinemsg = "Waiting For Sync...";
                                chkchecklist.Checked = false;
                                //if (synccakeorder == "Y")
                                //{
                                ...
                                for (int vLoop = 0; vLoop < gridorder.Rows.Count; vLoop++)
                                {
                                    ...
                                    if (drpcategory.SelectedValue != "Select Category" && drpitem.SelectedValue != "Select Product" && (txtQty.Text != "" || txtQty.Text != "0"))
                                    {
                                        int iStatus1 = objbs.InsertTransCakeorder("tbltransorder_" + sTableName, Convert.ToInt32(BillNo), Convert.ToInt32(drpcategory.SelectedValue), Convert.ToDouble(txtQty.Text), Convert.ToDouble(txtRate.Text), Convert.ToDouble(txtAmount.Text), Convert.ToInt32(drpitem.SelectedValue), chkchecklist.Checked, sTableName, lbltax.Text, lblitemdiscount.Text, modelno, modelImg, onlinemsg, drpset.SelectedValue, fullset);
                                    }
                    ...
                    if (txtDeliveryDate.Text != "")
                    {
                        if (radiomode.Text != "")
                        {
                            if (txtPhineNo.Text.Length == 10)
                            {
                                ...
                                txtBalance.Text = dBall.ToString("f2");
        ...
        //    DataSet dsStock = objbs.GetStockDetails(Convert.ToInt32(iStockID), Convert.ToInt32(lblUserID.Text), sTableName);
        ...
        protected void ddlFlavour_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            decimal dAmt = Convert.ToDecimal(DflavAmt.Tables[0].Rows[0][Rate].ToString());
            txtrate5.Text = dAmt.ToString("f2");
        ...
        protected void txtQty_TextChanged(object sender, EventArgs e)
        {
            ...
            //decimal dRate = dFlav;
            //txtamount5.Text = dRate.ToString("f2");
            //decimal dTotal = Convert.ToDecimal(txtamount1.Text) + Convert.ToDecimal(txtamount2.Text) + Convert.ToDecimal(txtamount3.Text) + Convert.ToDecimal(txtamount4.Text) + Convert.ToDecimal(txtamount5.Text);
        ...
        protected void ddlFlavour1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtFalvAmount5.Text = DflavAmt.Tables[0].Rows[0]["Rate"].ToString();
            decimal dAmt = Convert.ToDecimal(DflavAmt.Tables[0].Rows[0]["Rate"].ToString());
            txtrate1.Text = dAmt.ToString("f2");
            // = DflavAmt.Tables[0].Rows[0][Rate].ToString("f2");
        ...
        protected void ddlFlavour2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            decimal dAmt = Convert.ToDecimal(DflavAmt.Tables[0].Rows[0]["Rate"].ToString());
            txtrate2.Text = dAmt.ToString("f2");
        ...
        protected void ddlFlavour3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            decimal dAmt = Convert.ToDecimal(DflavAmt.Tables[0].Rows[0]["Rate"].ToString());
            txtrate3.Text = dAmt.ToString("f2");
        ...
        protected void ddlFlavour4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            decimal dAmt = Convert.ToDecimal(DflavAmt.Tables[0].Rows[0]["Rate"].ToString());
            txtrate4.Text = dAmt.ToString("f2");
        ...
        protected void smsSendAdvanceMessage()
        {
            ...
            string message = "Dear Customer, Thank you for booking cake with Blaack Forest!" + Convert.ToDateTime(txtOrderDate.Text).ToString("dd/MM/yyyy") + " for Rs." + Convert.ToDecimal(txtAdvance.Text).ToString("f2") + " /-. Your Order no. is " + lblOrderNo.InnerText + ". www.blaackforestcakes.com";
        ...
        protected void smsSendZeroAdvanceMessage()
        {
            ...
            //sb.Append("From -");
            string SMS = txtPhineNo.Text;
            string message = "Dear Customer, Thank you for booking cake with Blaack Forest!" + Convert.ToDateTime(txtOrderDate.Text).ToString("dd/MM/yyyy") + " for Rs." + Convert.ToDecimal(txtAdvance.Text).ToString("f2") + " /-. At the time of delivery, kindly settle the full order amount.Thank You. www.blaackforestcakes.com";
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://198.15.98.50/API/pushsms.aspx?loginID=api1&password=demo&mobile=" + SMS + "&text=" + message + "&senderid=BFCAKE&route_id=1&Unicode=0");
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
            StreamReader reader = new StreamReader(response.GetResponseStream());
            string result = reader.ReadToEnd();
        ...
        protected void smsSendFullMessage()
        {
            ...
            //sb.Append("From -");
            string SMS = txtPhineNo.Text;
            string message = "Dear Customer, Thank you for booking cake with Blaack Forest!" + Convert.ToDateTime(txtOrderDate.Text).ToString("dd/MM/yyyy") + " for Rs." + Convert.ToDecimal(txtAdvance.Text).ToString("f2") + " /-. Full Amount received against your order no. " + lblOrderNo.InnerText + ". Thank You. www.blaackforestcakes.com";
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://198.15.98.50/API/pushsms.aspx?loginID=api1&password=demo&mobile=" + SMS + "&text=" + message + "&senderid=BFCAKE&route_id=1&Unicode=0");
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
            StreamReader reader = new StreamReader(response.GetResponseStream());
            string result = reader.ReadToEnd();
        ...
        protected void smsSendDeliveredMessage()
        {
            ...
            //sb.Append("From -");
            string SMS = txtPhineNo.Text;
            string message = "Dear Customer, Your Order no." + lblOrderNo.InnerText + " is completed." + Convert.ToDateTime(txtDeliveryDate.Text).ToString("dd/MM/yyyy") + " for Rs." + Convert.ToDecimal(txtBalance.Text).ToString("f2") + " /-. Thank You. Celebrate Your Special Day with Blaack Forest. www.blaackforestcakes.com";
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://198.15.98.50/API/pushsms.aspx?loginID=api1&password=demo&mobile=" + SMS + "&text=" + message + "&senderid=BFCAKE&route_id=1&Unicode=0");
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
            StreamReader reader = new StreamReader(response.GetResponseStream());
            string result = reader.ReadToEnd();
        ...
        protected void smsSendZeroDeliveredMessage()
        {
            ...
            //sb.Append("From -");
            string SMS = txtPhineNo.Text;
            string message = "Dear Customer, Your Order no." + lblOrderNo.InnerText + " is completed.Thank You for Full Payment " + Convert.ToDateTime(txtDeliveryDate.Text).ToString("dd/MM/yyyy") + " for Rs." + Convert.ToDecimal(txtBalance.Text).ToString("f2") + " /-. Celebrate Your Special Day with Blaack Forest. www.blaackforestcakes.com";
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://198.15.98.50/API/pushsms.aspx?loginID=api1&password=demo&mobile=" + SMS + "&text=" + message + "&senderid=BFCAKE&route_id=1&Unicode=0");
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
            StreamReader reader = new StreamReader(response.GetResponseStream());
            string result = reader.ReadToEnd();
