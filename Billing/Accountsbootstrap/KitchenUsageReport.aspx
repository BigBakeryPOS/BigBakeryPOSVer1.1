                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <asp:Button ID="btnDetails" runat="server" Text="Print" Visible="true" CssClass="btn btn-secondary"
                                    OnClientClick="Denomination123()" />
                                 <asp:Button ID="btnSummary" runat="server" Text="Print" Visible="false" CssClass="btn btn-secondary"
