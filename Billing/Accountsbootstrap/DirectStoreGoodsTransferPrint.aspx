<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirectStoreGoodsTransferPrint.aspx.cs" Inherits="Billing.Accountsbootstrap.DirectStoreGoodsTransferPrint" %>
     ...
     Opp.to Fenner India Ltd.,<br /> Kochadai, Madurai - 625 016  </asp:Label><br />
                    ...
                    <table  style="font-weight:bold; font-size:large " border="1" width="100%">
                        <tr>
                            ...
                            <td width="38%" valign="top" style="border-right: solid 1px">
                                DC No :
                    ...
                    <div runat="server" id="divgv">
                        <asp:GridView runat="server" ID="gridprint" GridLines="Vertical" AutoGenerateColumns="false" FooterStyle-Font-Size="25px" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S.No" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-Width="3px">
                                    <ItemTemplate>
                    ...
                    <table style="width: 100%; border: solid 1px">
                        <tr id="Tr1" runat="server" visible="false" style="border: solid 1px">
                        ...
                        <tr id="Tr2" runat="server" visible="false" style="border: solid 1px">
                            <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: right">
                                Sub.Total:
                            </td>
                            <td style="border-bottom: solid 1px; text-align: right; width: 15%">
                        ...
                        <tr style="border: solid 1px">
                            <td style="border-bottom: solid 1px; border-right: solid 1px; width: 30%; text-align: right; font-weight:bold" >
                                <asp:Label ID="Label1" Font-Size="28px" Font-Bold="true" runat="server" Text="Grand Total : " ></asp:Label>
                            </td>
                    ...
                    <table width="595px" class="style1">
                        <tr>
                            <td align="center">
                                ...
                                <asp:Button ID="btnexit" runat="server" Text="Exit" PostBackUrl="~/Accountsbootstrap/DirectGoodsTransferGrid.aspx" />
                            </td>
                        </tr>
                    </table>
                </td>
