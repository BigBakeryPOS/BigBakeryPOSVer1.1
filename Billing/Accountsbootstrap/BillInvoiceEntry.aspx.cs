...
{
    public partial class BillInvoiceEntry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dDcNo = objbs.getmaxinvoiceno((sCode));
        ...
        protected void grn_date(object s, EventArgs e)
        {
            ...
            if (ddlbranch.SelectedValue != "" && ddlbranch.SelectedValue != "0" && ddlbranch.SelectedValue != "Select Branch")
            {
                ...
                DataSet dspo = objbs.GetbranchForGRN(ddlbranch.SelectedValue, frmdate, sTableName);
        ...
        protected void Process_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            DataSet dss = objbs.igetbillentrysummary((cond1), sTableName);
        ...
        protected void Save_click(object sender, EventArgs e)
        {
            ...
            int RequestID = objbs.InsertInvoice(sTableName, ddlbranch.SelectedValue, invdate, txtfullbillno.Text, grndate, txtAccepted.Text, txtcgst.Text, txtsgst.Text, txtigst.Text, txtgrandtotal.Text, txtroundoff.Text, txtNarration.Text, txtvehicleno.Text);
            ...
            for (int vLoop = 0; vLoop < gridsummary.Rows.Count; vLoop++)
            {
                ...
                int insertrawitems = objbs.Inserttransinvoice(RequestID.ToString(), lblCategoryUserID.Text, lblhsncode.Text, lbluom.Text, lblqty.Text, txtrate.Text, txtTaxVal.Text, txttax.Text, txttotal.Text, sTableName);
            }
