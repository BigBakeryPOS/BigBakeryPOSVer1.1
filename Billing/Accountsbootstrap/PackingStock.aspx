<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingStock.aspx.cs"
    Inherits="Billing.Accountsbootstrap.PackingStock" %>
...
<html lang="en">
<head id="Head1">
    <title>Packing Stock Entry</title>
    ...
    <div class="col-lg-12" style="">
        <div class="panel panel-default" style="">
            <div class="panel-heading " style="background-color: #428bca; color: White">
                <b>Packing Stock Entry</b>
                <br />
                Type:
                <asp:RadioButtonList ID="radentrytype" RepeatColumns="4" runat="server" OnSelectedIndexChanged="goodsentrytype"
                    AutoPostBack="true">
                    <asp:ListItem Text="Manual Type/with Stock Reduce" Value="1" Selected="True"></asp:ListItem>
                   <%-- <asp:ListItem Text="From Request" Value="2"></asp:ListItem>
            ...
            <div class="panel-body" style="">
                        ...
                        <div class="panel-body" style="height: 68px">
                            <div style="">
                                ...
                                <div class="row" style="">
                                    ...
                                    <div class="col-lg-2" style="">
                                        <div class="form-group" style="">
                                            <asp:Label runat="server" ID="lblDcNo"><label>Finish No.</label></asp:Label>
                                    ...
                                    <div class="col-lg-2" style="">
                                        <div class="form-group">
                                            <asp:Label runat="server" ID="lblDCDate"><label>Finish Date</label></asp:Label>
                ...
                <div class="col-lg-12">
                    <div class="col-lg-6">
                        <div class="panel panel-default" style="">
                            <div class="panel-heading " style="background-color: #428bca; color: White">
                                <b>Packing Stock Entry Details</b>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Packing Qty">
                                           ...
                                           <asp:TemplateField HeaderText="Current Qty">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtcurrentQty" onBlur="ResetColor()" onFocus="ChangeColor()" runat="server" Text='<%#Eval("CurrentQty") %>'
                                                Enabled="false"    Width="50px" AutoPostBack="false">0</asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="ftbe1" runat="server" TargetControlID="txtcurrentQty"
                                                    FilterType="Custom,Numbers" ValidChars="." />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="weight Qty">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtReceiveQty" onBlur="ResetColor()" onFocus="ChangeColor()" runat="server" Text='<%#Eval("ReceiveQty") %>'
                                                 Enabled="false"   Width="50px" AutoPostBack="false">0</asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="ftbe2" runat="server" TargetControlID="txtReceiveQty"
                                                    FilterType="Custom,Numbers" ValidChars="." />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Final Qty">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtFinalQty" onBlur="ResetColor()" onFocus="ChangeColor()" runat="server" Enabled="false"
                                                    Width="50px" AutoPostBack="false">0</asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="ftbe3" runat="server" TargetControlID="txtFinalQty"
                                                    FilterType="Custom,Numbers" ValidChars="." />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Unit">
                                            <ItemTemplate>
                                                <asp:Label ID="lblom" runat="server" Width="50px" Text='<%#Eval("UOM") %>' Enabled="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Batch No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbatchno" runat="server" Width="100px" Text='<%#Eval("batchno") %>' Enabled="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Expiry Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblexpirydate" runat="server" Width="50px" Text='<%#Eval("expirydate", "{0:dd-MM-yyyy}") %>' Enabled="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <FooterStyle BackColor="#990100" ForeColor="White" HorizontalAlign="Center" />
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                ...
                                <asp:Button ID="btngenerate" runat="server" Text="Calculate Qty" CssClass="btn btn-success"
                                    OnClick="btngenerate_OnClick" />
                            </div>
                           
                            <div class="col-lg-4">
                                <asp:Button ID="btnPreview" runat="server" CssClass="btn btn-danger" OnClientClick="ClientSideClick(this)" UseSubmitBehavior="false"  Text="Finish Pack"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Packing Qty">
                                          ...
                                          <asp:TemplateField HeaderText="Current Qty">
                                           ...
                                           <asp:TemplateField HeaderText="Final Qty">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtFinalQty" onBlur="ResetColor()" onFocus="ChangeColor()" runat="server"  Text='<%#Eval("FinalQty") %>'
                                                Enabled="false"    Width="50px" AutoPostBack="false">0</asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="ftbe3" runat="server" TargetControlID="txtFinalQty"
                                                    FilterType="Custom,Numbers" ValidChars="." />
                                            </ItemTemplate>
