...
namespace Billing.Accountsbootstrap
    {
        public partial class ReportRawMaterialDecAlert : System.Web.UI.Page
        {
            ...
            protected void Page_Load(object sender, EventArgs e)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    DataSet ds = objBs.StockDetailsDecrerseAlert(sTableName, ddlIngreCategory.SelectedValue);
                    if (ds != null)
                    {
            ...
            protected void btnExport_Click(object sender, EventArgs e)
            {
                // if (rdbtype.SelectedValue == "1")
                {
                    ...
                    if (sTableName == "admin")
                    {
                        ds = objBs.StockDetailsforRawitems( sTableName, ddlIngreCategory.SelectedValue);
