    ...
    public partial class DailyStockReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (sTableName == "admin")
                {
                    ds = objBs.GetDailyStockReport(sTableName, ddlcategory.SelectedValue, logintype);
                ...
                else
                {
                    admin.Visible = false;
                    ds = objBs.GetDailyStockReport(sTableName, ddlcategory.SelectedValue, logintype);
                    string caption1 = " <h4><b>" + " Daily Stock Report Generate On " + DateTime.Now.ToString("MM/dd/yyyy hh:mm tt") + " </b></h4> ";
        ...
        protected void ddlcategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            admin.Visible = false;
            DataSet ds = objBs.GetDailyStockReport(sTableName, ddlcategory.SelectedValue, logintype);
