<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterBranchRequest.aspx.cs" Inherits="Billing.Accountsbootstrap.InterBranchRequest" %>
...
<head>
    ...
    <title>Inter Branch Stock Request </title>
    ...
    <div class="col-lg-12">
     <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Branch Stock Request</h1>
	    </div>
                       ...
                       <div class="row">
                            ...
                            <label id="lblcap" runat="server" >Selected Category Items</label>
                                <div id="divid" runat="server" class="table-responsive panel-grid-left">
                                    <asp:GridView ID="gvitems" runat="server" AutoGenerateColumns="false" cssClass="table table-striped pos-table"  Width="100%" padding="0" spacing="0" border="0"  OnRowDataBound="onrowdatabound"
                                        >
                            ...
                            <label id="Label1" runat="server" >Selected Requested Item List</label>
                                <div id="div1" runat="server" class="table-responsive panel-grid-left">
                                    <asp:GridView ID="gvqueueitems" runat="server" AutoGenerateColumns="false" cssClass="table table-striped pos-table"  Width="100%" padding="0" spacing="0" border="0" Font-Names="Calibri" OnRowCommand="gvqueueitems_RowCommand"
