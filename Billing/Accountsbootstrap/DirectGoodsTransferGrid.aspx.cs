...
{
    public partial class DirectGoodsTransferGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = objBs.GetDirectGoodTrasnfer(sTableName);
        ...
        {
            Response.Redirect("DirectGoodsTransfer.aspx");
        }
        ...
        protected void gvsales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "view")
            {
                ...
                DataSet ds = objBs.GetDirectGoodTrasnferDetails(sTableName, Convert.ToInt32(e.CommandArgument));
                if (ds.Tables[0].Rows.Count > 0)
                {
