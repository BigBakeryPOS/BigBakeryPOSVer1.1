...
{
    public partial class DirectStoreGoodsTransferPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ISalesId != null)
                {
                    ...
                    //if (scode == "Production")
                    //{
                    ds = objbs.GoodTrasnferListExp_ReportStore(DcNo, sTableName);
                    //}
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        DataSet ditem = objbs.TransGoodTrasnferListExp_Reportstore(DcNo, sTableName);
