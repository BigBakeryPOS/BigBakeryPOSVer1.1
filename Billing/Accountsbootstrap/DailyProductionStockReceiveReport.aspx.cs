...
{
    public partial class DailyProductionStockReceiveReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dT = objbs.GetDailyProductionStockReceiveReport(sFromdate, sTodate, scode);
        ...
        protected void gvTransfer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Exp")
            {
                ...
                ds = objbs.ShowDailyProductionReceiveItem_ByReceiveNo(scode, DcNo);
                ...
                gridview.Caption = "Daily Production Stock Receive Details " + "On " + Date + "-" + "Request NO" + DcNo;
                string filename = "Daily Production Stock Receive Details On " + Date + "-" + "Request NO" + DcNo;
            ...
            else if (e.CommandName == "Print")
            {
                ...
                try
                {
                    ...
                    grid.Caption = "Daily Production Stock Receive Details " + "On " + Date + "-" + "Request NO" + DcNo;
