...
{
    public partial class WholeSalesQuotationQtyPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ISalesId != null)
                {
                    ...
                    DataSet ds1 = objbs.GetSalesQuotation(sTableName, Convert.ToInt32(ISalesId));
                    DataSet ds2 = objbs.getbranchdetails1(scode);
