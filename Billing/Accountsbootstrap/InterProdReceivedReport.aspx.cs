...
{
    public partial class InterProdReceivedReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //  if (scode == "Production")
                {
                    ...
                    DataSet dT = objbs.interProdReceivedReport_date(sFromdate, sTodate, scode);
        ...
        protected void gvreceivedr_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Exp")
            {
                ...
                //if (scode == "Production")
                //{
                ds = objbs.InterProdGoodReceivedListExp(DcNo, scode);
                //}
                //if (scode == "Production2")
                //{
