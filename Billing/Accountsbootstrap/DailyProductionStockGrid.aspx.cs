...
{
    public partial class DailyProductionStockGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.ShowFinishRaw_DailyProd(sTableName);
        ...
        protected void gvsales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                DataSet ds = objBs.ShowRequestRawDetails_DailyProd("tbldailyproduction_" + sTableName, "tbltransdailyproduction_" + sTableName, Convert.ToInt32(e.CommandArgument), "");
                if (ds.Tables[0].Rows.Count > 0)
                {
