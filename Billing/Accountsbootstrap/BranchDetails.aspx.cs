            ...
            if (!IsPostBack)
            {
                ...
                if (iCusID != "" || iCusID != null)
                {
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        drppurchaseorderrights.SelectedValue = ds1.Tables[0].Rows[0]["Porderrights"].ToString();

                        drpbatchwise.SelectedValue = ds1.Tables[0].Rows[0]["isbatchwise"].ToString();
