...
{
    public partial class PurchaseRequestGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dacess1 = objbs.getuseraccessscreen(Request.Cookies["userInfo"]["EmpId"].ToString(), "StockRequest");
            ...
            dacess = objbs.getuseraccessscreen(Request.Cookies["userInfo"]["EmpId"].ToString(), "StockRequest");
        ...
        protected void btnadd_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("ItemStockRequest.aspx");
            }
            else
            {
        ...
        protected void gvPurchaseEntry_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "View")
            {
                ...
                DataSet ds = objbs.RequestDet(ReqNo, sCode);
                ...
                string caption = "Daily Stock Request Details" + "</br>" + "Request From :" + sCode + "</br>" + "Request No :" + ReqNo + "</br>" + "Request Date :" + Convert.ToDateTime(ReqTime).ToString("dd/MM/yyyy") + "</br>" + "Request Entry Time :" + RequestDate;
            ...
            else if (e.CommandName == "Print")
            {
                ...
                string caption = "<h4><b>Daily Stock Request Details" + "</br>" + "Request From :" + sCode + "</br>" + "Request No :" + ReqNo + "</br>" + "Request Date :" + Convert.ToDateTime(ReqTime).ToString("dd/MM/yyyy") + "</br>" + "Request Entry Time :" +RequestDate + "</b></h4> " + "</br>" + " Print Time :" + DateTime.Now.ToString("MM/dd/yyyy hh:MM:tt") + " ";
                gvPurchaseReqDetails.Caption = caption;
