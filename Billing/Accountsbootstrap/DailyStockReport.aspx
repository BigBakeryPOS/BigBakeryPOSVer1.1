<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyStockReport.aspx.cs" Inherits="Billing.Accountsbootstrap.DailyStockReport" %>
...
<head id="Head1">
    ...
    <title>Daily Stock Report Grid </title>
                            ...
                            <tr>
                                <td colspan="4" align="left">
                                    <asp:GridView ID="gvstock" runat="server" AutoGenerateColumns="false" AllowPaging="false"
                                        CssClass="mGrid" PageSize="50" OnPageIndexChanging="page_change" OnRowDataBound="gvstock_RowDataBound" Caption="Daily Stock Details"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Quantity" Visible="false" DataField="Quantity" DataFormatString='{0:f}' />
                                            <asp:BoundField HeaderText="Available Quantity" DataField="Available_QTY" DataFormatString='{0:f}' />
