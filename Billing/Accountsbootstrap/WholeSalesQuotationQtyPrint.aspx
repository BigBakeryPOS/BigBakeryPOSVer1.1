<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WholeSalesQuotationQtyPrint.aspx.cs"
    Inherits="Billing.Accountsbootstrap.WholeSalesQuotationQtyPrint" %>
        ...
        <table width="595px" height="5px" class="style1">
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnexit" runat="server" Text="Exit" PostBackUrl="~/Accountsbootstrap/WholeSalesQuotationGrid.aspx" />
                </td>
            </tr>
        </table>
    </center>
