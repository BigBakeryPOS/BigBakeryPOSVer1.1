<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KitchenPurchaseReturnReport.aspx.cs" Inherits="Billing.Accountsbootstrap.KitchenPurchaseReturnReport" %>
                ...
                <div class="col-lg-12">
                    <div class="row panel-custom1">
                        <div class="panel-header">
                            <h1 class="page-header">Purchase Return Details</h1>
                        </div>
                                    ...
                                    <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                        NextPageText="Next" PreviousPageText="Previous" />--%>
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="PurchaseReturnDate" DataField="PurchaseRtnDate" DataFormatString="{0:dd/MMM/yyyy}" />
