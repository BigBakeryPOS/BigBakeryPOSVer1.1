<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VarientRateMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.VarientRateMaster" %>
...
<head>
    ...
    <title>Varient Rate Master </title>
            ...
            <div class="col-lg-12" >
              <div class="col-lg-8" >
                ...
                <div class="panel-header">
                  <h1 class="page-header">Varient Rate Master</h1>
	            </div>
                    <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                 <div class="form-group has-feedback">
                                    <asp:TextBox CssClass="form-control" ID="txtsearch" placeholder="Search Varient Rate.." onkeyup="Search_Gridview(this, 'gridview')"
                        ...
                        <div class="col-lg-12">
                                  <div class="table-responsive panel-grid-left">
                                                <asp:GridView ID="gridview" runat="server" AllowPaging="false" AutoGenerateColumns="false" Width="100%" cssClass="table table-striped pos-table"
                                                    AllowSorting="true" OnRowCommand="gvcat_RowCommand" OnSorting="gridview_Sorting" padding="0" spacing="0" border="0"
                                                   ...
                                                   <%--  <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField HeaderText="Varient Rate Name" DataField="VarientRateName" />
                                                        <asp:BoundField HeaderText="Is Default" DataField="isdefault" />
                                                        <asp:BoundField HeaderText="Is Active" DataField="IsActive" />
                                                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnedit" ForeColor="White" CommandArgument='<%#Eval("Varientrateid") %>' cssclass="btn btn-warning btn-md"
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("Varientrateid") %>' CommandName="Del"
                                                                    runat="server">
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-custom1">
                               ...
                               <div class="panel-header">
				                        <h1 class="page-header">Add Varient Rate Master</h1>
		                        </div>
                                 <div class="panel-body panel-form-right">
                                <center><blink> <label  style="color:#007aff">Need To Add Varient Rate Master</label></blink></center>
                               
                                   
                                        <div class="list-group">
                                           
                                                <asp:TextBox CssClass="form-control" ID="txtvarientId" runat="server" Visible="false"></asp:TextBox>
                                            
                                                <label>
                                                   Varient Rate Name</label>
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txtvarientname" runat="server" placeholder="To Add New Varient Name"
                                                    Style="text-transform: capitalize" ></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="txtcat" ControlToValidate="txtvarientname"
                                                    ValidationGroup="val1" ErrorMessage="Please enter your Varient Name!" Style="color: Red" />
                                             <br />
                                                <label>
                                                    IsDefault</label>
                                                   <asp:DropDownList ID="drpisdefaultrate" runat="server" CssClass="form-control" >
        ...
        <div class="popup_Container">
            ...
            <div class="popup_Body">
                <p>
                    ...
                    <blink> <label  style="color:Red; font-size:12px">If you Delete This Varient Rate Name It Will Affect Your Branchs!!!</label> </blink>
                </p>
            </div>
