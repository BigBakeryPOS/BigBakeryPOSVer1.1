...
{
    public partial class DailyProdReceiveStoreItemGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.ShowDailyProductionReceiveItem(sTableName);
        ...
        protected void gvsales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                DataSet ds = objBs.ShowDailyProductionReceiveItem_ByReceiveNo(sTableName,e.CommandArgument.ToString());
                if (ds.Tables[0].Rows.Count > 0)
                {
