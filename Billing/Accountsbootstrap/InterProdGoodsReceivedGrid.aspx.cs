...
{
    public partial class InterProdGoodsReceivedGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dacess1 = objbs.getuseraccessscreen(Request.Cookies["userInfo"]["EmpId"].ToString(), "IPGRG");
                ...
                dacess = objbs.getuseraccessscreen(Request.Cookies["userInfo"]["EmpId"].ToString(), "IPGRG");
                ...
                DataSet ds = objbs.GetinterDCNONew_prod(scode);
        ...
        protected void ddlDC_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlDC.SelectedValue != "" && ddlDC.SelectedValue != "0" && ddlDC.SelectedValue != "Select DC No" && ddlDC.SelectedValue != "No Goods Available")
            {
                ...
                DataSet ds = objbs.interGoodReceivedNew_prod(ddlDC.SelectedValue, scode);
        ...
        protected void gvGoodTransFer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Receive")
            {
                ...
                Response.Redirect("InterProdGoodReceivedNote.aspx?PReqNo=" + PRoreqno + "&DCNo=" + Dcno + "&ToCode=" + REQCode + "&BReqNo=" + Breqno);
            }
            ...
            if (e.CommandName == "print")
            {
                ...
                DataSet ds = objbs.ineterGoodReceivedListNew_prod(ddlDC.SelectedValue, scode);
                if (ds.Tables[0].Rows.Count > 0)
                {
                ...
                string caption = "Inter Goods Received Details:" + "</br>" + "DC No " + gvGoodsReceived.Rows[0].Cells[0].Text + "</br>" + "DC Date " + Convert.ToDateTime(gvGoodsReceived.Rows[0].Cells[1].Text).ToString("dd/MM/yyyy hh:MM:tt") + "</br>" + "Branch Request No:" + gvGoodsReceived.Rows[0].Cells[2].Text + "</br>" + " Print Time :" + DateTime.Now.ToString("MM/dd/yyyy hh:MM:tt") + " ";
            ...
            if (e.CommandName == "view")
            {
                ...
                string caption = "Inter Goods Received Details:" + "</br>" + "DC No " + gvGoodsReceived.Rows[0].Cells[0].Text + "</br>" + "DC Date " + Convert.ToDateTime(gvGoodsReceived.Rows[0].Cells[1].Text).ToString("dd/MM/yyyy hh:MM:tt") + "</br>" + "Branch Request No:" + gvGoodsReceived.Rows[0].Cells[2].Text;
                gvDetails.Caption = caption;
