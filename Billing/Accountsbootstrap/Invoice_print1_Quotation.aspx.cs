...
{
    public partial class Invoice_print1_Quotation : System.Web.UI.Page
    {
       ...
       decimal TotalTaxAmount = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (ID != null)
                {
                    DataSet ds = objBs.getwholeSaleQuotationprint(sTableName, (ID));
                    DataSet ds1 = objBs.getbranchdetails1(sTableName);
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                      ...
                      //  lblDespatchedThrough.Text = ds.Tables[0].Rows[0]["VehicleNo"].ToString();
                        ...
                        int iSNo = 1;
                        DataSet tds = objBs.getTranswholeSaleQuotationprint(sTableName, (ID));
                        ...
                        dsOrGSTHSN = objBs.getTranswholeSaleQuotationprint(sTableName, (ID));
