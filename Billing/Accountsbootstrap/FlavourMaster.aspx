<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlavourMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.FlavourMaster" %>
            ...
            <div class="col-lg-12" >
              <div class="col-lg-8" >
                ...
                <div class="panel-header">
                  <h1 class="page-header">Flavour Master</h1>
	            </div>
                    <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                 <div class="form-group has-feedback">
                                    <asp:TextBox CssClass="form-control" ID="txtsearch" placeholder="Search Flavour.." onkeyup="Search_Gridview(this, 'gridview')"
                                  ...
                                  <div class="table-responsive panel-grid-left">
                                                <asp:GridView ID="gridview" runat="server" AllowPaging="false" AutoGenerateColumns="false" Width="100%" cssClass="table table-striped pos-table"
                                                   ...
                                                   <%--  <HeaderStyle BackColor="#428bca" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" ForeColor="White" /> 
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField HeaderText="Flavour Name" DataField="FlavourName" />
                                                        <asp:BoundField HeaderText="Is Active" DataField="IsActive" />
                                                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnedit" ForeColor="White" CommandArgument='<%#Eval("flavourid") %>' cssclass="btn btn-warning btn-md"
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete" ItemStyle-Width="60px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("flavourid") %>' CommandName="Del"
                                                                    runat="server">
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-custom1">
                               ...
                               <div class="panel-header">
				                        <h1 class="page-header">Add Flavour Master</h1>
		                        </div>
                                 <div class="panel-body panel-form-right">
                                <center><blink> <label  style="color:#007aff">Need To Add Flavour Master</label></blink></center>
                               
                                   
                                        <div class="list-group">
                                           
                                                <asp:TextBox CssClass="form-control" ID="txtflavourId" runat="server" Visible="false"></asp:TextBox>
                                            
                                                <label>
                                                   Flavour Name</label>
                                                <asp:TextBox CssClass="form-control" ID="txtflavourname" runat="server" placeholder="To Add New Flavour Name"
                                                    Style="text-transform: capitalize" ></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" ID="txtcat" ControlToValidate="txtflavourname"
                                                    ValidationGroup="val1" ErrorMessage="Please enter your Flavour Name!" Style="color: Red" />
                                            <br />
                                                <label>
                                                    IsActive</label>
        ...
        <div class="popup_Container">
            ...
            <div class="popup_Body">
                <p>
                    ...
                    <blink> <label  style="color:Red; font-size:12px">If you Delete This Flavour Rate Name It Will Affect Your Branchs!!!</label> </blink>
                </p>
            </div>
