<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyProductionStockReceiveReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.DailyProductionStockReceiveReport" %>
...
<head>
    ...
    <title>Daily Production Stock Receive </title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="col-lg-12" style="">
            <div class="panel panel-default" style="">
                <div class="panel-heading " style="background-color: #428bca; color: White">
                    <b>Daily Production Stock Receive Details</b></div>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <label>
                                                <h3>
                                                    Daily Production Stock Receive Details
                                                </h3>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="gvTransfer" runat="server" EmptyDataText="No Record Found" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    <asp:BoundField HeaderText="Receive NO" DataField="ReceiveNO" />
                                                    <asp:BoundField HeaderText="Receive Date" DataField="ReceiveDate" DataFormatString='{0:dd/MM/yyyy}' />
                                                    ...
                                                    <asp:TemplateField HeaderText="Export">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnexp" runat="server" CommandName="Exp" CommandArgument='<%#Eval("ReceiveNO")+";"+Eval("ReceiveDate") %>'>
                                                    ...
                                                    <asp:TemplateField HeaderText="Print Receive">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnPrint" runat="server" CommandName="Print" CommandArgument='<%#Eval("ReceiveNO")+";"+Eval("ReceiveDate") %>'>
                                                    ...
                                                    <asp:TemplateField HeaderText="Print DC">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnPrint1" runat="server" CommandName="Print1" CommandArgument='<%#Eval("ReceiveNO")+";"+Eval("ReceiveDate") %>'>
                                                    ...
                                                    <asp:TemplateField HeaderText="View">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnView" runat="server" CommandName="View" CommandArgument='<%#Eval("ReceiveNO")+";"+Eval("ReceiveDate") %>'>
                                        ...
                                        <td valign="top">
                                            <asp:GridView ID="grid1" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                                                GridLines="Both">
                                                <Columns>
                                                   <asp:BoundField HeaderText="Receive No" DataField="ReceiveNo" Visible="true" />
                                                        <asp:BoundField HeaderText="Receive Date" DataField="ReceiveDate" DataFormatString='{0:dd/MM/yyyy}' />
                                                        <asp:BoundField HeaderText="Prepared" DataField="Prepared" Visible="true" />
                                                        <asp:BoundField HeaderText="Category" DataField="Category" Visible="true" />
                                                        <asp:BoundField HeaderText="Item" DataField="Definition" Visible="true" />
