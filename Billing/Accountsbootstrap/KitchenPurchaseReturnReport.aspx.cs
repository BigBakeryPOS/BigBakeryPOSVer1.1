...
{
    public partial class KitchenPurchaseReturnReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet pending = objBs.getpurchaseReturndetails(sTableName, ddlsuplier.SelectedValue, Convert.ToDateTime(From1).ToString("yyyy/MM/dd"), Convert.ToDateTime(To1).ToString("yyyy/MM/dd"), ddlraw.SelectedValue, drpsubcompany.SelectedValue);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            // if (rdbtype.SelectedValue == "1")
            {
...

                {
                    ...
                    ds = objBs.getpurchaseReturndetails(sTableName, ddlsuplier.SelectedValue, Convert.ToDateTime(From1).ToString("yyyy/MM/dd"), Convert.ToDateTime(To1).ToString("yyyy/MM/dd"), ddlraw.SelectedValue, drpsubcompany.SelectedValue);
                    gridview.Caption = " Purchase Return Report  Generated on " + DateTime.Now.ToString();
                ...
                if (BankGrid.Rows.Count > 0)
                {
                    using (StringWriter sw = new StringWriter())
                    {
                        ...
                        using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                        {
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=PurchaseReturnReport.pdf");
