...
namespace Billing.Accountsbootstrap
{
    public partial class Denomination : System.Web.UI.Page
    {
        ...
        //protected void txt1000s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt2000s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        //        return;
        //    }
        //    else
        //    {
        //        lbl2000s.Text = Convert.ToString(Convert.ToInt32(txt2000s_no.Text) * 2000);
        //        btncalc_Click(sender, e);
        //    }
        ...
        //protected void txt500s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt500s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl500s.Text = Convert.ToString(Convert.ToInt32(txt500s_no.Text) * 500);
        //        btncalc_Click(sender, e);
        //    }
        //    txt200s_no.Focus();
        //}
        //protected void txt200s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt200s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl200s.Text = Convert.ToString(Convert.ToInt32(txt200s_no.Text) * 200);
        //        btncalc_Click(sender, e);
        //    }
        //    txt100s_no.Focus();
        //}
        //protected void txt100s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt100s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl100s.Text = Convert.ToString(Convert.ToInt32(txt100s_no.Text) * 100);
        //        btncalc_Click(sender, e);
        //    }
        //    txt50s_no.Focus();
        //}
        //protected void txt50s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt50s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl50s.Text = Convert.ToString(Convert.ToInt32(txt50s_no.Text) * 50);
        //        btncalc_Click(sender, e);
        //    }

        //    txt20s_no.Focus();
        //}
        //protected void txt20s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt20s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl20s.Text = Convert.ToString(Convert.ToInt32(txt20s_no.Text) * 20);
        //        btncalc_Click(sender, e);
        //    }
        ...
        //protected void txt10s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt10s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl10s.Text = Convert.ToString(Convert.ToInt32(txt10s_no.Text) * 10);
        //        btncalc_Click(sender, e);
        //    }
        //    txt5s_no.Focus();
        //}

        //protected void txt5s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt5s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl5s.Text = Convert.ToString(Convert.ToInt32(txt5s_no.Text) * 5);
        //        btncalc_Click(sender, e);
        //    }
        ...
        //protected void txt2s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt2s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl2s.Text = Convert.ToString(Convert.ToInt32(txt2s_no.Text) * 2);
        //        btncalc_Click(sender, e);
        //    }
        ...
        //protected void txt1s_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txt1s_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lbl1s.Text = Convert.ToString(Convert.ToInt32(txt1s_no.Text) * 1);
        //        btncalc_Click(sender, e);
        //    }
        //    txtcoins_no.Focus();
        //}

        //protected void txtcoins_no_TextChanged(object sender, EventArgs e)
        //{
        //    if (txtcoins_no.Text == "")
        //    {
        //        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Enter any value or Zero.It cannot be empty.');", true);
        ...
        //    else
        //    {
        //        lblcoins.Text = Convert.ToString(Convert.ToInt32(txtcoins_no.Text) * 1);
        //        btncalc_Click(sender, e);
        //    }
        //    btncalc.Focus();
        //}
