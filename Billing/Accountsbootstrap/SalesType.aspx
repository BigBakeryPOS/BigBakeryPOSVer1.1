            ...
            <div class="panel panel-custom1">
                ...
                <div class="panel-body panel-form-right">
                    ...
                    <label>Payment Type Name</label>
                        ...
                        <asp:TextBox ID="txtmargin" runat="server" placeholder="Enter Margin" CssClass="form-control" OnTextChanged="Totcalcmar" AutoPostBack="true"></asp:TextBox>
                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                            FilterType="Custom,Numbers" ValidChars=" ." TargetControlID="txtmargin" />
                        <br />
                        <label>GST % : (Commission/Margin)</label>
                        <asp:TextBox Visible="true" ID="txtGST" runat="server" placeholder="Enter GST For Commission/Margin" CssClass="form-control" Text="0" Enabled="true" OnTextChanged="Totcalc" AutoPostBack="true"></asp:TextBox>
                        ...
                        <br />
                        <label>Total</label>
                        <asp:TextBox ID="txtTotal" runat="server" placeholder="Enter txtTotal" CssClass="form-control" Text="0" Enabled="false" ></asp:TextBox>
                       ...
                       <br />
                        ...
                        <label>Is Inclusive Of Rate </label>
                         ...
                         <label>Is Discount</label>
                            <asp:CheckBox ID="chkdiscountchk" runat="server" OnCheckedChanged="chk_discountcnaged" AutoPostBack="true" width="20px" />
