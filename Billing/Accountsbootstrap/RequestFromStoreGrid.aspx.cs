...
{
    public partial class RequestFromStoreGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dacess1 = objbs.getuseraccessscreen(Request.Cookies["userInfo"]["EmpId"].ToString(), "ISSRFS");
                ...
                dacess = objbs.getuseraccessscreen(Request.Cookies["userInfo"]["EmpId"].ToString(), "ISSRFS");
                ...
                DataSet ds = objbs.getrequestprodfromanotherstore(sCode, sDate);
        ...
        protected void gvPurchaseEntry_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Accept")
            {
                ...
                Response.Redirect("InterStoreStockTransfer.aspx?ReqNo=" + ReqNo + "&bcode=" + Branch + "&breqno=" + Branchreqno + "&REQCode=" + reqcode);
            }
            ...
            else if (e.CommandName == "view")
            {
                ...
                string Breqno = arg[3];
                DataSet ds = objbs.interrequestdetails_store(Breqno, Branch, sCode, ReqNo);
            ...
            else if (e.CommandName == "Export")
            {
                try
                {
                    ...
                    gridview.DataSource = objbs.RequestDetExport_store((ReqNo), Branch);
                    gridview.DataBind();


                    //   gridview.Caption = Branch +"-"+Date+"-Request" ;

                    gridview.Caption = "Inter Store Stock Request For " + Branch + " Store On " + Date;
                    gvDetails.Caption = "Inter Store Stock Request For " + Branch + " Store On " + Date;
                    Response.ClearContent();
                    string filename = "Inter Store Stock Request For " + Branch + " Store On " + Date;
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = objbs.getrequestprodfromanotherStoredate(sCode, sDate);
            if (ds.Tables[0].Rows.Count > 0)
            {
                gvPurchaseEntry.DataSource = ds;
                gvPurchaseEntry.DataBind();
