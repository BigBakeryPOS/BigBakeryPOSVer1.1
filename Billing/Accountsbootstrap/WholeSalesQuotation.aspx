<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WholeSalesQuotation.aspx.cs" Inherits="Billing.Accountsbootstrap.WholeSalesQuotation" %>
...
<body>
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
         <h1 class="page-header">Whole Sales Quotation</h1></div>
                    ...
                    <div class="panel-body">
                         ...
                         <div class="col-lg-2 form-inline">
                                                ...
                                                <label>
                                                    Quotation No</label><br>
                                                <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" ID="RequiredFieldValidator4"
                                                    Text="*" ControlToValidate="txtbillno" ErrorMessage="Please enter Quotation NO!" Style="color: Red" />
                                        ...
                                        <div class="col-lg-2">
                                                <asp:Label runat="server" ID="Label4" Style="font-weight: bold;">Quotation Date</asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ValidationGroup="val1"
                                                    Text="*" ControlToValidate="txtdate" Style="color: Red" ErrorMessage="Enter Quotation Date"></asp:RequiredFieldValidator><br />
