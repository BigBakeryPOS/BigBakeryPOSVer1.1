...
{
    public partial class InterProdStockRequestReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RangeValidator1.MinimumValue = System.DateTime.Now.AddDays(-Convert.ToDouble(Session["ReportDay"])).ToString("yyyy-MM-dd");
                RangeValidator1.MaximumValue = System.DateTime.Now.ToString("yyyy-MM-dd");

                RangeValidator2.MinimumValue = System.DateTime.Now.AddDays(-Convert.ToDouble(Session["ReportDay"])).ToString("yyyy-MM-dd");
                RangeValidator2.MaximumValue = System.DateTime.Now.ToString("yyyy-MM-dd");
        ...
        {
            Response.Redirect("InterProdStockRequestReport.aspx");
        }
        protected void btnadd_Click(object sender, EventArgs e)
        {
            DataSet ds = objbs.interProductionRequestreports(Convert.ToInt32(lblUserID.Text), sCode, txtfromdate.Text, txttodate.Text);
        ...
        protected void gvPurchaseEntry_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (gvGroup.DataKeys[e.Row.RowIndex].Value != "")
                {
                    ...
                    DataSet ds = objbs.InterstoreReport_StockReqDetails(groupID, sCode);
