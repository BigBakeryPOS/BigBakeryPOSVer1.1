                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                        {
                            ...
                            if (Amount.Text != "")
                            {
                                ...
                                int iStatus1 = objBs.insertTransSales("tblTransSales_" + sTableName, isalesid, Convert.ToInt32(ddcategory.SelectedValue), dQty, DRate, Convert.ToDouble(0), dAmount, Convert.ToInt32(lblDefID.Text), Convert.ToInt32(ddldef.SelectedValue), 0, "", "", "", Convert.ToDouble(1), "N", "0",Convert.ToDouble(1));
