...
{
    public partial class StockREceivedFromBranch : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //  if (scode == "Production")
                {
                    ...
                    DataSet dT = objbs.GetReceivedReport_date(sFromdate, sTodate, scode);
        ...
        protected void gvreceivedr_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Exp")
            {
                ...
                //if (scode == "Production")
                //{
                ds = objbs.GoodReceivedListExp(DcNo, scode);
                //}
                //if (scode == "Production2")
                //{
                ...
                gridview.Caption = "Goods Received Details for " + scode + "On " + Date + "-" + "DC.No" + DcNo;

                string filename = "Goods Received Details for " + scode + "On " + Date + "-" + "DC.No" + DcNo;
            ...
            else if (e.CommandName == "Print")
            {
                try
                {
                    ...
                    grid.DataBind();
                    string caption = "<h4><b>Goods Received Details" + "</br>" + "Request From :" + scode + "</br>" + "DC No :" + DcNo + "</br>" + "DC Date :" + Convert.ToDateTime(Date).ToString("MM/dd/yyyy hh:MM:tt") + "</br></b></h4> " + "</br>" + " Print Time :" + DateTime.Now.ToString("MM/dd/yyyy hh:MM:tt") + " ";
            ...
            else if (e.CommandName == "View")
            {
                ...
                //    grid.Caption = "Goods Received Details for " + scode + "On " + Date + "-" + "DC.No" + DcNo;
                    string caption = "Goods Received Details" + "</br>" + "Request From :" + scode + "</br>" + "DC No :" + DcNo + "</br>" + "DC Date :" + Convert.ToDateTime(Date).ToString("dd/MM/yyyy hh:MM:tt") + "</br>" ;
                    grid.Caption = caption;
                    //ScriptManager.RegisterStartupScript(this, typeof(Page), "printGrid", "printGrid();", true);
