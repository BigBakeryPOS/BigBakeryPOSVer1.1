...
{
    public partial class OrderFromBranch : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Mtype = Request.Cookies["userInfo"]["Mtype"].ToString();
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = objbs.getbranchbyproduction(sCode, sDate);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    gvPurchaseEntry.DataSource = dtw;
        ...
        protected void gvPurchaseEntry_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Accept")
            {
                ...
                DateTime reqdate = Convert.ToDateTime(arg[3]);
                int s = DateTime.Compare(System.DateTime.Now, reqdate);
                if (s < 0) //not allowed to give the items for future days
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Not allowed to access the Future days Items !!!.');", true);
                    return;
                }
                else
                    Response.Redirect("GoodTransfer.aspx?ReqNo=" + ReqNo + "&bcode=" + Branch + "&breqno=" + Branchreqno);
            }
            ...
            else if (e.CommandName == "Export")
            {
                ...
                try
                {
                    ...
                    string filename = "Stock-ReqFrmBranch.xls";
                    System.IO.StringWriter tw = new System.IO.StringWriter();
                    System.Web.UI.HtmlTextWriter hw = new System.Web.UI.HtmlTextWriter(tw);
                    DataGrid dgGrid = new DataGrid();
        ...
        protected void gvdetails_bound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                OrderQty = Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "Order_Qty"));
                RecQty = Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "Received_Qty"));
        ...
        protected void Griddc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblOqty.Text = Convert.ToDouble(lblOqty.Text).ToString("" + qtysetting + "");
