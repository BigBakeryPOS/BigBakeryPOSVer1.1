...
{
    public partial class Press_ContactReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dSelect = objBs.CustomerReport(Convert.ToInt32(3));
        ...
        protected void btnexcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition",
                "attachment;filename=PressReport.xls");
        ...
        {
            DataSet dSelect = objBs.Press_Search(txtser.Text);
            gvcust.DataSource = dSelect;
            gvcust.DataBind();
        }
