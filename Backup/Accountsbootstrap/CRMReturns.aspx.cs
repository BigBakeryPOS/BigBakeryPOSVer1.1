...
{
    public partial class CRMReturns : System.Web.UI.Page
    {
        ...
        protected void ddlState_Change(object sender, EventArgs e)
        {
            ...
            dsFinal = objbs.GenerateChart_CRMresons(ddlState.SelectedValue, sTableName);
        ...
        protected void ddlType_Change(object sender, EventArgs e)
        {
            ...
            if (ddlType.SelectedValue == "TopCategoryWise")
            {
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMresons("TopcatWise", sTableName);
                ...
                dsFinalqty = objbs.GenerateChart_CRMQuantityresons("TopcatWise", sTableName);
            ...
            else if (ddlType.SelectedValue == "LastCategoryWise")
            {
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMresons("LastcatWise", sTableName);
                ...
                DataSet dsFinalqty = new DataSet();
                dsFinalqty = objbs.GenerateChart_CRMQuantityresons("LastcatWise", sTableName);
            ...
            else if (ddlType.SelectedValue == "TopProductWise")
            {
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMresons("TopitemWise", sTableName);
                ...
                DataSet dsFinalqty = new DataSet();
                dsFinalqty = objbs.GenerateChart_CRMQuantityresons("TopitemWise", sTableName);
            ...
            else if (ddlType.SelectedValue == "LastProductWise")
            {
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMresons("LastitemWise", sTableName);
                ...
                DataSet dsFinalqty = new DataSet();
                dsFinalqty = objbs.GenerateChart_CRMQuantityresons("LastitemWise", sTableName);
            ...
            else if (ddlType.SelectedValue == "TopReasonsWise")
            {
                #region Chart 1
                Chart1.Series["Series1"].ChartType = SeriesChartType.Column;
                Chart1.Series["Series1"].IsValueShownAsLabel = true;
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMresons("TopReasonsWise", sTableName);

                DataTable dt = new DataTable();
                DataColumn dc;

                dc = new DataColumn();
                dc.ColumnName = "ipayMode";
                dt.Columns.Add(dc);
                dc = new DataColumn();
                dc.ColumnName = "Amount";
                dt.Columns.Add(dc);
                ...
                if (dsFinal != null)
                {
                    if (dsFinal.Tables[0].Rows.Count > 0)
                    {
                        for (int i = 0; i < dsFinal.Tables[0].Rows.Count; i++)
                        {
                            ...
                            if (dsFinal.Tables[0].Rows[i]["ipayMode"].ToString() == dsFinal.Tables[0].Rows[i]["ipayMode"].ToString())
                            {
                                dr["ipayMode"] = dsFinal.Tables[0].Rows[i]["ipayMode"].ToString();
                            }
                            dr["Amount"] = dsFinal.Tables[0].Rows[i]["Amount"].ToString();
                            dt.Rows.Add(dr);
                        }
                    ...
                    Chart1.DataSource = dt;
                    Chart1.Series["Series1"].XValueMember = "ipayMode";
                    Chart1.Series["Series1"].YValueMembers = "Amount";
                    Chart1.DataBind();
                }
                ...
                DataSet dsFinalqty = new DataSet();
                dsFinalqty = objbs.GenerateChart_CRMQuantityresons("TopReasonsWise", sTableName);

                DataTable dt1 = new DataTable();
                DataColumn dc1;

                dc1 = new DataColumn();
                dc1.ColumnName = "ipayMode";
                dt1.Columns.Add(dc1);
                dc1 = new DataColumn();
                dc1.ColumnName = "Quantity";
                dt1.Columns.Add(dc1);
                ...
                if (dsFinalqty != null)
                {
                    if (dsFinalqty.Tables[0].Rows.Count > 0)
                    {
                        for (int i = 0; i < dsFinalqty.Tables[0].Rows.Count; i++)
                        {
                            ...
                            if (dsFinalqty.Tables[0].Rows[i]["ipayMode"].ToString() == dsFinalqty.Tables[0].Rows[i]["ipayMode"].ToString())
                            {
                                dr["ipayMode"] = dsFinalqty.Tables[0].Rows[i]["ipayMode"].ToString();
                            }
                            dr["Quantity"] = dsFinalqty.Tables[0].Rows[i]["Quantity"].ToString();
                            dt1.Rows.Add(dr);
                        }
                    ...
                    Chart2.DataSource = dt1;
                    Chart2.Series["Series1"].XValueMember = "ipayMode";
                    Chart2.Series["Series1"].YValueMembers = "Quantity";
                    Chart2.DataBind();
                }
            ...
            else if (ddlType.SelectedValue == "LastReasonsWise")
            {
                #region Chart 1
                Chart1.Series["Series1"].ChartType = SeriesChartType.Column;
                Chart1.Series["Series1"].IsValueShownAsLabel = true;
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMresons("LastReasonsWise", sTableName);
                ...
                DataSet dsFinalqty = new DataSet();
                dsFinalqty = objbs.GenerateChart_CRMQuantityresons("LastReasonsWise", sTableName);
        ...
        protected void ddlSubType_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlSubType.SelectedValue != "--Select Category--")
            {
                ...
                DataSet dsFinal = new DataSet();
                dsFinal = objbs.GenerateChart_CRMsubnewresons(ddlSubType.SelectedValue, sTableName);
                ...
                DataSet dsFinalqty = new DataSet();
                dsFinalqty = objbs.GenerateChart_CRMQuantitysubnewresons(ddlSubType.SelectedValue, sTableName);
