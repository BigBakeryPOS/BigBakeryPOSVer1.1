...
namespace Billing.Accountsbootstrap
{
    public partial class SupplierOutStanding : System.Web.UI.Page
    {
        ...
        string sTableName = "";
        double NetAmount = 0; double Receipt = 0; double Balance = 0; double ReturnAmount = 0; double CloseDiscount = 0;
        ...
        protected void btnsearch_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objbs.getSupplierOutStanding(ddltype.SelectedValue, sTableName, ddlcustomerrep.SelectedValue, sFrom, sTo);
