<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferedReport.aspx.cs" Inherits="Billing.TransferedReport" %>
...
<head>
    ...
    <title>Stock Outward Report</title>
  ...
  <form id="Form1" runat="server">
    <asp:ScriptManager ID="scrip" runat="server"></asp:ScriptManager>
        ...
        <asp:Label ID="lblstockid"  runat="server" Visible="false"></asp:Label>
            ...
            <div class="row" align="center">
                <div class="col-lg-12">
                    <h1 class="page-header">Stock Outward Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <label>Select Branch</label>
                            ...
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1"  runat="server" TargetControlID="txttoDate" Format="yyyy-MM-dd"></ajaxToolkit:CalendarExtender>
                             ...
                             <div class="row">
                             <asp:GridView ID="gv" runat="server" CssClass="mGrid" Width="500px" EmptyDataText="No Data Found">
                             </asp:GridView>
