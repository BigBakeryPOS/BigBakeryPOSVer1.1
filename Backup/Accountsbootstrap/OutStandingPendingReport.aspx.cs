...
{
    public partial class OutStandingPendingReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lbltotal.Visible = true;
                    dsAllOutstanding = objBs.getAllOutstandingPending();
                ...
                {
                    dsAllOutstanding = objBs.getOutstandingAmountpending("tblTransReceipt_" + sTableName, "tblReceipt_" + sTableName, "tblSales_" + sTableName);
                    if (dsAllOutstanding.Tables[0].Rows.Count > 0)
                    {
        ...
        protected void search(object sender, EventArgs e)
        {
            ...
            {
                lbltotal.Visible = true;
                DataSet ds = objBs.AdminOutstandingAmountPending(ddcustomer.SelectedValue);
            ...
            {
                DataSet ds = objBs.GetOutstandingAmountsPending(ddcustomer.SelectedValue, "tblTransReceipt_" + sTableName, "tblReceipt_" + sTableName, "tblSales_" + sTableName);
                gvpending.DataSource = ds;
                gvpending.DataBind();
            }
        ...
        protected void gvpending_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            DataSet ds = objBs.getOutstandingAmountpending("tblTransReceipt_" + sTableName, "tblReceipt_" + sTableName, "tblSales_" + sTableName);
