...
{
    public partial class Storeinvoice_print : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (ID != null)
                {
                    ...
                    // if (T == "Request")
                    {
                        ds = objBs.getprintforinvoice_Store(sTableName, (ID));
                        //  dsGST = objBs.GetInternalTransferPrintGST(Convert.ToInt32(ID));
                        dsOnlyGST = objBs.GetInternalTransferPrintOnlyGST_Store(sTableName, (ID));
                    }
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        lblgstin.Text = ds.Tables[0].Rows[0]["GSTIN"].ToString();
