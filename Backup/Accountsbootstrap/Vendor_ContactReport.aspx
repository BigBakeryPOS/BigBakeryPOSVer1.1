<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vendor_ContactReport.aspx.cs" Inherits="Billing.Accountsbootstrap.Vendor_ContactReport" %>
...
<body>
   ...
   <form runat="server" id="form1">
    ...
    <div style="margin-top:100px" class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Vendor Contact Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
          ...
          <div class="row">
            ...
            <asp:TextBox ID="txtser" Visible="true" runat="server" Width="175px" placeholder="Search by Name / Mobile No." CssClass="form-control" ></asp:TextBox>
             </div>
            <div class="form-group">
