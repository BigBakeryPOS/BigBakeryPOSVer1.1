...
{
    public partial class Dispatch_OrderPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (iD > 0)
            {
                ...
                if (goodstype == "B")
                {
                    ...
                    DataSet ds = objBs.getdispatchprint_order(sTableName, iD.ToString(), goodstype);
                    if (ds.Tables[0].Rows.Count > 0)
                    {
        ...
        protected void Griddc_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if ((Bnchid == string.Empty) && (DataBinder.Eval(e.Row.DataItem, "branchid") != null))
            {
                ...
                cell.Text = "Branch Name : " + DataBinder.Eval(e.Row.DataItem, "heading").ToString();
                cell.ColumnSpan = 8;
                cell.CssClass = "GroupHeaderStyle";
                row.Cells.Add(cell);
                gridPurchase.Controls[0].Controls.AddAt(e.Row.RowIndex + intSubTotalIndex, row);
