...
{
    public partial class SemiGoodsReceivedGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                #region
                DataSet dss = objbs.checkrequestallowornot_SemiProd(scode);
                if (dss.Tables[0].Rows.Count > 0)
                {
                    Productioncode = dss.Tables[0].Rows[0]["ToProdcode"].ToString();
                }
                else
                {
                ...
                DataSet ds = objbs.GetDCNONew_Semi(scode, Productioncode);
        ...
        protected void ddlDC_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlDC.SelectedValue != "" && ddlDC.SelectedValue != "0" && ddlDC.SelectedValue != "Select DC No" && ddlDC.SelectedValue != "No Goods Available")
            {
                ...
                DataSet ds = objbs.GoodReceivedNew_Semi(ddlDC.SelectedValue, scode, Productioncode);
        ...
        protected void Newprint_click(object sender, EventArgs e)
        {
            ...
            ds = objbs.GetItemreceivedDetails_Semi(sDate, scode, btnlist.SelectedValue);
        ...
        protected void gvGoodTransFer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Receive")
            {
                ...
                Response.Redirect("SemiGoodsReceivedNote.aspx?PReqNo=" + PRoreqno + "&DCNo=" + Dcno + "&Productioncode=" + Productioncode + "&BReqNo=" + Breqno);
            }
            ...
            if (e.CommandName == "print")
            {
                ...
                DataSet ds = objbs.GoodReceivedListNew_Semi(ddlDC.SelectedValue, scode, Productioncode);
                if (ds.Tables[0].Rows.Count > 0)
                {
                ...
                string caption = "Semi Goods Received Details:" + "</br>" + "DC No " + gvGoodsReceived.Rows[0].Cells[0].Text + "</br>" + "DC Date " + Convert.ToDateTime(gvGoodsReceived.Rows[0].Cells[1].Text).ToString("dd/MM/yyyy hh:MM:tt") + "</br>" + " Request No:" + gvGoodsReceived.Rows[0].Cells[2].Text + "</br>" + " Print Time :" + DateTime.Now.ToString("MM/dd/yyyy hh:MM:tt") + " ";
            ...
            if (e.CommandName == "view")
            {
                ...
                string caption = "Semi Goods Received Details:" + "</br>" + "DC No " + gvGoodsReceived.Rows[0].Cells[0].Text + "</br>" + "DC Date " + Convert.ToDateTime(gvGoodsReceived.Rows[0].Cells[1].Text).ToString("dd/MM/yyyy hh:MM:tt") + "</br>" + " Request No:" + gvGoodsReceived.Rows[0].Cells[2].Text;
                gvDetails.Caption = caption;
