    ...
    public partial class Company_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (iCompanyID != "" || iCompanyID != null)
                    {
                        DataSet ds1 = objBs.GetCompanyDetails(Convert.ToInt32(iCompanyID));
                        ...
                        {
                            txtcompanyID.Text = ds1.Tables[0].Rows[0]["ComapanyID"].ToString();
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                if (txtemail.Text != "")
                {
                    DataSet ds2 = objBs.EmailID_CompanyDetails(txtemail.Text, txtmobileno.Text);
            ...
            else
            {
                ...
                int iStatus = objBs.EditCompanyDetails(txtcustomername.Text, txtmobileno.Text, txtphoneno.Text, txtarea.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, txtemail.Text, txtGstNo.Text, txtWebSite.Text, txtSocial.Text, Convert.ToInt32(iCompanyID), Imagepath, Imagepath2, Imagepath3, Imagepath4, txtUsername.Text, txtPasswprd.Text, txtEmpCode.Text, txtNoOfBranch.Text, drpbranchtype.SelectedValue, txtAboutUs.Text,DigitalMenu,Ecommerce);
