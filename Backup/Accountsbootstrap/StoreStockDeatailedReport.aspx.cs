...
{
    public partial class StoreStockDeatailedReport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (chkcategorylist.SelectedIndex >= 0)
            {
                ...
                DataTable dt = objBs.dElobratedClosingStockstore(ddlBranch.SelectedValue, Convert.ToInt32(lblUserID.Text), txtFrom.Text, sCode, cond1, ddlstcktype.SelectedValue, ddlclosingstocktype.SelectedValue);
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < GVStockAlert.Rows.Count; i++)
                    {
                        ...
                        if (ddldisplaytype.SelectedValue == "1")
                        {
                            ...
                            Label lbltrastockrate = (Label)GVStockAlert.Rows[i].FindControl("lbltrastockrate");
                        ...
                        else if (ddldisplaytype.SelectedValue == "2")
                        {
                            ...
                            Label lbltrastock = (Label)GVStockAlert.Rows[i].FindControl("lbltrastock");
