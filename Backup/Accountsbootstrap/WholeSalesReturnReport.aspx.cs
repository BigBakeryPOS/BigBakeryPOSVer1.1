...
{
    public partial class WholeSalesReturnReport1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = objBs.GetSalesallretrep(sTableName);
        ...
        protected void search(object sender, EventArgs e)
        {
            ...
            DataSet ds = objBs.GetSalesallretrep(sTableName, ddlcustomer.SelectedValue, ddlcategory.SelectedValue, ddlitem.SelectedValue, frmdate, todate);
            if (ds.Tables[0].Rows.Count > 0)
            {
                gvsales.DataSource = ds;
                gvsales.DataBind();
