    ...
    public partial class DispatchPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dT = objBs.griddispatch_date(sTableName, sFromdate, sTodate);
                ...
                //    DataSet ds = objBs.getdispatchprint(sTableName, iD.ToString());
                //    if (ds.Tables[0].Rows.Count > 0)
                //    {
        ...
        protected void dispatch_checked(object sender, EventArgs e)
        {
            ...
            {
                DataSet dT = objBs.griddispatch_branch(sTableName, drpdispatchno.SelectedValue);
                if (dT.Tables[0].Rows.Count > 0)
                {
        ...
        protected void Branch_select(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dT = objBs.griddispatch_dispatchn(sTableName, drpdispatchno.SelectedValue, drpbranch.SelectedValue);
                if (dT.Tables[0].Rows.Count > 0)
                {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = objBs.getdispatchprint_multipledc(sTableName, cond1);
            if (ds.Tables[0].Rows.Count > 0)
            {
