...
{
    public partial class InterBranchStockRequestReport : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("InterBranchStockRequestReport.aspx");
        }
        protected void btnadd_Click(object sender, EventArgs e)
        {
            DataSet ds = objbs.interBranchRequestreports(Convert.ToInt32(lblUserID.Text), sCode, txtfromdate.Text, txttodate.Text);
        ...
        protected void gvPurchaseEntry_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (gvGroup.DataKeys[e.Row.RowIndex].Value != "")
                {
                    ...
                    DataSet ds = objbs.InterbranchReport_StockReqDetails(groupID, sCode);
