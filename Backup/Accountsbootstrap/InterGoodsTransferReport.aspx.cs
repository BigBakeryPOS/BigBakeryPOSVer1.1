...
{
    public partial class InterGoodsTransferReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //  if (scode == "Production")
                {
                    ...
                    DataSet dT = objbs.InterbranchTransferReport_date(sFromdate, sTodate, scode, ddlBranch.SelectedValue);
        ...
        protected void gvTransfer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Exp")
            {
                ...
                //if (scode == "Production")
                //{
                ds = objbs.InterbranchGoodTrasnferListExp(DcNo, scode);
                //}
                //if (scode == "Production2")
                //{
