...
{
    public partial class ProductionStockDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objbs.getProductionStockDetailsselectAll(sTableName);
        ...
        protected void gvitemsdetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[2].Text = Qtyitems.ToString("f2");
            }
        }
