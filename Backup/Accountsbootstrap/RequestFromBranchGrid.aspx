<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestFromBranchGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.RequestFromBranchGrid" %>
...
<head>
    ...
    <title>Inter Branch Request Details Grid </title>
...
<body style="">
    ...
    <div class="row panel-custom1">
        <div class="panel-header">
          <h1 class="page-header">Inter Stock Request From Branch Details</h1>
	    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <asp:ScriptManager ID="scriptmanager" runat="server">
                            ...
                            <div id="Div1" runat="server" visible="false"  style="">
                                <label>
                                    Filter By</label>
                            ...
                            <div class="col-lg-3" >
                             ...
                             <asp:TextBox ID="txtDate" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                              ...
                              <div class="col-lg-3">
                                <asp:Button ID="btnsearch" runat="server" class="btn btn-primary pos-btn1" Text="Search" OnClick="btnsearch_Click" />
                       ...
                       <div class="row">
                            ...
                            <div class="table-responsive panel-grid-left">
                                <asp:GridView ID="gvPurchaseEntry" runat="server" AllowPaging="true" PageSize="20"  padding="0" spacing="0" border="0" cssClass="table table-striped pos-table"
