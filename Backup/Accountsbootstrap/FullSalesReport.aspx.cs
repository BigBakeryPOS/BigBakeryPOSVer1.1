...
{
    public partial class FullSalesReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
              ...
              //  DataSet FullValues = objBs.GetFullValuesForSalesdate(sTableName, txtfrmdate.Text);
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            // if (ddlcat.SelectedValue != "Select Category")
            {
              ...
              //  lblstkreturn.Text = Label123 + " Stock Return and GRN(+)(-) Generated on From Date " + txtfrmdate.Text + " To Date " + txttodate.Text + " On " + DateTime.Now.ToString("dd/MM/yyyy HH:mm tt");
                ...
                DataSet FullValues = objBs.GetFullValuesForSalesdate(ddlBranch.SelectedValue, txtfrmdate.Text);
                gvSalesValue.DataSource = FullValues;
                gvSalesValue.DataBind();
        ...
        protected void btnexcel_Click(object sender, EventArgs e)
        {
            ...
            string filename = "Fullsalesreport_" + DateTime.Now.ToString() + ".xls";
            ...
            ds1 = objBs.selectret111(ddlBranch.SelectedValue, ddlcat.SelectedValue, txtfrmdate.Text, txttodate.Text);
