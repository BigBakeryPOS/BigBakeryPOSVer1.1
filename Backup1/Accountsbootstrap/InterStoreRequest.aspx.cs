...
{
    public partial class InterStoreRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dsCategory = objbs.selectcategorymasterforproductionentry_store();
                ...
                DataSet dReqNo = objbs.ReqNoInter_store(Convert.ToInt32(lblUserID.Text), sTableName);
        ...
        protected void ddlcategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataSet dsitems = objbs.itemforreqest_store(catid, sTableName, "REQ");
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            DataSet checktable = objbs.checktableexisitsornot("tblinterStorerequest_" + sTableName + "");
            ...
            DataSet checktranstable = objbs.checktableexisitsornot("tblTransinterStorerequest_" + sTableName + "");
            ...
            if (txtOrderBy.Text != "")
            {
                ...
                int MainRequestID = objbs.insert_interstockrequest_store(Convert.ToInt32(empid), txtpono.Text, sDate, "Requset Sent", 0, sTableName, 0, Convert.ToInt32(lblUserID.Text), txtOrderBy.Text, sTableName, requestentrytime, entrytime, drpfrombranch.SelectedValue, drptobranch.SelectedValue);
                #region Geautex
                for (int i = 0; i < gvqueueitems.Rows.Count; i++)
                {
                    ...
                    if (tt.Text != "0")
                    {
                        int iSAve = objbs.insertinterTransReqMain_Store(txtpono.Text, iCatID, iSubCatID, Convert.ToDecimal(dTextBox), sUnits, 0, Convert.ToInt32(lblUserID.Text), 0, sTableName, sDate, "", MainRequestID);
                ...
                Response.Redirect("InterStoreGrid.aspx");
            }
        }
