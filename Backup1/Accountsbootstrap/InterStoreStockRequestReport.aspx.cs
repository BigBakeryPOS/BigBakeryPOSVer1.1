...
{
    public partial class InterStoreStockRequestReport : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("InterstoreStockRequestReport.aspx");
        }
        protected void btnadd_Click(object sender, EventArgs e)
        {
            DataSet ds = objbs.interStoreRequestreports(Convert.ToInt32(lblUserID.Text), sCode, txtfromdate.Text, txttodate.Text);
