...
{
    public partial class GoodsTransferReportStore : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //  if (scode == "Production")
                {
                    ...
                    DataSet dT = objbs.getstocktransferreportstore(ddlcategory.SelectedValue, sFromdate, sTodate, scode);
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (dT.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < dT.Tables[0].Rows.Count; i++)
                {
                    dT.Tables[0].Rows[i]["DC_Date"] = Convert.ToDateTime(dT.Tables[0].Rows[i]["DC_Date"]).ToString("dd/MMM/yyyy hh:mm:ss tt");
                }
            }
