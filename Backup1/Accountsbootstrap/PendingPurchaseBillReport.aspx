<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingPurchaseBillReport.aspx.cs" Inherits="Billing.Accountsbootstrap.PendingPurchaseBillReport" %>
...
<form runat="server" id="form1" method="post" style="margin-top:100px">
   ...
   <usc:Header ID="Header" runat="server" />
    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Purchase Pending Payment Grid</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                               ...
                               <div class="table-responsive">
                                ...
                                <asp:BoundField HeaderText="Pending Bill Amount" DataField="Balance" DataFormatString="{0:f}" />
                                </Columns>
