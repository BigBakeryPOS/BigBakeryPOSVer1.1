...
{
    public partial class InterGoodsReceivedGrid : System.Web.UI.Page
    {
       ...
       // string Productioncode = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                #region
                DataSet dss = objbs.checkinterrequestallowornot(scode);
        ...
        protected void ddlDC_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlDC.SelectedValue != "" && ddlDC.SelectedValue != "0" && ddlDC.SelectedValue != "Select DC No" && ddlDC.SelectedValue != "No Goods Available")
            {
                ...
                DataSet ds = objbs.interGoodReceivedNew(ddlDC.SelectedValue, scode);
        ...
        protected void gvGoodTransFer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Receive")
            {
                ...
                Response.Redirect("InterGoodReceivedNote.aspx?PReqNo=" + PRoreqno + "&DCNo=" + Dcno + "&ToCode=" + REQCode + "&BReqNo=" + Breqno);
            }
            ...
            if (e.CommandName == "print")
            {
                ...
                DataSet ds = objbs.ineterGoodReceivedListNew(ddlDC.SelectedValue, scode);
                if (ds.Tables[0].Rows.Count > 0)
                {
