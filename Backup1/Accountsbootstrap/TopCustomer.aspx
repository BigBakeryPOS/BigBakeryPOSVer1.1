<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopCustomer.aspx.cs" Inherits="Billing.Accountsbootstrap.TopCustomer" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                               ...
                               <table width="100%">
                                <tr ><td class="col-lg-4" align="center">
                                
                              
                                <label>Top 10 Customers</label>

                                
                                <asp:GridView ID="gvCustomer"  Width="400px" runat="server" AllowPaging="true" PageSize="10"  
                                        AutoGenerateColumns="false" CssClass="myGridStyle" EmptyDataText="No data found!" ShowHeaderWhenEmpty="True" 
                                          >
