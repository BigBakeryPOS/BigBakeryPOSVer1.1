...
namespace Billing
{
    public partial class PRtnPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (iPo != null)
            {
                ...
                else
                {
                    ...
                    lblpotype.Text = "Purchase Return";
                    type.Visible = true;

                    DataSet ds1 = objBs.GetPurchaseReturnprint(sTableName, Convert.ToInt32(iPo));
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        lblpodate.Text = Convert.ToDateTime(ds1.Tables[0].Rows[0]["PurchaseRtnDate"]).ToString("dd/MM/yyyy");
                        lblpono.Text = ds1.Tables[0].Rows[0]["PurchaseRtnID"].ToString();
                        lblpaymode.Text = ds1.Tables[0].Rows[0]["Paymode1"].ToString();
                        ...
                        DataSet dsPODet = objBs.GettransPpurchaseReturnprint(sTableName, Convert.ToInt32(iPo));
                        if (dsPODet.Tables[0].Rows.Count > 0)
                        {
                            gridprint.DataSource = dsPODet;
                            gridprint.DataBind();
