...
{
    public partial class BillInvoiceGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.GwtinvoiceBillgrid(sTableName);
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Billinvoiceentry.aspx");
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = objBs.GwtinvoiceBillgridsearch(sTableName, ddlbillno.SelectedValue, txtAutoName.Text);
        ...
        protected void gvsales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "view")
            {
                ...
                ds = objBs.GwtinvoiceBillgridbyid(sTableName,(e.CommandArgument.ToString()));
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (gvGroup.DataKeys[e.Row.RowIndex].Value != "")
                {
                  ...
                  //  string salestype = gvGroup.DataKeys[e.Row.RowIndex].Values[1].ToString();
                    DataSet ds = objBs.gettransitemforid(sTableName,groupID.ToString());
                    //if (ds.Tables[0].Rows.Count > 0)
                    //{
                    if (ds.Tables[0].Rows.Count > 0)
                    {
