...
{
    public partial class WholeSalesReturnPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ISalesId != null)
                {
                    ...
                    DataSet ds1 = objbs.GetSalesret(sTableName, Convert.ToInt32(ISalesId));
                    ...
                    lblNarrations.Text = ds1.Tables[0].Rows[0]["Narrations"].ToString();
