...
{
    public partial class ItemStockRequestStoreDept : System.Web.UI.Page
    {
       ...
       // string sCodeBnch = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Make Sure Table Created OR Not.Please Contact Administrator.Thank You!!!');", true);
                    return;
                }
        ...
        protected void dept_chnaged(object sender, EventArgs e)
        {
            ...
            {
                DataSet dss = objbs.checkrequestallowornot_depat(drpdepartment.SelectedValue);
                if (dss.Tables[0].Rows.Count > 0)
                {
                    sCodeProd = dss.Tables[0].Rows[0]["Prodcode"].ToString();
                    //sCodeBnch = dss.Tables[0].Rows[0]["BranchCode"].ToString();
                }
                else
                {
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Make Sure Your Selected Department is allow to Request Stock Or Not.Please Contact Administrator.Thank You!!!');", true);
                    return;
                }
            }
        }
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            DataSet checktable = objbs.checktableexisitsornot("tblPurchaseRequestStoreDept_" + sTableName + "");
            ...
            DataSet checktranstable = objbs.checktableexisitsornot("tblTransPurchaseRequestStoreDept_" + sTableName + "");
            ...
            //DataSet livechecktable = objbs.checktableexisitsornotlive("tblPurchaseRequestProdStoreProd_" + sCodeProd + "");
            ...
            if (txtOrderBy.Text != "")
            {
                ...
                for (int i = 0; i < gvqueueitems.Rows.Count; i++)
                {
                    ...
                    if (tt.Text != "0")
                    {
                        int iSAve = objbs.insertTransPurchaseReqStoreDept(txtpono.Text, iCatID, iSubCatID, Convert.ToDecimal(dTextBox), sUnits, 0, Convert.ToInt32(lblUserID.Text), 0, "0", sDate, sCodeProd, MainRequestID);
                ...
                Response.Redirect("PurchaseReqDeptGrid.aspx");
            }
        }
