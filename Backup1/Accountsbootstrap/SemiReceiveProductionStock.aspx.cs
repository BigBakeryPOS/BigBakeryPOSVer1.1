...
{
    public partial class SemiReceiveProductionStock : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dDcNo = objbs.getFinishRawMaterialsno_Semi((sCode));
        ...
        protected void btnaddqueue_OnClick(object sender, EventArgs e)
        {
            ...
            if (dstd.Tables[0].Rows.Count > 0)
            {
                ...
                var result1 = from r in dtddd.AsEnumerable()
                              group r by new { CategoryID = r["CategoryID"], CategoryUserID = r["CategoryUserID"], UOMID = r["UOMID"], Category = r["Category"], Definition = r["Definition"], UOM = r["UOM"] } into raw
                              select new
                              {
                ...
                foreach (var g in result1)
                {
                    ...
                    drraw["Qty"] = Convert.ToInt32(g.Qty);
                    drraw["UOM"] = g.UOM;
        ...
        protected void ddlrequestno_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (radentrytype.SelectedValue == "3" || radentrytype.SelectedValue == "1")
            {
                ...
                else
                {
                    ...
                    DataSet dsitems = objbs.itemforreqestNew_Semi((ddlcategory.SelectedValue), sTableName);
        ...
        protected void btnPrev_Click(object sender, EventArgs e)
        {
            ...
            if (radentrytype.SelectedValue == "2")
            {
                ...
                int RequestID = objbs.Insertrawfinish_Semi(sCode, txtDCNo.Text, Date, txtAccepted.Text, lblUserID.Text, Convert.ToInt32(ddlrequestno.SelectedValue), radentrytype.SelectedValue);
                ...
                Response.Redirect("SemiReceiveProductionStockGrid.aspx");
            }
            else if (radentrytype.SelectedValue == "3")
            {
                ...
                int RequestID = objbs.Insertrawfinish_Semi(sCode, txtDCNo.Text, Date, txtAccepted.Text, lblUserID.Text, Convert.ToInt32(0), radentrytype.SelectedValue);
                ...
                for (int vLoop = 0; vLoop < gvqueueitems.Rows.Count; vLoop++)
                {
                    ...
                    {
                        int MainRequestID = objbs.Inserttransrawfinish_Semi(sCode, RequestID, Convert.ToInt32(hideitemID.Value), Convert.ToDouble(txtQty.Text), Convert.ToDouble(0), Convert.ToInt32(0), Convert.ToInt32(txtQty.Text), Convert.ToInt32(0), Convert.ToInt32(0), Convert.ToInt32(0), Convert.ToInt32(0), Convert.ToInt32(0), radentrytype.SelectedValue);
                    }
                    #endregion
                }
                Response.Redirect("SemiReceiveProductionStockGrid.aspx");
