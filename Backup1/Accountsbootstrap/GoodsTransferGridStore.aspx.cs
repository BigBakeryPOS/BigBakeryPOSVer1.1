...
{
    public partial class GoodsTransferGridStore : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //  if (scode == "Production")
                {
                    ...
                    DataSet dT = objbs.GetTransferReport_datestore(sFromdate, sTodate, scode, ddlBranch.SelectedValue);
        ...
        protected void gvTransfer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Exp")
            {
                ...
                //if (scode == "Production")
                //{
                ds = objbs.GoodTrasnferListExpstore(DcNo, scode);
                //}
                //if (scode == "Production2")
                //{
                ...
                gridview.Caption = "Goods Transfer Store Details for " + Branch + "On " + Date + "-" + "DC.No" + DcNo;

                string filename = "Goods Transfer Store Details for " + Branch + "On " + Date + "-" + "DC.No" + DcNo;
            ...
            else if (e.CommandName == "Print")
            {
                try
                {
                    ...
                    grid.Caption = Branch + "-" + Date + "-Sent Store Items Details" + "-" + "DC.No" + DcNo;
            ...
            else if (e.CommandName == "View")
            {
                try
                {
                    ...
                    grid.Caption = "Goods Transfer Store Details for " + Branch + "On " + Date + "-" + "DC.No" + DcNo;
                    //ScriptManager.RegisterStartupScript(this, typeof(Page), "printGrid", "printGrid();", true);
