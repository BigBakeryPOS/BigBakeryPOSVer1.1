...
{
    public partial class InterBranchStockRequestGrid : System.Web.UI.Page
    {
        ...
        protected void btnadd_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("InterBranchRequest.aspx");
            }
            else
            {
        ...
        protected void gvPurchaseEntry_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "View")
            {
               // int rowIndex = Convert.ToInt32(e.CommandArgument);
                ...
                string caption = "Inter Branch  Stock Request Details" + "</br>" + "Request From :" + sCode + "</br>" + "To Branch : " + ToBranch + "</br>" + "Request No :" + ReqNo + "</br>" + "Request Date :" + Convert.ToDateTime(ReqTime).ToString("dd/MM/yyyy") + "</br>" + "Request Entry Time :" + RequestDate;
            ...
            else if (e.CommandName == "Print")
            {
                ...
                string caption = "<h4><b>Inter Branch Stock Request Details" + "</br>" + "Request From :" + sCode + "</br>" + "To Branch : " + ToBranch + "</br>" + "Request No :" + ReqNo + "</br>" + "Request Date :" + Convert.ToDateTime(ReqTime).ToString("dd/MM/yyyy") + "</br>" + "Request Entry Time :" + RequestDate + "</b></h4> " + "</br>" + " Print Time :" + DateTime.Now.ToString("MM/dd/yyyy hh:MM:tt") + " ";
