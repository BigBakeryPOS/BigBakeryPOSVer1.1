...
{
    public partial class InterProdGoodsTransferReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //  if (scode == "Production")
                {
                    ...
                    DataSet dT = objbs.InterProdTransferReport_date(sFromdate, sTodate, scode, ddlBranch.SelectedValue);
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (dT.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    dT.Tables[0].Rows[i]["Dc_Date"] = Convert.ToDateTime(dT.Tables[0].Rows[i]["Dc_Date"]).ToString("dd/MMM/yyyy");
                }
            }
            //end update
            if (dT.Tables[0].Rows.Count > 0)
        ...
        protected void gvTransfer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Exp")
            {
                ...
                //if (scode == "Production")
                //{
                ds = objbs.InterProdGoodTrasnferListExp(DcNo, scode);
                //}
                //if (scode == "Production2")
                //{
                ...
                gridview.Caption = "Goods Transfer Details for " + scode + "On " + Date + "-" + "DC.No" + DcNo;

                string filename = "Goods Transfer Details for " + scode + "On " + Date + "-" + "DC.No" + DcNo;
            ...
            else if (e.CommandName == "View")
            {
                try
                {
                    ...
                    grid.Caption = "Goods Transfer Details for " + scode + "On " + Date + "-" + "DC.No" + DcNo;
                    //ScriptManager.RegisterStartupScript(this, typeof(Page), "printGrid", "printGrid();", true);
