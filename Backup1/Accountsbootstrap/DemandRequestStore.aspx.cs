...
{
    public partial class DemandRequestStore : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dsCategory = objbs.selectcategorymasterforitemrequestStoreDemand();
                ...
                DataSet dsbranch = objbs.getDepartment_New(sTableName, "Y");
                ...
                DataSet dReqNo = objbs.getmaxrawmaterialrequestDemand(sCodeBnch);
        ...
        {
            DataSet dsitems = objbs.itemforreqestStoreDemand((ddlcategory.SelectedValue), sTableName, "");
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Make Sure  Department is Selected Or Not.Please Contact Administrator.Thank You!!!');", true);
                return;
            }
            ...
            if (txtOrderBy.Text != "")
            {
                ...
                DataSet dDcNo = objbs.getmaxrawmaterialrequestDemand((sCodeProd));
                txtpono.Text = dDcNo.Tables[0].Rows[0]["RequestNo"].ToString();
                
                int RequestID = objbs.Insertrawrequest(sCodeProd, txtpono.Text, sDate, txtOrderBy.Text, lblUserID.Text, drpentrytype.SelectedValue,drpdepartment.SelectedValue);
