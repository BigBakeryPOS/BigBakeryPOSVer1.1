<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreBillInvoiceGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.StoreBillInvoiceGrid" %>
                                    ...
                                    <div class="col-lg-6">
                                     <div class="table-responsive panel-grid-left">
                                        <asp:GridView ID="gvsales" align="center" runat="server" AllowPaging="true" PageSize="50" cssClass="table table-striped pos-table"
                                            Width="100%" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnPageIndexChanging="Page_Change" padding="0" spacing="0" border="0"
